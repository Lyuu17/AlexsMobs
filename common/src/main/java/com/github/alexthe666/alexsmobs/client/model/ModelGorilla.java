...
public class ModelGorilla extends AdvancedEntityModel<EntityGorilla> {
	...
	public ModelGorilla() {
		...
		body.addBox(-4.5F, -4.0F, -3.0F, 9.0F, 9.0F, 7.0F, 0.0F, false);

		chest = new AdvancedModelBox(this, "chest");
		chest.setRotationPoint(0.0F, 4.0F, -3.0F);
		body.addChild(chest);
		chest.setTextureOffset(0, 0);
		chest.addBox(-6.5F, -8.0F, -11.0F, 13.0F, 11.0F, 11.0F, 0.0F, false);

		head = new AdvancedModelBox(this, "head");
		head.setRotationPoint(0.0F, -8.0F, -11.0F);
		chest.addChild(head);
		head.setTextureOffset(22, 48);
		head.addBox(-3.0F, -5.0F, -4.0F, 6.0F, 7.0F, 7.0F, 0.0F, false);
		head.setTextureOffset(38, 0);
		head.addBox(-3.0F, -6.0F, -4.0F, 6.0F, 1.0F, 7.0F, 0.0F, false);
		head.setTextureOffset(0, 40);
		head.addBox(-3.0F, -8.0F, -5.0F, 6.0F, 4.0F, 8.0F, 0.0F, false);
		...
		foreheadDK_r1.setTextureOffset(0, 56);
		foreheadDK_r1.addBox(0.0F, -6.0F, -4.0F, 0.0F, 6.0F, 10.0F, 0.0F, false);

		mouth = new AdvancedModelBox(this, "mouth");
		mouth.setRotationPoint(0.0F, 0.0F, -1.0F);
		head.addChild(mouth);
		mouth.setTextureOffset(49, 9);
		mouth.addBox(-2.0F, -2.0F, -5.0F, 4.0F, 5.0F, 4.0F, 0.0F, false);

		leftArm = new AdvancedModelBox(this, "leftArm");
		leftArm.setRotationPoint(6.0F, -6.5F, -9.5F);
		chest.addChild(leftArm);
		leftArm.setTextureOffset(33, 23);
		leftArm.addBox(-3.0F, -2.5F, -2.5F, 6.0F, 19.0F, 5.0F, 0.0F, false);

		rightArm = new AdvancedModelBox(this, "rightArm");
		rightArm.setRotationPoint(-6.0F, -6.5F, -9.5F);
		chest.addChild(rightArm);
		rightArm.setTextureOffset(33, 23);
		rightArm.addBox(-3.0F, -2.5F, -2.5F, 6.0F, 19.0F, 5.0F, 0.0F, true);

		leftLeg = new AdvancedModelBox(this, "leftLeg");
		leftLeg.setRotationPoint(3.0F, 4.5F, 2.5F);
		body.addChild(leftLeg);
		leftLeg.setTextureOffset(49, 48);
		leftLeg.addBox(-2.5F, 0.5F, -2.5F, 5.0F, 9.0F, 5.0F, 0.0F, false);

		rightLeg = new AdvancedModelBox(this, "rightLeg");
		rightLeg.setRotationPoint(-3.0F, 4.5F, 2.5F);
		body.addChild(rightLeg);
		rightLeg.setTextureOffset(49, 48);
		rightLeg.addBox(-2.5F, 0.5F, -2.5F, 5.0F, 9.0F, 5.0F, 0.0F, true);
	...
	@Override
	public void setAngles(EntityGorilla entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.resetToDefaultPose();
		...
		float rideProgress = entityIn.hasVehicle() && entityIn.isBaby() ? 5F : 0;
