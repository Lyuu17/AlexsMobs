...
public class ModelSnowLeopard extends AdvancedEntityModel<EntitySnowLeopard> {
    ...
    public ModelSnowLeopard() {
        ...
        body.addBox(-4.0F, -4.0F, -9.0F, 8.0F, 9.0F, 18.0F, 0.0F, false);

        tail1 = new AdvancedModelBox(this);
        tail1.setRotationPoint(0.0F, -1.0F, 9.0F);
        body.addChild(tail1);
        setRotationAngle(tail1, -0.7418F, 0.0F, 0.0F);
        tail1.setTextureOffset(0, 28);
        tail1.addBox(-1.5F, -2.0F, -2.0F, 3.0F, 3.0F, 13.0F, 0.0F, false);

        tail2 = new AdvancedModelBox(this);
        tail2.setRotationPoint(0.0F, -0.2F, 11.0F);
        tail1.addChild(tail2);
        setRotationAngle(tail2, -1.0472F, 0.0F, 0.0F);
        tail2.setTextureOffset(0, 28);
        tail2.addBox(-1.5F, -8.0F, -2.0F, 3.0F, 9.0F, 3.0F, 0.1F, false);

        tail3 = new AdvancedModelBox(this);
        tail3.setRotationPoint(0.0F, -7.3F, -1.3F);
        tail2.addChild(tail3);
        setRotationAngle(tail3, -0.9599F, 0.0F, 0.0F);
        tail3.setTextureOffset(20, 28);
        tail3.addBox(-1.5F, -2.0F, -8.0F, 3.0F, 3.0F, 9.0F, 0.2F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, -1.0F, -9.0F);
        body.addChild(head);
        head.setTextureOffset(35, 0);
        head.addBox(-3.5F, -4.0F, -4.0F, 7.0F, 5.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(35, 11);
        head.addBox(-2.5F, -2.0F, -6.0F, 5.0F, 3.0F, 2.0F, 0.0F, false);
        head.setTextureOffset(36, 28);
        head.addBox(1.5F, -6.0F, -3.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        head.setTextureOffset(36, 28);
        head.addBox(-3.5F, -6.0F, -3.0F, 2.0F, 2.0F, 3.0F, 0.0F, true);

        bubble = new AdvancedModelBox(this);
        bubble.setRotationPoint(0.0F, -2.0F, -6.0F);
        head.addChild(bubble);
        bubble.setTextureOffset(7, 13);
        bubble.addBox(-2.0F, -2.0F, -2.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        whiskersLeft.setTextureOffset(11, 0);
        whiskersLeft.addBox(0.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        whiskersRight.setTextureOffset(11, 0);
        whiskersRight.addBox(-3.0F, -1.5F, 0.0F, 3.0F, 3.0F, 0.0F, 0.0F, true);

        armLeft = new AdvancedModelBox(this);
        armLeft.setRotationPoint(2.9F, 4.0F, -6.0F);
        body.addChild(armLeft);
        armLeft.setTextureOffset(0, 0);
        armLeft.addBox(-1.4F, -2.0F, -2.0F, 3.0F, 9.0F, 4.0F, 0.0F, false);

        armRight = new AdvancedModelBox(this);
        armRight.setRotationPoint(-2.9F, 4.0F, -6.0F);
        body.addChild(armRight);
        armRight.setTextureOffset(0, 0);
        armRight.addBox(-1.6F, -2.0F, -2.0F, 3.0F, 9.0F, 4.0F, 0.0F, true);

        legLeft = new AdvancedModelBox(this);
        legLeft.setRotationPoint(2.9F, 4.0F, 8.0F);
        body.addChild(legLeft);
        legLeft.setTextureOffset(29, 41);
        legLeft.addBox(-1.4F, -1.0F, -2.0F, 3.0F, 8.0F, 4.0F, 0.0F, false);

        legRight = new AdvancedModelBox(this);
        legRight.setRotationPoint(-2.9F, 4.0F, 8.0F);
        body.addChild(legRight);
        legRight.setTextureOffset(29, 41);
        legRight.addBox(-1.6F, -1.0F, -2.0F, 3.0F, 8.0F, 4.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntitySnowLeopard entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
