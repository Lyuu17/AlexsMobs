...
public class ModelCapuchinMonkey extends AdvancedEntityModel<EntityCapuchinMonkey> {
	...
	public ModelCapuchinMonkey() {
		...
		body.addBox(-3.0F, -2.1F, -9.9F, 6.0F, 5.0F, 11.0F, 0.0F, false);

		arm_left = new AdvancedModelBox(this, "arm_left");
		arm_left.setPos(2.1F, 2.4F, -8.8F);
		body.addChild(arm_left);
		arm_left.setTextureOffset(28, 17);
		arm_left.addBox(-1.0F, -1.5F, -1.0F, 2.0F, 9.0F, 2.0F, 0.0F, false);

		arm_right = new AdvancedModelBox(this, "arm_right");
		arm_right.setPos(-2.1F, 2.4F, -8.8F);
		body.addChild(arm_right);
		arm_right.setTextureOffset(28, 17);
		arm_right.addBox(-1.0F, -1.5F, -1.0F, 2.0F, 9.0F, 2.0F, 0.0F, true);

		leg_left = new AdvancedModelBox(this, "leg_left");
		leg_left.setPos(2.0F, 2.9F, 0.1F);
		body.addChild(leg_left);
		leg_left.setTextureOffset(0, 0);
		leg_left.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		leg_right = new AdvancedModelBox(this, "leg_right");
		leg_right.setPos(-2.0F, 2.9F, 0.1F);
		body.addChild(leg_right);
		leg_right.setTextureOffset(0, 0);
		leg_right.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, true);

		tail1 = new AdvancedModelBox(this, "tail1");
		tail1.setPos(0.0F, -1.1F, 0.5F);
		body.addChild(tail1);
		setRotationAngle(tail1, 0.6981F, 0.0F, 0.0F);
		tail1.setTextureOffset(15, 22);
		tail1.addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 8.0F, 0.0F, false);
		...
		tail2_r1.setTextureOffset(0, 17);
		tail2_r1.addBox(-1.0F, -0.8125F, -0.2209F, 2.0F, 3.0F, 9.0F, -0.1F, false);

		head = new AdvancedModelBox(this, "head");
		head.setPos(0.0F, -1.1F, -9.9F);
		body.addChild(head);
		head.setTextureOffset(24, 0);
		head.addBox(-2.0F, -3.0F, -3.0F, 4.0F, 4.0F, 3.0F, 0.0F, false);

		hair = new AdvancedModelBox(this, "hair");
		hair.setPos(0.0F, -1.0F, -2.0F);
		head.addChild(hair);
		hair.setTextureOffset(6, 38);
		hair.addBox(-3.0F, -2.0F, 0.0F, 6.0F, 4.0F, 0.0F, 0.0F, false);

		snout = new AdvancedModelBox(this, "snout");
		snout.setPos(0.0F, 1.0F, -3.0F);
		head.addChild(snout);
		snout.setTextureOffset(0, 17);
		snout.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityCapuchinMonkey entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		float sitProgress = entity.hasVehicle() ? 0 :entity.prevSitProgress + (entity.sitProgress - entity.prevSitProgress) * partialTick;
		float rideProgress = entity.hasVehicle() && entity.getVehicle() instanceof LivingEntity && entity.isOwner((LivingEntity) entity.getVehicle()) ? 10 : 0;
