...
public class ModelCatfishLarge extends AdvancedEntityModel<EntityCatfish> {
    ...
    public ModelCatfishLarge() {
        ...
        body.addBox(-10.0F, -7.0F, -14.0F, 20.0F, 15.0F, 26.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 0);
        left_fin.addBox(0.0F, 0.0F, -2.0F, 5.0F, 0.0F, 8.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 0);
        right_fin.addBox(-5.0F, 0.0F, -2.0F, 5.0F, 0.0F, 8.0F, 0.0F, true);
        ...
        dorsal_fin.setTextureOffset(0, 0);
        dorsal_fin.addBox(0.0F, -7.0F, 0.0F, 0.0F, 7.0F, 8.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 13.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 41);
        tail.addBox(-6.0F, -5.0F, -1.0F, 12.0F, 11.0F, 20.0F, 0.0F, false);
        tail.setTextureOffset(0, 56);
        tail.addBox(0.0F, 6.0F, -1.0F, 0.0F, 4.0F, 16.0F, 0.0F, false);
        tail.setTextureOffset(16, 18);
        tail.addBox(0.0F, -7.0F, 4.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setRotationPoint(0.0F, 0.0F, 17.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(44, 18);
        tail_fin.addBox(0.0F, -10.0F, -5.0F, 0.0F, 17.0F, 23.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -5.0F, -15.0F);
        body.addChild(head);
        head.setTextureOffset(56, 64);
        head.addBox(-9.5F, -2.0F, -7.0F, 19.0F, 13.0F, 8.0F, 0.0F, false);
        ...
        left_BigWhisker.setTextureOffset(66, 0);
        left_BigWhisker.addBox(0.0F, 0.0F, 0.0F, 15.0F, 8.0F, 0.0F, 0.0F, false);
        ...
        right_BigWhisker.setTextureOffset(66, 0);
        right_BigWhisker.addBox(-15.0F, 0.0F, 0.0F, 15.0F, 8.0F, 0.0F, 0.0F, true);
        ...
        left_SmallWhisker.setTextureOffset(0, 15);
        left_SmallWhisker.addBox(0.0F, 0.0F, 0.0F, 7.0F, 6.0F, 0.0F, 0.0F, false);
        ...
        right_SmallWhisker.setTextureOffset(0, 15);
        right_SmallWhisker.addBox(-7.0F, 0.0F, 0.0F, 7.0F, 6.0F, 0.0F, 0.0F, true);
        this.updateDefaultPose();
    }

    @Override
    public void setAngles(EntityCatfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
