...
public class ModelDevilsHolePupfish extends AdvancedEntityModel<EntityDevilsHolePupfish> {
    ...
    public ModelDevilsHolePupfish() {
        ...
        body.addBox(-1.5F, -2.0F, -5.0F, 3.0F, 4.0F, 9.0F, 0.0F, false);

        bottom_fin = new AdvancedModelBox(this, "bottom_fin");
        bottom_fin.setRotationPoint(0.0F, 2.0F, 1.0F);
        body.addChild(bottom_fin);
        bottom_fin.setTextureOffset(0, 0);
        bottom_fin.addBox(0.0F, 0.0F, 0.0F, 0.0F, 2.0F, 3.0F, 0.0F, false);

        dorsal_fin = new AdvancedModelBox(this, "dorsal_fin");
        dorsal_fin.setRotationPoint(0.0F, -2.0F, 0.0F);
        body.addChild(dorsal_fin);
        dorsal_fin.setTextureOffset(11, 14);
        dorsal_fin.addBox(0.0F, -3.0F, -2.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -1.0F, 4.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 14);
        tail.addBox(0.0F, -3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 14);
        left_fin.addBox(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 14);
        right_fin.addBox(0.0F, -1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, true);

        this.updateDefaultPose();
    }

    @Override
    public void setAngles(EntityDevilsHolePupfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
