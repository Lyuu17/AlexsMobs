...
public class ModelWarpedMosco extends AdvancedEntityModel<EntityWarpedMosco> {
    ...
    public ModelWarpedMosco() {
        ...
        body.addBox(-8.0F, -10.0F, -7.0F, 16.0F, 14.0F, 14.0F, 0.0F, false);

        back = new AdvancedModelBox(this, "back");
        back.setPos(0.0F, -4.0F, 7.0F);
        body.addChild(back);
        setRotationAngle(back, -0.4363F, 0.0F, 0.0F);
        back.setTextureOffset(44, 44);
        back.addBox(-5.0F, -1.0F, 0.0F, 10.0F, 10.0F, 17.0F, 0.0F, false);
        ...
        legfront_left.setTextureOffset(72, 86);
        legfront_left.addBox(-3.5F, -2.0F, -3.5F, 7.0F, 12.0F, 7.0F, 0.0F, false);
        ...
        kneefront_left.setTextureOffset(101, 81);
        kneefront_left.addBox(-2.5F, 0.0F, -2.5F, 5.0F, 12.0F, 5.0F, 0.0F, false);
        ...
        legfront_right.setTextureOffset(72, 86);
        legfront_right.addBox(-3.5F, -2.0F, -3.5F, 7.0F, 12.0F, 7.0F, 0.0F, true);
        ...
        kneefront_right.setTextureOffset(101, 81);
        kneefront_right.addBox(-2.5F, 0.0F, -2.5F, 5.0F, 12.0F, 5.0F, 0.0F, true);
        ...
        legback_left.setTextureOffset(72, 86);
        legback_left.addBox(-3.5F, -2.0F, -3.5F, 7.0F, 12.0F, 7.0F, 0.0F, false);
        ...
        kneeback_left.setTextureOffset(101, 81);
        kneeback_left.addBox(-2.5F, 0.0F, -2.5F, 5.0F, 12.0F, 5.0F, 0.0F, false);
        ...
        legback_right.setTextureOffset(72, 86);
        legback_right.addBox(-3.5F, -2.0F, -3.5F, 7.0F, 12.0F, 7.0F, 0.0F, true);
        ...
        kneeback_right.setTextureOffset(101, 81);
        kneeback_right.addBox(-2.5F, 0.0F, -2.5F, 5.0F, 12.0F, 5.0F, 0.0F, true);

        chest = new AdvancedModelBox(this, "chest");
        chest.setPos(0.0F, -10.0F, 0.0F);
        body.addChild(chest);
        chest.setTextureOffset(0, 0);
        chest.addBox(-12.0F, -14.0F, -8.0F, 24.0F, 14.0F, 16.0F, 0.0F, false);
        ...
        wingtop_left.setTextureOffset(24, 109);
        wingtop_left.addBox(0.0F, -11.0F, 0.0F, 33.0F, 19.0F, 0.0F, 0.0F, false);
        ...
        wingtop_right.setTextureOffset(24, 109);
        wingtop_right.addBox(-33.0F, -11.0F, 0.0F, 33.0F, 19.0F, 0.0F, 0.0F, true);
        ...
        wingbottom_left_r1.setTextureOffset(24, 109);
        wingbottom_left_r1.addBox(0.0F, -11.0F, 0.0F, 33.0F, 19.0F, 0.0F, 0.0F, false);
        ...
        wingbottom_right_r1.setTextureOffset(24, 109);
        wingbottom_right_r1.addBox(-33.0F, -11.0F, 0.0F, 33.0F, 19.0F, 0.0F, 0.0F, true);

        shoulder_left = new AdvancedModelBox(this, "shoulder_left");
        shoulder_left.setPos(16.0F, -11.0F, 0.0F);
        chest.addChild(shoulder_left);
        shoulder_left.setTextureOffset(0, 60);
        shoulder_left.addBox(-4.0F, -6.0F, -6.0F, 12.0F, 12.0F, 12.0F, 0.0F, false);
        ...
        shoulderspikes_left.setTextureOffset(101, 101);
        shoulderspikes_left.addBox(-6.5F, -8.0F, 0.0F, 13.0F, 16.0F, 0.0F, 0.0F, false);

        arm_left = new AdvancedModelBox(this, "arm_left");
        arm_left.setPos(1.1F, 6.0F, 2.0F);
        shoulder_left.addChild(arm_left);
        arm_left.setTextureOffset(71, 21);
        arm_left.addBox(-5.0F, 0.0F, -7.0F, 10.0F, 11.0F, 10.0F, 0.0F, false);

        hand_left = new AdvancedModelBox(this, "hand_left");
        hand_left.setPos(0.0F, 11.0F, 0.0F);
        arm_left.addChild(hand_left);
        hand_left.setTextureOffset(0, 85);
        hand_left.addBox(-4.0F, 0.0F, -7.0F, 8.0F, 12.0F, 10.0F, 0.0F, false);
        ...
        shoulder_right.setTextureOffset(0, 60);
        shoulder_right.addBox(-8.0F, -6.0F, -6.0F, 12.0F, 12.0F, 12.0F, 0.0F, true);
        ...
        shoulderspikes_right.setTextureOffset(101, 101);
        shoulderspikes_right.addBox(-6.5F, -8.0F, 0.0F, 13.0F, 16.0F, 0.0F, 0.0F, true);

        arm_right = new AdvancedModelBox(this, "arm_right");
        arm_right.setPos(-1.2F, 6.0F, 2.0F);
        shoulder_right.addChild(arm_right);
        arm_right.setTextureOffset(71, 21);
        arm_right.addBox(-5.0F, 0.0F, -7.0F, 10.0F, 11.0F, 10.0F, 0.0F, true);

        hand_right = new AdvancedModelBox(this, "hand_right");
        hand_right.setPos(0.0F, 11.0F, 0.0F);
        arm_right.addChild(hand_right);
        hand_right.setTextureOffset(0, 85);
        hand_right.addBox(-4.0F, 0.0F, -7.0F, 8.0F, 12.0F, 10.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setPos(0.0F, -14.0F, -1.0F);
        chest.addChild(head);
        head.setTextureOffset(82, 43);
        head.addBox(-5.0F, -5.0F, -5.0F, 10.0F, 5.0F, 10.0F, 0.0F, false);
        ...
        antenna_left.setTextureOffset(102, 59);
        antenna_left.addBox(-1.0F, -20.0F, 0.0F, 6.0F, 20.0F, 0.0F, 0.0F, false);
        ...
        antenna_right.setTextureOffset(102, 59);
        antenna_right.addBox(-5.0F, -20.0F, 0.0F, 6.0F, 20.0F, 0.0F, 0.0F, true);
        ...
        proboscis_r1.setTextureOffset(37, 86);
        proboscis_r1.addBox(-1.0F, 0.0F, -15.0F, 2.0F, 1.0F, 15.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityWarpedMosco entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(entity.getAnimation() != EntityWarpedMosco.ANIMATION_SUCK){
            this.head.rotateAngleY += netHeadYaw * 0.6F * MathHelper.RADIANS_PER_DEGREE;
            this.head.rotateAngleX += headPitch * 0.9F * MathHelper.RADIANS_PER_DEGREE;
        }
    }
