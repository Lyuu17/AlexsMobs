...
//    public static final RegistrySupplier<Block> STRADDLITE_BLOCK = registerBlockAndItem("straddlite_block", () -> new Block(AbstractBlock.Settings.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(1.0F, 1200.0F).sound(SoundType.ANCIENT_DEBRIS)), new Item.Settings().fireResistant(), false);
...
//    public static final RegistrySupplier<Block> BISON_FUR_BLOCK = registerBlockAndItem("bison_fur_block", () -> new Block(AbstractBlock.Settings.of().mapColor(MapColor.COLOR_BROWN).strength(0.6F, 1.0F).sound(SoundType.WOOL)));
...
//    public static final RegistrySupplier<Block> TRANSMUTATION_TABLE = registerBlockAndItem("transmutation_table", BlockTransmutationTable::new, new Item.Settings().rarity(Rarity.EPIC).fireResistant(), true);
