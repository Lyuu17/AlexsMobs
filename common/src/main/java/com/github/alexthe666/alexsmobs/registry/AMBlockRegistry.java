...
public class AMBlockRegistry {
    ...
    public static final DeferredRegister<Block> DEF_REG = DeferredRegister.create(AlexsMobs.MOD_ID, Registries.BLOCK);
    ...
    public static RegistrySupplier<Block> registerBlockAndItem(String name, Supplier<Block> block, Item.Properties blockItemProps, boolean specialRender){
