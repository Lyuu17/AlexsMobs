...
public class ModelSkelewag extends AdvancedEntityModel<EntitySkelewag> {
    ...
    public ModelSkelewag() {
        ...
        root.addChild(body);
        body.setTextureOffset(17, 11);
        body.addBox(-1.0F, -1.0F, -16.0F, 2.0F, 2.0F, 20.0F, 0.0F, false);
        body.setTextureOffset(50, 66);
        body.addBox(-0.5F, -16.0F, -15.0F, 1.0F, 15.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(23, 34);
        body.addBox(-0.5F, -12.0F, -11.0F, 1.0F, 11.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(19, 6);
        body.addBox(-0.5F, -9.0F, -7.0F, 1.0F, 8.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(26, 6);
        body.addBox(-0.5F, -7.0F, -3.0F, 1.0F, 6.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(0, 0);
        body.addBox(0.0F, -4.0F, 1.0F, 0.0F, 3.0F, 2.0F, 0.0F, false);
        body.setTextureOffset(45, 34);
        body.addBox(-2.0F, 1.0F, -12.0F, 4.0F, 6.0F, 10.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(-0.5F, 0.0F, -17.0F);
        body.addChild(head);
        head.setTextureOffset(23, 54);
        head.addBox(-2.0F, -1.0F, -7.0F, 5.0F, 7.0F, 8.0F, 0.0F, false);
        head.setTextureOffset(50, 51);
        head.addBox(-0.5F, -1.0F, -19.0F, 2.0F, 2.0F, 12.0F, 0.0F, false);
        head.setTextureOffset(42, 17);
        head.addBox(0.0F, -1.0F, -31.0F, 1.0F, 1.0F, 12.0F, 0.0F, false);

        flag = new AdvancedModelBox(this, "flag");
        flag.setRotationPoint(0.5F, -10.0F, -15.0F);
        body.addChild(flag);
        setRotationAngle(flag, 0.0F, 0.1309F, 0.0F);
        flag.setTextureOffset(0, 0);
        flag.addBox(0.0F, -5.0F, 0.0F, 0.0F, 12.0F, 18.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(19, 0);
        left_fin.addBox(0.0F, 0.0F, -2.0F, 10.0F, 1.0F, 4.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(19, 0);
        right_fin.addBox(-10.0F, 0.0F, -2.0F, 10.0F, 1.0F, 4.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 0.0F, 5.0F);
        body.addChild(tail);
        tail.setTextureOffset(23, 34);
        tail.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 17.0F, 0.0F, false);
        tail.setTextureOffset(9, 0);
        tail.addBox(0.0F, -3.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);
        tail.setTextureOffset(57, 17);
        tail.addBox(0.0F, -2.0F, 4.0F, 0.0F, 1.0F, 10.0F, 0.0F, false);
        tail.setTextureOffset(42, 0);
        tail.addBox(-2.0F, 1.0F, 2.0F, 4.0F, 5.0F, 11.0F, 0.0F, false);
        tail.setTextureOffset(0, 0);
        tail.addBox(0.0F, 4.0F, 5.0F, 0.0F, 6.0F, 8.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setRotationPoint(0.0F, 0.0F, 15.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(0, 31);
        tail_fin.addBox(0.0F, -12.0F, 0.0F, 0.0F, 25.0F, 11.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntitySkelewag entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.head.rotateAngleX -= headPitch * 0.5F * MathHelper.RADIANS_PER_DEGREE;
