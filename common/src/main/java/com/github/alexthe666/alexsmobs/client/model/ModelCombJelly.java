...
public class ModelCombJelly extends AdvancedEntityModel<EntityCombJelly> {
    ...
    public ModelCombJelly(float f) {
        ...
        body.addBox(-5.0F, -2.0F, -5.0F, 10.0F, 15.0F, 10.0F, f, false);
        inner_body = new AdvancedModelBox(this, "inner_body");
        inner_body.setRotationPoint(0.0F, -3.0F, 0.0F);
        body.addChild(inner_body);
        inner_body.setTextureOffset(40, 6);
        inner_body.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 13.0F, 6.0F, f, false);
    ...
    @Override
    public void setAngles(EntityCombJelly entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        this.body.rotateAngleX = birdPitch * MathHelper.RADIANS_PER_DEGREE * (1F - landProgress * 0.2F);
        this.body.rotateAngleZ = landProgress * 0.2F * MathHelper.HALF_PI;
