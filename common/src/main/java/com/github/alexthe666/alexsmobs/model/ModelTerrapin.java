...
public class ModelTerrapin extends AdvancedEntityModel<EntityTerrapin> {
    ...
    public ModelTerrapin() {
        ...
        left_foot.addBox(-1.0F, -0.01F, -5.0F, 3.0F, 0.0F, 5.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setPos(-4.0F, 0.0F, 4.4F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(17, 25);
        right_leg.addBox(-1.0F, -1.0F, -2.0F, 2.0F, 3.0F, 3.0F, 0.0F, true);
        ...
        right_foot.addBox(-2.0F, 0.0F, -4.0F, 3.0F, 0.0F, 5.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityTerrapin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
