...
public class ModelHammerheadShark extends AdvancedEntityModel<EntityHammerheadShark> {
	...
	public ModelHammerheadShark() {
		...
		main_body.setTextureOffset(0, 0);
		main_body.addBox(-5.0F, -4.0F, -14.0F, 10.0F, 10.0F, 25.0F, 0.0F, false);

		head = new AdvancedModelBox(this, "head");
		head.setPos(0.0F, -1.0F, -14.5F);
		main_body.addChild(head);
		head.setTextureOffset(40, 55);
		head.addBox(-4.0F, -1.0F, -6.5F, 8.0F, 7.0F, 7.0F, 0.0F, false);

		head_hammer = new AdvancedModelBox(this, "head_hammer");
		head_hammer.setPos(0.0F, 1.5F, -7.0F);
		head.addChild(head_hammer);
		head_hammer.setTextureOffset(32, 36);
		head_hammer.addBox(-11.0F, -1.5F, -3.5F, 22.0F, 3.0F, 7.0F, 0.0F, false);
		...
		finL.setTextureOffset(47, 47);
		finL.addBox(-1.0F, -1.0F, -1.0F, 14.0F, 1.0F, 6.0F, 0.0F, false);
		...
		finR.setTextureOffset(47, 47);
		finR.addBox(-13.0F, -1.0F, -1.0F, 14.0F, 1.0F, 6.0F, 0.0F, true);
		...
		topfin.setTextureOffset(0, 0);
		topfin.addBox(-1.0F, -13.0F, -2.0F, 2.0F, 14.0F, 7.0F, 0.0F, false);

		tail1 = new AdvancedModelBox(this, "tail1");
		tail1.setPos(0.0F, -0.3F, 11.75F);
		main_body.addChild(tail1);
		tail1.setTextureOffset(0, 36);
		tail1.addBox(-4.0F, -2.5F, -0.75F, 8.0F, 8.0F, 15.0F, 0.0F, false);
		...
		tail_finL.setTextureOffset(64, 55);
		tail_finL.addBox(0.0F, -1.0F, 0.0F, 8.0F, 1.0F, 4.0F, 0.0F, false);
		...
		tail_finR.setTextureOffset(64, 55);
		tail_finR.addBox(-8.0F, -1.0F, 0.0F, 8.0F, 1.0F, 4.0F, 0.0F, true);
		...
		topfintail.setTextureOffset(0, 36);
		topfintail.addBox(-0.5F, -4.0237F, -1.7836F, 1.0F, 5.0F, 4.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this, "tail2");
		tail2.setPos(0.0F, 0.3F, 14.75F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(46, 0);
		tail2.addBox(-2.5F, -2.0F, -0.5F, 5.0F, 6.0F, 14.0F, 0.0F, false);
		...
		tailbottomend.setTextureOffset(17, 60);
		tailbottomend.addBox(0.0F, -11.5F, -2.5F, 1.0F, 14.0F, 6.0F, 0.0F, false);
		...
		tailtopend.setTextureOffset(0, 60);
		tailtopend.addBox(-1.0F, -16.5F, -1.5F, 2.0F, 19.0F, 6.0F, 0.0F, false);

		this.updateDefaultPose();
	}

	@Override
	public void setAngles(EntityHammerheadShark entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
