...
public class ModelShoebill extends AdvancedEntityModel<EntityShoebill> {
    ...
    public ModelShoebill() {
        ...
        body.addBox(-4.0F, -3.0F, -7.0F, 8.0F, 6.0F, 13.0F, 0.0F, false);

        tail = new AdvancedModelBox(this);
        tail.setRotationPoint(0.0F, -2.0F, 6.0F);
        body.addChild(tail);
        tail.setTextureOffset(42, 27);
        tail.addBox(-3.0F, -1.0F, 0.0F, 6.0F, 2.0F, 9.0F, 0.0F, false);

        leftWing = new AdvancedModelBox(this);
        leftWing.setRotationPoint(4.0F, 0.3F, -3.4F);
        body.addChild(leftWing);
        leftWing.setTextureOffset(0, 20);
        leftWing.addBox(-1.0F, -3.0F, -2.0F, 2.0F, 6.0F, 13.0F, 0.0F, false);
        ...
        leftWingFeathers.setTextureOffset(31, 8);
        leftWingFeathers.addBox(0.2F, -4.0F, -3.0F, 0.0F, 6.0F, 12.0F, 0.0F, false);

        rightWing = new AdvancedModelBox(this);
        rightWing.setRotationPoint(-4.0F, 0.3F, -3.4F);
        body.addChild(rightWing);
        rightWing.setTextureOffset(0, 20);
        rightWing.addBox(-1.0F, -3.0F, -2.0F, 2.0F, 6.0F, 13.0F, 0.0F, true);
        ...
        rightWingFeathers.setTextureOffset(31, 8);
        rightWingFeathers.addBox(-0.2F, -4.0F, -3.0F, 0.0F, 6.0F, 12.0F, 0.0F, true);

        leftLeg = new AdvancedModelBox(this);
        leftLeg.setRotationPoint(2.5F, 3.0F, 4.0F);
        body.addChild(leftLeg);
        setRotationAngle(leftLeg, 0.9599F, 0.0F, 0.0F);
        leftLeg.setTextureOffset(18, 20);
        leftLeg.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 12.0F, 0.0F, 0.0F, false);

        leftFoot = new AdvancedModelBox(this);
        leftFoot.setRotationPoint(0.0F, 12.0F, 0.0F);
        leftLeg.addChild(leftFoot);
        leftFoot.setTextureOffset(30, 0);
        leftFoot.addBox(-2.5F, 0.0F, -3.0F, 5.0F, 0.0F, 5.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(18, 20);
        rightLeg.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 12.0F, 0.0F, 0.0F, true);

        rightFoot = new AdvancedModelBox(this);
        rightFoot.setRotationPoint(0.0F, 12.0F, 0.0F);
        rightLeg.addChild(rightFoot);
        rightFoot.setTextureOffset(30, 0);
        rightFoot.addBox(-2.5F, 0.0F, -3.0F, 5.0F, 0.0F, 5.0F, 0.0F, true);
        ...
        head.setTextureOffset(20, 29);
        head.addBox(-2.5F, -3.0F, -11.0F, 5.0F, 5.0F, 11.0F, 0.0F, false);
        head.setTextureOffset(34, 47);
        head.addBox(-2.5F, 2.0F, -11.0F, 5.0F, 1.0F, 1.0F, 0.0F, false);
        head.setTextureOffset(0, 0);
        head.addBox(0.0F, -6.0F, -12.0F, 0.0F, 6.0F, 5.0F, 0.0F, false);
        ...
        hair_r1.setTextureOffset(30, 6);
        hair_r1.addBox(-2.5F, -5.0F, 0.0F, 5.0F, 5.0F, 0.0F, 0.0F, false);

        beak = new AdvancedModelBox(this);
        beak.setRotationPoint(0.0F, 2.0F, -9.0F);
        head.addChild(beak);
        setRotationAngle(beak, 0.3927F, 0.0F, 0.0F);
        beak.setTextureOffset(0, 40);
        beak.addBox(-3.0F, -1.0F, 0.0F, 6.0F, 8.0F, 3.0F, 0.0F, false);
        beak.setTextureOffset(6, 0);
        beak.addBox(-1.0F, 7.0F, 3.0F, 2.0F, 0.0F, 1.0F, 0.0F, false);
        ...
        jaw_r1.setTextureOffset(0, 20);
        jaw_r1.addBox(-2.5F, -1.4F, -0.3F, 5.0F, 7.0F, 1.0F, -0.03F, false);
    ...
    @Override
    public void setAngles(EntityShoebill entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
