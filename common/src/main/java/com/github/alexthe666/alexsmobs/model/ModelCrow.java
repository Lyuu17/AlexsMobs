...
public class ModelCrow extends AdvancedEntityModel<EntityCrow> {
	...
	public ModelCrow() {
		...
		body.addBox(-1.5F, -5.0F, 0.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);

		leg_left = new AdvancedModelBox(this, "leg_left");
		leg_left.setPos(0.9F, 0.0F, 0.0F);
		body.addChild(leg_left);
		setRotationAngle(leg_left, 0.5672F, 0.0F, 0.0F);
		leg_left.setTextureOffset(0, 17);
		leg_left.addBox(-0.5F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, false);
		...
		leg_right.setTextureOffset(0, 17);
		leg_right.addBox(-0.5F, -2.0F, -2.0F, 1.0F, 2.0F, 3.0F, 0.0F, true);
		...
		wing_left.setTextureOffset(13, 13);
		wing_left.addBox(-0.5F, 0.0F, -1.7F, 1.0F, 6.0F, 3.0F, 0.0F, false);
		...
		wing_right.setTextureOffset(13, 13);
		wing_right.addBox(-0.5F, 0.0F, -1.7F, 1.0F, 6.0F, 3.0F, 0.0F, true);

		tail = new AdvancedModelBox(this, "tail");
		tail.setPos(0.0F, -0.1F, 3.0F);
		body.addChild(tail);
		setRotationAngle(tail, -0.1309F, 0.0F, 0.0F);
		tail.setTextureOffset(13, 0);
		tail.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 4.0F, 2.0F, -0.1F, false);
		...
		head.addBox(-1.5F, -2.8F, -1.5F, 3.0F, 4.0F, 3.0F, -0.2F, false);

		beak = new AdvancedModelBox(this, "beak");
		beak.setPos(0.0F, -1.4F, -1.9F);
		head.addChild(beak);
		beak.setTextureOffset(13, 7);
		beak.addBox(-0.5F, -1.0F, -1.8F, 1.0F, 2.0F, 3.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityCrow entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
