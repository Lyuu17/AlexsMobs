...
public class ModelLeafcutterAntQueen extends AdvancedEntityModel<EntityLeafcutterAnt> {
	...
	public ModelLeafcutterAntQueen() {
		...
		body.addBox(-3.5F, -5.0F, -5.0F, 7.0F, 9.0F, 11.0F, 0.0F, false);
		...
		legront_left.setTextureOffset(38, 46);
		legront_left.addBox(0.0F, -2.0F, 0.0F, 9.0F, 8.0F, 0.0F, 0.0F, false);
		...
		legront_right.setTextureOffset(38, 46);
		legront_right.addBox(-9.0F, -2.0F, 0.0F, 9.0F, 8.0F, 0.0F, 0.0F, true);

		legmid_left = new AdvancedModelBox(this, "legmid_left");
		legmid_left.setPos(3.5F, 4.0F, 0.0F);
		body.addChild(legmid_left);
		legmid_left.setTextureOffset(19, 46);
		legmid_left.addBox(0.0F, -2.0F, 0.0F, 9.0F, 8.0F, 0.0F, 0.0F, false);

		legmid_right = new AdvancedModelBox(this, "legmid_right");
		legmid_right.setPos(-3.5F, 4.0F, 0.0F);
		body.addChild(legmid_right);
		legmid_right.setTextureOffset(19, 46);
		legmid_right.addBox(-9.0F, -2.0F, 0.0F, 9.0F, 8.0F, 0.0F, 0.0F, true);
		...
		legback_left.setTextureOffset(0, 46);
		legback_left.addBox(0.0F, -2.0F, 0.0F, 9.0F, 8.0F, 0.0F, 0.0F, false);
		...
		legback_right.setTextureOffset(0, 46);
		legback_right.addBox(-9.0F, -2.0F, 0.0F, 9.0F, 8.0F, 0.0F, 0.0F, true);

		abdomen = new AdvancedModelBox(this, "abdomen");
		abdomen.setPos(0.0F, -1.0F, 6.0F);
		body.addChild(abdomen);
		abdomen.setTextureOffset(0, 0);
		abdomen.addBox(-4.5F, -2.0F, 0.0F, 9.0F, 9.0F, 15.0F, 0.0F, false);

		head = new AdvancedModelBox(this, "head");
		head.setPos(0.0F, 0.0F, -5.0F);
		body.addChild(head);
		head.setTextureOffset(37, 25);
		head.addBox(-4.5F, -4.0F, -7.0F, 9.0F, 7.0F, 7.0F, 0.0F, false);
		...
		antenna_left.setTextureOffset(34, 0);
		antenna_left.addBox(0.0F, 0.0F, -12.0F, 9.0F, 0.0F, 12.0F, 0.0F, false);
		...
		antenna_right.setTextureOffset(34, 0);
		antenna_right.addBox(-9.0F, 0.0F, -12.0F, 9.0F, 0.0F, 12.0F, 0.0F, true);

		fangs = new AdvancedModelBox(this, "fangs");
		fangs.setPos(0.0F, 2.0F, -7.0F);
		head.addChild(fangs);
		fangs.setTextureOffset(37, 40);
		fangs.addBox(-4.5F, -1.0F, -3.0F, 9.0F, 2.0F, 3.0F, 0.0F, false);
