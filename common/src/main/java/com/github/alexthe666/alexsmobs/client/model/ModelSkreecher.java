...
public class ModelSkreecher extends AdvancedEntityModel<EntitySkreecher> {
    ...
    public ModelSkreecher() {
        ...
        body.addBox(-3.0F, -5.0F, -1.5F, 6.0F, 6.0F, 3.0F, 0.0F, false);
        ...
        leftLeg.setTextureOffset(27, 25);
        leftLeg.addBox(0.0F, -1.0F, -5.0F, 0.0F, 6.0F, 7.0F, 0.0F, false);

        leftFoot = new AdvancedModelBox(this, "leftFoot");
        leftFoot.setRotationPoint(0.0F, 2.0F, -4.0F);
        leftLeg.addChild(leftFoot);
        leftFoot.setTextureOffset(1, 48);
        leftFoot.addBox(-1.0F, 0.0F, -4.0F, 1.0F, 6.0F, 6.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(27, 25);
        rightLeg.addBox(0.0F, -1.0F, -5.0F, 0.0F, 6.0F, 7.0F, 0.0F, true);

        rightFoot = new AdvancedModelBox(this, "rightFoot");
        rightFoot.setRotationPoint(0.0F, 2.0F, -4.0F);
        rightLeg.addChild(rightFoot);
        rightFoot.setTextureOffset(1, 48);
        rightFoot.addBox(0.0F, 0.0F, -4.0F, 1.0F, 6.0F, 6.0F, 0.0F, true);
        ...
        leftArm.setTextureOffset(17, 34);
        leftArm.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 16.0F, 2.0F, 0.0F, false);

        leftHand = new AdvancedModelBox(this, "leftHand");
        leftHand.setRotationPoint(0.0F, 15.0F, 0.0F);
        leftArm.addChild(leftHand);
        leftHand.setTextureOffset(31, 9);
        leftHand.addBox(-4.0F, -0.1F, -2.0F, 8.0F, 3.0F, 4.0F, 0.0F, false);
        ...
        rightArm.setTextureOffset(17, 34);
        rightArm.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 16.0F, 2.0F, 0.0F, true);

        rightHand = new AdvancedModelBox(this, "rightHand");
        rightHand.setRotationPoint(0.0F, 15.0F, 0.0F);
        rightArm.addChild(rightHand);
        rightHand.setTextureOffset(31, 9);
        rightHand.addBox(-4.0F, -0.1F, -2.0F, 8.0F, 3.0F, 4.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntitySkreecher entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
