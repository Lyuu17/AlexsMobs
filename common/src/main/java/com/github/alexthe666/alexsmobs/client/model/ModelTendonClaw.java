...
public class ModelTendonClaw extends AdvancedEntityModel<EntityTendonSegment> {
    ...
    public ModelTendonClaw() {
        ...
        claw1.setTextureOffset(0, 0);
        claw1.addBox(-1.5F, -8.0F, -2.0F, 3.0F, 8.0F, 2.0F, 0.0F, false);

        claw2 = new AdvancedModelBox(this, "claw2");
        claw2.setRotationPoint(0.5F, 0.0F, 1.0F);
        root.addChild(claw2);
        setRotationAngle(claw2, 0.2618F, 0.0F, 2.1817F);
        claw2.setTextureOffset(0, 0);
        claw2.addBox(-1.5F, -8.0F, -2.0F, 3.0F, 8.0F, 2.0F, 0.0F, false);

        claw3 = new AdvancedModelBox(this, "claw3");
        claw3.setRotationPoint(-0.5F, 0.0F, 1.0F);
        root.addChild(claw3);
        setRotationAngle(claw3, 0.2618F, 0.0F, -2.1817F);
        claw3.setTextureOffset(0, 0);
        claw3.addBox(-1.5F, -8.0F, -2.0F, 3.0F, 8.0F, 2.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityTendonSegment entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
