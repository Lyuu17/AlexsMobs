...
public class ModelCosmicCod extends AdvancedEntityModel<EntityCosmicCod> {
    ...
    public ModelCosmicCod() {
        ...
        body.addBox(-1.0F, -1.0F, -5.0F, 2.0F, 3.0F, 8.0F, 0.0F, false);
        body.setTextureOffset(15, 15);
        body.addBox(0.0F, -3.0F, -2.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 12);
        left_fin.addBox(0.0F, 0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 12);
        right_fin.addBox(0.0F, 0.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, true);

        mouth = new AdvancedModelBox(this, "mouth");
        mouth.setRotationPoint(0.0F, 1.0F, -5.0F);
        body.addChild(mouth);
        mouth.setTextureOffset(0, 0);
        mouth.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 0.0F, 3.0F);
        body.addChild(tail);
        tail.setTextureOffset(15, 6);
        tail.addBox(-0.5F, -1.0F, 0.0F, 1.0F, 2.0F, 6.0F, 0.0F, false);

        tail_tip = new AdvancedModelBox(this, "tail_tip");
        tail_tip.setRotationPoint(0.0F, 0.0F, 6.0F);
        tail.addChild(tail_tip);
        tail_tip.setTextureOffset(0, 12);
        tail_tip.addBox(0.0F, -3.0F, -1.0F, 0.0F, 5.0F, 7.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityCosmicCod entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        this.resetToDefaultPose();
        float idleSpeed = 0.14F;
        float idleDegree = 0.25F;
        float swimSpeed = 0.8F;
        float swimDegree = 0.5F;
        float pitch = Maths.rad(MathHelper.lerpAngleDegrees(ageInTicks - entity.age, entity.prevFishPitch, entity.getFishPitch()));
