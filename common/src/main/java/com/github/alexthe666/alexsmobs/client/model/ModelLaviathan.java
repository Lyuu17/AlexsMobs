...
public class ModelLaviathan extends AdvancedEntityModel<EntityLaviathan> {
    ...
    public ModelLaviathan() {
        ...
        body.addBox(-20.0F, -27.0F, -31.0F, 40.0F, 27.0F, 64.0F, 0.0F, false);

        leftArm = new AdvancedModelBox(this, "leftArm");
        leftArm.setRotationPoint(20.0F, -9.0F, -28.0F);
        body.addChild(leftArm);
        leftArm.setTextureOffset(150, 151);
        leftArm.addBox(0.0F, -2.0F, -3.0F, 21.0F, 4.0F, 13.0F, 0.0F, false);
        leftArm.setTextureOffset(0, 49);
        leftArm.addBox(13.0F, -1.9F, 1.0F, 10.0F, 0.0F, 14.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this, "rightArm");
        rightArm.setRotationPoint(-20.0F, -9.0F, -28.0F);
        body.addChild(rightArm);
        rightArm.setTextureOffset(150, 151);
        rightArm.addBox(-21.0F, -2.0F, -3.0F, 21.0F, 4.0F, 13.0F, 0.0F, true);
        rightArm.setTextureOffset(0, 49);
        rightArm.addBox(-23.0F, -1.9F, 1.0F, 10.0F, 0.0F, 14.0F, 0.0F, true);

        leftLeg = new AdvancedModelBox(this, "leftLeg");
        leftLeg.setRotationPoint(20.0F, -8.0F, 21.0F);
        body.addChild(leftLeg);
        leftLeg.setTextureOffset(65, 151);
        leftLeg.addBox(0.0F, -2.0F, -5.0F, 25.0F, 4.0F, 17.0F, 0.0F, false);
        leftLeg.setTextureOffset(0, 30);
        leftLeg.addBox(23.0F, -1.9F, -4.0F, 4.0F, 0.0F, 18.0F, 0.0F, false);

        rightLeg = new AdvancedModelBox(this, "rightLeg");
        rightLeg.setRotationPoint(-20.0F, -8.0F, 21.0F);
        body.addChild(rightLeg);
        rightLeg.setTextureOffset(65, 151);
        rightLeg.addBox(-25.0F, -2.0F, -5.0F, 25.0F, 4.0F, 17.0F, 0.0F, true);
        rightLeg.setTextureOffset(0, 30);
        rightLeg.addBox(-27.0F, -1.9F, -4.0F, 4.0F, 0.0F, 18.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -20.0F, 33.0F);
        body.addChild(tail);
        tail.setTextureOffset(92, 92);
        tail.addBox(-7.0F, -4.0F, 0.0F, 14.0F, 9.0F, 49.0F, 0.0F, false);

        neck = new AdvancedModelBox(this, "neck");
        neck.setRotationPoint(0.0F, -19.0F, -32.0F);
        body.addChild(neck);
        neck.setTextureOffset(0, 138);
        neck.addBox(-7.0F, -5.0F, -35.0F, 14.0F, 11.0F, 36.0F, 0.0F, false);
        neck.setTextureOffset(0, 0);
        neck.addBox(-1.0F, -7.0F, -34.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        neck.setTextureOffset(0, 0);
        neck.addBox(-1.0F, -7.0F, -25.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        neck.setTextureOffset(0, 0);
        neck.addBox(-1.0F, -7.0F, -16.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        neck.setTextureOffset(0, 0);
        neck.addBox(-1.0F, -7.0F, -7.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);

        neck2 = new AdvancedModelBox(this, "neck2");
        neck2.setRotationPoint(0.0F, 0.0F, -35.0F);
        neck.addChild(neck2);
        neck2.setTextureOffset(145, 0);
        neck2.addBox(-5.0F, -4.0F, -39.0F, 10.0F, 9.0F, 39.0F, 0.0F, false);
        neck2.setTextureOffset(0, 0);
        neck2.addBox(-1.0F, -6.0F, -35.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        neck2.setTextureOffset(0, 0);
        neck2.addBox(-1.0F, -6.0F, -26.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        neck2.setTextureOffset(0, 0);
        neck2.addBox(-1.0F, -6.0F, -17.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
        neck2.setTextureOffset(0, 0);
        neck2.addBox(-1.0F, -6.0F, -8.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -1.0F, -40.0F);
        neck2.addChild(head);
        head.setTextureOffset(0, 0);
        head.addBox(-6.0F, -5.0F, -16.0F, 12.0F, 12.0F, 17.0F, 0.0F, false);
        head.setTextureOffset(0, 49);
        head.addBox(1.0F, -10.0F, -14.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
        head.setTextureOffset(0, 41);
        head.addBox(-3.0F, -7.0F, -8.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
        head.setTextureOffset(27, 30);
        head.addBox(0.0F, -8.0F, -4.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

        bottom_jaw = new AdvancedModelBox(this, "bottom_jaw");
        bottom_jaw.setRotationPoint(0.0F, 2.0F, -16.0F);
        head.addChild(bottom_jaw);
        bottom_jaw.setTextureOffset(27, 30);
        bottom_jaw.addBox(-4.0F, 0.0F, -9.0F, 8.0F, 3.0F, 9.0F, 0.0F, false);
        bottom_jaw.setTextureOffset(0, 92);
        bottom_jaw.addBox(-3.5F, -2.0F, -9.0F, 7.0F, 2.0F, 9.0F, 0.0F, false);

        top_jaw = new AdvancedModelBox(this, "top_jaw");
        top_jaw.setRotationPoint(0.0F, 2.0F, -16.0F);
        head.addChild(top_jaw);
        top_jaw.setTextureOffset(103, 92);
        top_jaw.addBox(-3.0F, -4.0F, -9.0F, 6.0F, 4.0F, 9.0F, 0.0F, false);
        top_jaw.setTextureOffset(0, 104);
        top_jaw.addBox(-3.0F, 0.0F, -9.0F, 6.0F, 2.0F, 9.0F, 0.0F, false);
        top_jaw.setTextureOffset(0, 30);
        top_jaw.addBox(-2.0F, -4.0F, -11.0F, 4.0F, 8.0F, 2.0F, 0.0F, false);

        shell = new AdvancedModelBox(this, "shell");
        shell.setRotationPoint(0.0F, -27.0F, 1.0F);
        body.addChild(shell);
        shell.setTextureOffset(0, 92);
        shell.addBox(-16.0F, -7.0F, -19.0F, 32.0F, 7.0F, 38.0F, 0.0F, false);

        vent1 = new AdvancedModelBox(this, "vent1");
        vent1.setRotationPoint(10.5F, -27.0F, -26.5F);
        body.addChild(vent1);
        vent1.setTextureOffset(224, 65);
        vent1.addBox(-2.5F, -10.0F, -2.5F, 5.0F, 10.0F, 5.0F, 0.0F, false);

        vent2 = new AdvancedModelBox(this, "vent2");
        vent2.setRotationPoint(7.0F, -27.0F, 27.0F);
        body.addChild(vent2);
        vent2.setTextureOffset(216, 104);
        vent2.addBox(-2.0F, -7.0F, -2.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);

        vent3 = new AdvancedModelBox(this, "vent3");
        vent3.setRotationPoint(-6.5F, -27.0F, 24.5F);
        body.addChild(vent3);
        vent3.setTextureOffset(182, 103);
        vent3.addBox(-2.5F, -14.0F, -2.5F, 5.0F, 14.0F, 5.0F, 0.0F, false);

        vent4 = new AdvancedModelBox(this, "vent4");
        vent4.setRotationPoint(-6.0F, -27.0F, -23.0F);
        body.addChild(vent4);
        vent4.setTextureOffset(226, 124);
        vent4.addBox(-3.0F, -13.0F, -3.0F, 6.0F, 13.0F, 6.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityLaviathan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
