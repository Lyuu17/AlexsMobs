...
public class ModelMoose extends AdvancedEntityModel<EntityMoose> {
    ...
    public ModelMoose() {
        ...
        root.addChild(body);
        body.setTextureOffset(37, 80);
        body.addBox(-6.0F, -8.0F, -4.0F, 12.0F, 15.0F, 20.0F, 0.0F, false);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setPos(4.7F, 6.0F, -13.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(19, 58);
        left_arm.addBox(-2.0F, 1.0F, -2.0F, 4.0F, 21.0F, 4.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setPos(-4.7F, 6.0F, -13.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(19, 58);
        right_arm.addBox(-2.0F, 1.0F, -2.0F, 4.0F, 21.0F, 4.0F, 0.0F, true);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setPos(3.7F, 6.0F, 14.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(0, 58);
        left_leg.addBox(-2.0F, 1.0F, -3.0F, 4.0F, 21.0F, 5.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setPos(-3.7F, 6.0F, 14.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(0, 58);
        right_leg.addBox(-2.0F, 1.0F, -3.0F, 4.0F, 21.0F, 5.0F, 0.0F, true);

        upper_body = new AdvancedModelBox(this, "upper_body");
        upper_body.setPos(0.0F, -1.0F, -4.0F);
        body.addChild(upper_body);
        upper_body.setTextureOffset(52, 45);
        upper_body.addBox(-7.0F, -10.0F, -13.0F, 14.0F, 18.0F, 13.0F, 0.0F, false);

        neck = new AdvancedModelBox(this, "neck");
        neck.setPos(0.0F, -6.0F, -14.0F);
        upper_body.addChild(neck);
        neck.setTextureOffset(45, 0);
        neck.addBox(-4.0F, -3.0F, -6.0F, 8.0F, 9.0F, 7.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setPos(0.0F, 0.0F, -7.0F);
        neck.addChild(head);
        head.setTextureOffset(51, 18);
        head.addBox(-3.0F, -3.0F, -15.0F, 6.0F, 7.0F, 16.0F, 0.0F, false);
        head.setTextureOffset(0, 34);
        head.addBox(3.0F, -12.0F, -7.0F, 18.0F, 9.0F, 14.0F, 0.0F, false);
        head.setTextureOffset(0, 34);
        head.addBox(-21.0F, -12.0F, -7.0F, 18.0F, 9.0F, 14.0F, 0.0F, true);
        ...
        left_ear.addBox(-0.3F, -4.0F, -0.5F, 2.0F, 4.0F, 1.0F, 0.0F, false);
        ...
        right_ear.addBox(-1.7F, -4.0F, -0.5F, 2.0F, 4.0F, 1.0F, 0.0F, true);

        beard = new AdvancedModelBox(this, "beard");
        beard.setPos(0.0F, 4.0F, 0.0F);
        head.addChild(beard);
        beard.setTextureOffset(0, 0);
        beard.addBox(0.0F, 0.0F, -4.0F, 0.0F, 6.0F, 5.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityMoose entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetToDefaultPose();
