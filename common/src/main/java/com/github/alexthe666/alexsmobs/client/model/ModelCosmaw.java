...
public class ModelCosmaw extends AdvancedEntityModel<EntityCosmaw> {
    ...
    public ModelCosmaw() {
        ...
        body.addBox(-6.5F, -7.0F, -20.0F, 13.0F, 14.0F, 32.0F, 0.0F, false);

        leftArm = new AdvancedModelBox(this, "leftArm");
        leftArm.setRotationPoint(5.0F, 7.0F, -12.2F);
        body.addChild(leftArm);
        leftArm.setTextureOffset(17, 47);
        leftArm.addBox(-1.0F, 0.0F, -0.8F, 2.0F, 4.0F, 3.0F, 0.0F, false);
        leftArm.setTextureOffset(0, 13);
        leftArm.addBox(0.0F, 2.0F, 1.2F, 0.0F, 4.0F, 3.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this, "rightArm");
        rightArm.setRotationPoint(-5.0F, 7.0F, -12.2F);
        body.addChild(rightArm);
        rightArm.setTextureOffset(17, 47);
        rightArm.addBox(-1.0F, 0.0F, -0.8F, 2.0F, 4.0F, 3.0F, 0.0F, true);
        rightArm.setTextureOffset(0, 13);
        rightArm.addBox(0.0F, 2.0F, 1.2F, 0.0F, 4.0F, 3.0F, 0.0F, true);

        leftFin = new AdvancedModelBox(this, "leftFin");
        leftFin.setRotationPoint(4.5F, -6.0F, 0.0F);
        body.addChild(leftFin);
        leftFin.setTextureOffset(33, 47);
        leftFin.addBox(0.0F, 0.0F, -5.0F, 9.0F, 0.0F, 27.0F, 0.0F, false);

        rightFin = new AdvancedModelBox(this, "rightFin");
        rightFin.setRotationPoint(-4.5F, -6.0F, 0.0F);
        body.addChild(rightFin);
        rightFin.setTextureOffset(33, 47);
        rightFin.addBox(-9.0F, 0.0F, -5.0F, 9.0F, 0.0F, 27.0F, 0.0F, true);
        ...
        mouthArm1.setTextureOffset(65, 75);
        mouthArm1.addBox(-2.0F, -1.0F, -20.0F, 4.0F, 4.0F, 22.0F, 0.0F, false);
        ...
        mouthArm2.setTextureOffset(79, 32);
        mouthArm2.addBox(-2.0F, -4.0F, -17.0F, 4.0F, 4.0F, 17.0F, -0.1F, false);
        ...
        topJaw.setTextureOffset(0, 13);
        topJaw.addBox(-2.5F, -3.0F, -7.0F, 5.0F, 3.0F, 8.0F, 0.0F, false);

        lowerJaw = new AdvancedModelBox(this, "lowerJaw");
        lowerJaw.setRotationPoint(0.0F, -1.0F, 0.3F);
        mouth.addChild(lowerJaw);
        lowerJaw.setTextureOffset(0, 0);
        lowerJaw.addBox(-3.0F, 0.0F, -9.0F, 6.0F, 3.0F, 9.0F, 0.0F, false);

        eyesBase = new AdvancedModelBox(this, "eyesBase");
        eyesBase.setRotationPoint(0.0F, -7.0F, -11.0F);
        body.addChild(eyesBase);
        eyesBase.setTextureOffset(3, 69);
        eyesBase.addBox(-11.0F, -1.0F, -1.0F, 23.0F, 2.0F, 2.0F, 0.0F, false);

        leftEye = new AdvancedModelBox(this, "leftEye");
        leftEye.setRotationPoint(13.0F, 0.0F, 0.0F);
        eyesBase.addChild(leftEye);
        leftEye.setTextureOffset(0, 47);
        leftEye.addBox(-1.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F, 0.0F, false);

        rightEye = new AdvancedModelBox(this, "rightEye");
        rightEye.setRotationPoint(-12.0F, 0.0F, 1.0F);
        eyesBase.addChild(rightEye);
        rightEye.setTextureOffset(0, 47);
        rightEye.addBox(-1.0F, -3.0F, -4.0F, 2.0F, 6.0F, 6.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -1.8F, 11.6F);
        body.addChild(tail);
        tail.setTextureOffset(59, 0);
        tail.addBox(-4.5F, -5.0F, 0.0F, 9.0F, 11.0F, 20.0F, 0.0F, false);

        leftLeg = new AdvancedModelBox(this, "leftLeg");
        leftLeg.setRotationPoint(3.0F, 5.8F, 3.2F);
        tail.addChild(leftLeg);
        leftLeg.setTextureOffset(19, 13);
        leftLeg.addBox(-1.0F, 0.0F, -0.8F, 2.0F, 4.0F, 3.0F, 0.0F, false);
        leftLeg.setTextureOffset(0, 0);
        leftLeg.addBox(0.0F, 2.0F, 1.2F, 0.0F, 4.0F, 3.0F, 0.0F, false);

        rightLeg = new AdvancedModelBox(this, "rightLeg");
        rightLeg.setRotationPoint(-3.0F, 5.8F, 3.2F);
        tail.addChild(rightLeg);
        rightLeg.setTextureOffset(19, 13);
        rightLeg.addBox(-1.0F, 0.0F, -0.8F, 2.0F, 4.0F, 3.0F, 0.0F, true);
        rightLeg.setTextureOffset(0, 0);
        rightLeg.addBox(0.0F, 2.0F, 1.2F, 0.0F, 4.0F, 3.0F, 0.0F, true);

        tailFin = new AdvancedModelBox(this, "tailFin");
        tailFin.setRotationPoint(0.0F, 1.0F, 7.0F);
        tail.addChild(tailFin);
        tailFin.setTextureOffset(0, 47);
        tailFin.addBox(0.0F, -10.0F, -3.0F, 0.0F, 19.0F, 32.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityCosmaw entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float eyeYaw = (MathHelper.clamp(netHeadYaw, -40, 40) / 57.295776F);
