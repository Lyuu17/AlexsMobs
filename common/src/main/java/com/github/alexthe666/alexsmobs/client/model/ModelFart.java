...
public class ModelFart extends AdvancedEntityModel<EntityFart> {
    ...
    public ModelFart() {
        ...
        main.addBox(-4.0F, -4.0F, -5.0F, 8.0F, 8.0F, 11.0F, 0.0F, false);

        cube_r1 = new AdvancedModelBox(this);
        cube_r1.setRotationPoint(0.0F, 0.0F, 0.5F);
        main.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, 0.0F, -0.7854F);
        cube_r1.setTextureOffset(0, 20);
        cube_r1.addBox(0.0F, -4.0F, -2.5F, 0.0F, 8.0F, 11.0F, 0.0F, true);

        cube_r2 = new AdvancedModelBox(this);
        cube_r2.setRotationPoint(0.0F, 0.0F, 0.5F);
        main.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.0F, 0.7854F);
        cube_r2.setTextureOffset(0, 20);
        cube_r2.addBox(0.0F, -4.0F, -2.5F, 0.0F, 8.0F, 11.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityFart entity, float limbSwing, float limbSwingAmount, float partialTicks, float netHeadYaw, float headPitch){
        this.resetToDefaultPose();
        float f = Math.min(entity.age + partialTicks, 30) / 30F;
        float expand = 1.5F * f;
