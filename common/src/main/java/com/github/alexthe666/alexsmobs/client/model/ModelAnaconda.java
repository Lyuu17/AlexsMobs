...
public class ModelAnaconda<T extends LivingEntity> extends AdvancedEntityModel<T> {
    ...
    public ModelAnaconda(AnacondaPartIndex index) {
        ...
        switch (index) {
            case HEAD -> {
                ...
                part.setTextureOffset(62, 32);
                part.addBox(-3.5F, -3.0F, -9.0F, 7.0F, 3.0F, 10.0F, 0.0F, false);
                part.setTextureOffset(67, 0);
                part.addBox(-3.5F, -1.0F, -9.0F, 7.0F, 0.0F, 10.0F, 0.0F, false);
                jaw = new AdvancedModelBox(this, "jaw");
                jaw.setRotationPoint(0, 0, 0);
                jaw.setTextureOffset(52, 55);
                jaw.addBox(-3.5F, -1.0F, -9, 7.0F, 4.0F, 10.0F, 0.0F, false);
                jaw.setTextureOffset(66, 11);
                jaw.addBox(-3.5F, 0.0F, -9, 7.0F, 0.0F, 10.0F, 0.0F, false);
                part.addChild(jaw);
            }
            case NECK -> {
                part.setRotationPoint(0.0F, 0, 0.0F);
                part.setTextureOffset(33, 32);
                part.addBox(-3.0F, -3.0F, -8, 6.0F, 6.0F, 16.0F, 0.0F, false);
            }
            case BODY -> {
                part.setRotationPoint(0.0F, 0, -8.0F);
                part.setTextureOffset(33, 8);
                part.addBox(-4.0F, -4.0F, 0, 8.0F, 7.0F, 16.0F, 0.0F, false);
            }
            case TAIL -> {
                part.setRotationPoint(0.0F, 0, -7.0F);
                part.setTextureOffset(29, 55);
                part.addBox(-1.5F, -2.0F, 0, 3.0F, 4.0F, 16.0F, 0.0F, false);
            }
        }
        root.addChild(part);
    ...
    public void setAngles(LivingEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        }else if(entity instanceof EntityAnacondaPart partEntity){ //body
            //int i = MathHelper.clamp(partEntity.getBodyIndex(), 0 , 6);
            float f = 1.01F;
