...
public class ModelToucan extends AdvancedEntityModel<EntityToucan> {
    ...
    public ModelToucan() {
        ...
        body.addBox(-2.0F, -3.0F, -5.0F, 4.0F, 4.0F, 7.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 2.0F);
        body.addChild(tail);
        setRotationAngle(tail, 0.3927F, 0.0F, 0.0F);
        tail.setTextureOffset(18, 7);
        tail.addBox(-1.5F, -1.0F, 0.0F, 3.0F, 2.0F, 5.0F, 0.0F, false);
        ...
        left_wing.setTextureOffset(11, 16);
        left_wing.addBox(0.0F, -1.0F, -1.0F, 1.0F, 4.0F, 6.0F, 0.0F, false);
        ...
        left_wingtip.setTextureOffset(20, 21);
        left_wingtip.addBox(0.0F, -1.0F, -1.0F, 0.0F, 3.0F, 6.0F, 0.0F, false);
        ...
        right_wing.setTextureOffset(11, 16);
        right_wing.addBox(-1.0F, -1.0F, -1.0F, 1.0F, 4.0F, 6.0F, 0.0F, true);
        ...
        right_wingtip.setTextureOffset(20, 21);
        right_wingtip.addBox(0.0F, -1.0F, -1.0F, 0.0F, 3.0F, 6.0F, 0.0F, true);
        ...
        left_leg.addBox(-0.5F, 0.0F, -2.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        right_leg.addBox(-0.5F, 0.0F, -2.0F, 1.0F, 3.0F, 2.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -2.0F, -4.0F);
        body.addChild(head);
        setRotationAngle(head, 0.48F, 0.0F, 0.0F);
        head.setTextureOffset(0, 24);
        head.addBox(-1.5F, -4.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);

        beak = new AdvancedModelBox(this, "beak");
        beak.setRotationPoint(0.0F, -4.0F, -1.8F);
        head.addChild(beak);
        beak.setTextureOffset(0, 12);
        beak.addBox(-1.0F, 0.0F, -6.0F, 2.0F, 3.0F, 6F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityToucan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
