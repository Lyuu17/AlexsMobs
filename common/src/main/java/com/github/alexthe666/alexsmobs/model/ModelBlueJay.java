...
public class ModelBlueJay extends AdvancedEntityModel<EntityBlueJay> {
    ...
    public ModelBlueJay() {
        ...
        body.addBox(-2.0F, -4.0F, -4.0F, 4.0F, 4.0F, 7.0F, 0.0F, false);
        ...
        leftLeg.setTextureOffset(26, 10);
        leftLeg.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(26, 10);
        rightLeg.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 3.0F, 2.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -3.0F, 3.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 22);
        tail.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 1.0F, 7.0F, 0.0F, false);

        leftWing = new AdvancedModelBox(this, "leftWing");
        leftWing.setRotationPoint(2.0F, -3.0F, -2.0F);
        body.addChild(leftWing);
        leftWing.setTextureOffset(15, 14);
        leftWing.addBox(0.0F, -1.0F, -1.0F, 1.0F, 3.0F, 8.0F, 0.0F, false);

        rightWing = new AdvancedModelBox(this, "rightWing");
        rightWing.setRotationPoint(-2.0F, -3.0F, -2.0F);
        body.addChild(rightWing);
        rightWing.setTextureOffset(15, 14);
        rightWing.addBox(-1.0F, -1.0F, -1.0F, 1.0F, 3.0F, 8.0F, 0.0F, true);
        ...
        head.addBox(-2.5F, -3.0F, -3.0F, 5.0F, 4.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(26, 16);
        head.addBox(-1.0F, -1.0F, -6.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);

        crest = new AdvancedModelBox(this, "crest");
        crest.setRotationPoint(0.0F, -2.0F, -1.0F);
        head.addChild(crest);
        setRotateAngle(crest, 0.3491F, 0.0F, 0.0F);
        crest.setTextureOffset(0, 12);
        crest.addBox(-2.5F, -1.0F, 0.0F, 5.0F, 3.0F, 6.0F, -0.01F, false);
    ...
    @Override
    public void setAngles(EntityBlueJay entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
