...
public class ModelSoulVulture extends AdvancedEntityModel<EntitySoulVulture> {
	...
	public ModelSoulVulture() {
		...
		body.addBox(-3.0F, -6.0F, -9.0F, 6.0F, 6.0F, 10.0F, 0.0F, false);
		body.setTextureOffset(26, 25);
		body.addBox(-3.5F, -6.5F, -9.2F, 7.0F, 6.0F, 7.0F, 0.0F, false);
		...
		leftWing.setTextureOffset(36, 15);
		leftWing.addBox(-1.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, false);
		leftWing.setTextureOffset(0, 0);
		leftWing.addBox(-1.0F, 0.0F, 0.0F, 24.0F, 0.0F, 14.0F, 0.0F, false);
		...
		rightWing.setTextureOffset(36, 15);
		rightWing.addBox(-6.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, 0.0F, true);
		rightWing.setTextureOffset(0, 0);
		rightWing.addBox(-23.0F, 0.0F, 0.0F, 24.0F, 0.0F, 14.0F, 0.0F, true);

		heart = new AdvancedModelBox(this, "heart");
		heart.setRotationPoint(0.0F, 0.0F, -6.0F);
		body.addChild(heart);
		heart.setTextureOffset(0, 15);
		heart.addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		leftLeg.setTextureOffset(0, 6);
		leftLeg.addBox(-1.0F, -1.0F, -4.0F, 1.0F, 4.0F, 4.0F, 0.0F, false);
		...
		leftFoot.setTextureOffset(0, 0);
		leftFoot.addBox(-2.0F, 0.0F, -2.0F, 3.0F, 2.0F, 3.0F, 0.0F, false);
		...
		rightLeg.setTextureOffset(0, 6);
		rightLeg.addBox(0.0F, -1.0F, -4.0F, 1.0F, 4.0F, 4.0F, 0.0F, true);
		...
		rightFoot.setTextureOffset(0, 0);
		rightFoot.addBox(-1.0F, 0.0F, -2.0F, 3.0F, 2.0F, 3.0F, 0.0F, true);

		neck = new AdvancedModelBox(this, "neck");
		neck.setRotationPoint(0.0F, -2.5F, -10.0F);
		body.addChild(neck);
		setRotationAngle(neck, 0.48F, 0.0F, 0.0F);
		neck.setTextureOffset(17, 39);
		neck.addBox(-1.5F, -1.5F, -7.0F, 3.0F, 3.0F, 8.0F, 0.0F, false);
		...
		head.addBox(-2.5F, -3.0F, -5.0F, 5.0F, 4.0F, 7.0F, 0.0F, false);
		head.setTextureOffset(23, 15);
		head.addBox(-1.5F, -2.0F, -11.0F, 3.0F, 3.0F, 6.0F, 0.0F, false);
		head.setTextureOffset(32, 39);
		head.addBox(-1.5F, 1.0F, -11.0F, 3.0F, 1.0F, 2.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntitySoulVulture entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
