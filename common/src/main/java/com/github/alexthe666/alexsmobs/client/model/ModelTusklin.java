...
public class ModelTusklin extends AdvancedEntityModel<EntityTusklin> {
    ...
    public ModelTusklin() {
        ...
        root.addChild(body);
        body.setTextureOffset(52, 56);
        body.addBox(-8.0F, -7.0F, 0.0F, 16.0F, 15.0F, 15.0F, 0.0F, false);

        leg_left = new AdvancedModelBox(this, "leg_left");
        leg_left.setRotationPoint(6.0F, 8.0F, 13.0F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(58, 0);
        leg_left.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 11.0F, 7.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this, "leg_right");
        leg_right.setRotationPoint(-6.0F, 8.0F, 13.0F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(58, 0);
        leg_right.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 11.0F, 7.0F, 0.0F, true);

        torso = new AdvancedModelBox(this, "torso");
        torso.setRotationPoint(0.0F, 0.0F, -1.0F);
        body.addChild(torso);
        torso.setTextureOffset(0, 0);
        torso.addBox(-9.0F, -11.0F, -20.0F, 18.0F, 20.0F, 21.0F, 0.0F, false);
        torso.setTextureOffset(0, 0);
        torso.addBox(0.0F, -16.0F, -20.0F, 0.0F, 5.0F, 10.0F, 0.0F, false);

        arm_left = new AdvancedModelBox(this, "arm_left");
        arm_left.setRotationPoint(5.5F, 10.0F, -14.0F);
        torso.addChild(arm_left);
        arm_left.setTextureOffset(0, 71);
        arm_left.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 9.0F, 6.0F, 0.0F, false);

        arm_right = new AdvancedModelBox(this, "arm_right");
        arm_right.setRotationPoint(-5.5F, 10.0F, -14.0F);
        torso.addChild(arm_right);
        arm_right.setTextureOffset(0, 71);
        arm_right.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 9.0F, 6.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -5.0F, -22.0F);
        torso.addChild(head);
        setRotationAngle(head, 0.5236F, 0.0F, 0.0F);
        head.setTextureOffset(0, 42);
        head.addBox(-7.0F, -3.0F, -17.0F, 14.0F, 9.0F, 19.0F, 0.0F, false);
        head.setTextureOffset(52, 50);
        head.addBox(0.0F, 6.0F, -16.0F, 0.0F, 3.0F, 7.0F, 0.0F, false);
        head.setTextureOffset(0, 42);
        head.addBox(0.0F, -10.0F, -5.0F, 0.0F, 7.0F, 7.0F, 0.0F, false);

        tusk_left = new AdvancedModelBox(this, "tusk_left");
        tusk_left.setRotationPoint(8.0F, 2.0F, -13.5F);
        head.addChild(tusk_left);
        tusk_left.setTextureOffset(48, 42);
        tusk_left.addBox(-1.0F, -11.0F, -1.5F, 2.0F, 11.0F, 3.0F, 0.0F, false);
        tusk_left.setTextureOffset(59, 42);
        tusk_left.addBox(-1.0F, -11.0F, 1.5F, 2.0F, 3.0F, 4.0F, 0.0F, false);

        tusk_right = new AdvancedModelBox(this, "tusk_right");
        tusk_right.setRotationPoint(-8.0F, 2.0F, -13.5F);
        head.addChild(tusk_right);
        tusk_right.setTextureOffset(48, 42);
        tusk_right.addBox(-1.0F, -11.0F, -1.5F, 2.0F, 11.0F, 3.0F, 0.0F, true);
        tusk_right.setTextureOffset(59, 42);
        tusk_right.addBox(-1.0F, -11.0F, 1.5F, 2.0F, 3.0F, 4.0F, 0.0F, true);
        ...
        earLeft_r1.setTextureOffset(68, 46);
        earLeft_r1.addBox(-1.0F, -1.0F, -3.0F, 1.0F, 5.0F, 4.0F, 0.0F, false);
        ...
        earLeft_r2.setTextureOffset(68, 46);
        earLeft_r2.addBox(0.0F, -1.0F, -3.0F, 1.0F, 5.0F, 4.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityTusklin entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
