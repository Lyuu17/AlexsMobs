...
public class ModelTransmutationTable extends AdvancedEntityModel<Entity> {
    ...
    public ModelTransmutationTable(float scale) {
        ...
        base.addBox(-7.0F, -5.0F, -7.0F, 14.0F, 5.0F, 14.0F, scale, false);

        star = new AdvancedModelBox(this, "star");
        star.setRotationPoint(0.0F, -12.5F, 0.0F);
        base.addChild(star);
        star.setTextureOffset(0, 20);
        star.addBox(-2.5F, -2.5F, -2.5F, 5.0F, 5.0F, 5.0F, scale, false);

        portal = new AdvancedModelBox(this, "portal");
        portal.setRotationPoint(0.0F, -12.5F, 0.0F);
        base.addChild(portal);
        portal.setTextureOffset(21, 20);
        portal.addBox(-4.1F, -4.5F, 0.0F, 9.0F, 9.0F, 0.0F, scale, false);
        ...
        leftArm.setTextureOffset(13, 39);
        leftArm.addBox(-1.0F, -6.0F, -1.0F, 2.0F, 7.0F, 2.0F, scale, false);
        ...
        leftElbow.setTextureOffset(0, 36);
        leftElbow.addBox(-3.0F, -2.0F, -1.0F, 5.0F, 2.0F, 2.0F, scale -0.1F, false);
        ...
        leftHand.setTextureOffset(31, 39);
        leftHand.addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, scale, false);
        leftHand.setTextureOffset(32, 30);
        leftHand.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 6.0F, scale, false);
        ...
        rightArm.setTextureOffset(13, 39);
        rightArm.addBox(-1.0F, -6.0F, -1.0F, 2.0F, 7.0F, 2.0F, scale, true);
        ...
        rightElbow.setTextureOffset(0, 36);
        rightElbow.addBox(-2.0F, -2.0F, -1.0F, 5.0F, 2.0F, 2.0F, scale -0.1F, true);
        ...
        rightHand.setTextureOffset(31, 39);
        rightHand.addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, scale, true);
        rightHand.setTextureOffset(32, 30);
        rightHand.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 6.0F, scale, true);
    ...
    public void animate(TransmutationTableBlockEntity beak, float partialTick) {
        this.resetToDefaultPose();
