...
public abstract class EntityCockroach extends Animal implements Shearable, ITargetsDroppedItems {
    ...
    public EntityCockroach(EntityType<? extends Animal> type, Level world) {
        super(type, world);
    }
    ...
    @NotNull
    @Override
    public InteractionResult mobInteract(@NotNull Player p_230254_1_, @NotNull InteractionHand p_230254_2_) {
