...
public class AMTagRegistry {
    ...
    private static TagKey<EntityType<?>> registerEntityTag(String name) {
        return TagKey.of(RegistryKeys.ENTITY_TYPE, new Identifier(AlexsMobs.MOD_ID, name));
    }

    private static TagKey<Item> registerItemTag(String name) {
        return TagKey.of(RegistryKeys.ITEM, new Identifier(AlexsMobs.MOD_ID, name));
    }

    private static TagKey<Block> registerBlockTag(String name) {
        return TagKey.of(RegistryKeys.BLOCK, new Identifier(AlexsMobs.MOD_ID, name));
    }

    private static TagKey<Biome> registerBiomeTag(String name) {
        return TagKey.of(RegistryKeys.BIOME, new Identifier(AlexsMobs.MOD_ID, name));
    }

    private static TagKey<Structure> registerStructureTag(String name) {
        return TagKey.of(RegistryKeys.STRUCTURE, new Identifier(AlexsMobs.MOD_ID, name));
    }
}
