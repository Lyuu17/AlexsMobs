...
public class ItemAnimalDictionary extends Item {
    ...
    public InteractionResult interactLivingEntity(ItemStack stack, Player playerIn, LivingEntity target, InteractionHand hand) {
        ...
        if (playerIn.level().isClientSide && target.getEncodeId() != null && target.getEncodeId().contains(AlexsMobs.MOD_ID + ":")) {
            usedOnEntity = true;
            String id = target.getEncodeId().replace(AlexsMobs.MOD_ID + ":", "");
