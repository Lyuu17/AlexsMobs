...
public class ModelEndPirateDoor extends AdvancedEntityModel<Entity> {
    ...
    public ModelEndPirateDoor() {
        ...
        doorRightHinge.setTextureOffset(0, 0);
        doorRightHinge.addBox(-15.0F, -24.0F, -1.0F, 16.0F, 48.0F, 2.0F, 0.0F, false);
        ...
        doorLeftHinge.setTextureOffset(0, 0);
        doorLeftHinge.addBox(-1.0F, -24.0F, -1.0F, 16.0F, 48.0F, 2.0F, 0.0F, true);
    ...
    public void renderDoor(EndPirateDoorBlockEntity door, float partialTick, boolean left) {
