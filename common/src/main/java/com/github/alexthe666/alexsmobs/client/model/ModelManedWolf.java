...
public class ModelManedWolf extends AdvancedEntityModel<EntityManedWolf> {
    ...
    public ModelManedWolf() {
        ...
        body.addBox(-3.0F, -4.0F, -10.0F, 6.0F, 8.0F, 17.0F, 0.0F, false);
        body.setTextureOffset(0, 26);
        body.addBox(-3.5F, -4.4F, -10.1F, 7.0F, 5.0F, 8.0F, 0.0F, false);

        neck = new AdvancedModelBox(this, "neck");
        neck.setRotationPoint(0.0F, -1.0F, -9.0F);
        body.addChild(neck);
        setRotationAngle(neck, -0.6545F, 0.0F, 0.0F);
        neck.setTextureOffset(30, 0);
        neck.addBox(-2.5F, -3.0F, -6.0F, 5.0F, 5.0F, 7.0F, 0.0F, false);
        neck.setTextureOffset(42, 39);
        neck.addBox(-1.5F, -6.0F, -5.0F, 3.0F, 3.0F, 6.0F, 0.0F, false);
        ...
        head.setTextureOffset(0, 40);
        head.addBox(-3.0F, -2.0F, -4.0F, 6.0F, 5.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(44, 22);
        head.addBox(-1.5F, 0.0F, -8.0F, 3.0F, 3.0F, 4.0F, 0.0F, false);
        ...
        left_ear.setTextureOffset(47, 13);
        left_ear.addBox(-1.0F, -5.0F, -0.4F, 3.0F, 6.0F, 1.0F, 0.0F, false);
        ...
        right_ear.setTextureOffset(47, 13);
        right_ear.addBox(-2.0F, -5.0F, -0.4F, 3.0F, 6.0F, 1.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 7.0F);
        body.addChild(tail);
        tail.setTextureOffset(31, 26);
        tail.addBox(-2.0F, -1.0F, -1.0F, 4.0F, 14.0F, 4.0F, 0.0F, false);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setRotationPoint(1.8F, 5.0F, -8.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(0, 0);
        left_arm.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setRotationPoint(-1.8F, 5.0F, -8.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(0, 0);
        right_arm.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 13.0F, 2.0F, 0.0F, true);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setRotationPoint(2.0F, 3.0F, 5.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(23, 42);
        left_leg.addBox(-0.8F, -2.0F, -0.9F, 2.0F, 16.0F, 3.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setRotationPoint(-2.0F, 3.0F, 5.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(23, 42);
        right_leg.addBox(-1.2F, -2.0F, -0.9F, 2.0F, 16.0F, 3.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityManedWolf entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.left_ear_pivot.rotateAngleX += earPitch * MathHelper.RADIANS_PER_DEGREE;
        this.left_ear_pivot.rotateAngleY += earYaw * MathHelper.RADIANS_PER_DEGREE;
        this.right_ear_pivot.rotateAngleX += earPitch * MathHelper.RADIANS_PER_DEGREE;
        this.right_ear_pivot.rotateAngleY -= earYaw * MathHelper.RADIANS_PER_DEGREE;
        ...
        float f1 = 0.2F * danceProgress * (float) (-Math.abs(Math.sin(ageInTicks * 0.5F * 0.5F) * (double) 8F));
