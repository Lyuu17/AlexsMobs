...
public class ModelKomodoDragon extends AdvancedEntityModel<EntityKomodoDragon> {
	...
	public ModelKomodoDragon(float scale) {
		...
		body.addBox(-5.0F, -4.0F, -11.0F, 10.0F, 9.0F, 23.0F, scale, false);

		neck = new AdvancedModelBox(this, "neck");
		neck.setRotationPoint(0.0F, -1.0F, -10.0F);
		body.addChild(neck);
		neck.setTextureOffset(0, 60);
		neck.addBox(-3.5F, -3.0F, -7.0F, 7.0F, 7.0F, 6.0F, scale, false);

		head = new AdvancedModelBox(this, "head");
		head.setRotationPoint(0.0F, -1.0F, -7.0F);
		neck.addChild(head);
		head.setTextureOffset(44, 0);
		head.addBox(-3.5F, -2.0F, -10.0F, 7.0F, 5.0F, 10.0F, scale, false);

		tongue = new AdvancedModelBox(this, "tongue");
		tongue.setRotationPoint(0.0F, 1.0F, -10.0F);
		head.addChild(tongue);
		tongue.setTextureOffset(60, 26);
		tongue.addBox(-1.5F, 0.0F, -7.0F, 3.0F, 0.0F, 7.0F, scale, false);

		tail1 = new AdvancedModelBox(this, "tail1");
		tail1.setRotationPoint(0.0F, -1.0F, 11.0F);
		body.addChild(tail1);
		tail1.setTextureOffset(0, 33);
		tail1.addBox(-3.0F, -2.0F, 1.0F, 6.0F, 6.0F, 20.0F, scale, false);

		tail2 = new AdvancedModelBox(this, "tail2");
		tail2.setRotationPoint(0.0F, 1.0F, 20.0F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(35, 42);
		tail2.addBox(-1.5F, -2.0F, 1.0F, 3.0F, 4.0F, 18.0F, scale, false);
		...
		left_arm.setTextureOffset(0, 33);
		left_arm.addBox(-2.0F, -3.0F, -2.0F, 4.0F, 12.0F, 4.0F, scale, false);
		left_arm.setTextureOffset(57, 34);
		left_arm.addBox(-4.0F, 8.99F, -5.0F, 8.0F, 0.0F, 7.0F, scale, false);
		...
		right_arm.setTextureOffset(0, 33);
		right_arm.addBox(-2.0F, -3.0F, -2.0F, 4.0F, 12.0F, 4.0F, scale, true);
		right_arm.setTextureOffset(57, 34);
		right_arm.addBox(-4.0F, 8.99F, -5.0F, 8.0F, 0.0F, 7.0F, scale, true);
		...
		left_leg.addBox(-1.0F, -3.0F, -2.0F, 4.0F, 12.0F, 5.0F, scale, false);
		left_leg.setTextureOffset(33, 33);
		left_leg.addBox(-3.0F, 8.99F, -5.0F, 8.0F, 0.0F, 7.0F, scale, false);
		...
		right_leg.addBox(-3.0F, -3.0F, -2.0F, 4.0F, 12.0F, 5.0F, scale, true);
		right_leg.setTextureOffset(33, 33);
		right_leg.addBox(-5.0F, 8.99F, -5.0F, 8.0F, 0.0F, 7.0F, scale, true);
	...
	@Override
	public void setAngles(EntityKomodoDragon entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
