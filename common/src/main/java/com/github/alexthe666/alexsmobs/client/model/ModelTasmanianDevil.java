...
public class ModelTasmanianDevil extends AdvancedEntityModel<EntityTasmanianDevil> {
	...
	public ModelTasmanianDevil() {
		...
		body.addBox(-3.5F, -3.0F, -5.0F, 7.0F, 6.0F, 11.0F, 0.0F, false);

		armLeft = new AdvancedModelBox(this);
		armLeft.setRotationPoint(2.6F, 3.0F, -3.0F);
		body.addChild(armLeft);
		armLeft.setTextureOffset(26, 18);
		armLeft.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

		armRight = new AdvancedModelBox(this);
		armRight.setRotationPoint(-2.6F, 3.0F, -3.0F);
		body.addChild(armRight);
		armRight.setTextureOffset(26, 18);
		armRight.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, true);

		legLeft = new AdvancedModelBox(this);
		legLeft.setRotationPoint(2.6F, 3.0F, 4.0F);
		body.addChild(legLeft);
		legLeft.setTextureOffset(0, 0);
		legLeft.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);

		legRight = new AdvancedModelBox(this);
		legRight.setRotationPoint(-2.6F, 3.0F, 4.0F);
		body.addChild(legRight);
		legRight.setTextureOffset(0, 0);
		legRight.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 2.0F, 0.0F, true);

		head = new AdvancedModelBox(this);
		head.setRotationPoint(0.0F, -2.0F, -6.0F);
		body.addChild(head);
		head.setTextureOffset(0, 18);
		head.addBox(-3.0F, -2.0F, -3.0F, 6.0F, 4.0F, 4.0F, 0.0F, false);
		head.setTextureOffset(26, 0);
		head.addBox(-2.0F, -2.0F, -6.0F, 4.0F, 4.0F, 3.0F, 0.0F, false);
		...
		earLeft.setTextureOffset(0, 27);
		earLeft.addBox(-1.0F, -3.0F, -1.0F, 3.0F, 3.0F, 1.0F, 0.0F, false);
		...
		earRight.setTextureOffset(0, 27);
		earRight.addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 1.0F, 0.0F, true);

		tail = new AdvancedModelBox(this);
		tail.setRotationPoint(0.0F, -2.0F, 6.0F);
		body.addChild(tail);
		setRotationAngle(tail, -0.5236F, 0.0F, 0.0F);
		tail.setTextureOffset(15, 21);
		tail.addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 6.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityTasmanianDevil entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
