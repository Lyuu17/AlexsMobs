...
public class ModelBaldEagle extends AdvancedEntityModel<EntityBaldEagle> {
    ...
    public ModelBaldEagle() {
        ...
        head.setTextureOffset(1, 3);
        head.addBox(-1.5F, -4.4F, -1.0F, 3.0F, 6.0F, 3.0F, 0.0F, false);

        topHead = new AdvancedModelBox(this, "topHead");
        topHead.setPos(0.0F, -4.9F, -0.5F);
        head.addChild(topHead);
        topHead.setTextureOffset(10, 0);
        topHead.addBox(-1.5F, -0.5F, -1.5F, 3.0F, 1.0F, 4.0F, 0.0F, false);

        beak1 = new AdvancedModelBox(this, "beak1");
        beak1.setPos(0.0F, -3.5F, -0.7F);
        head.addChild(beak1);
        setRotationAngle(beak1, -0.1745F, 0.0F, 0.0F);
        beak1.setTextureOffset(21, 9);
        beak1.addBox(-0.5F, -1.0F, -1.94F, 1.0F, 2.0F, 2.0F, 0.0F, false);

        beak2 = new AdvancedModelBox(this, "beak2");
        beak2.setPos(0.0F, -1.0F, -2.54F);
        beak1.addChild(beak2);
        beak2.setTextureOffset(16, 9);
        beak2.addBox(-0.5F, 0.01F, -0.4F, 1.0F, 3.0F, 1.0F, 0.0F, false);
        ...
        hood_tie.setTextureOffset(40, -4);
        hood_tie.addBox(0.0F, -4.0F, -2.0F, 0.0F, 5.0F, 4.0F, 0.0F, false);

        hood = new AdvancedModelBox(this, "hood");
        hood.setPos(0.0F, -4.9F, -0.5F);
        head.addChild(hood);
        hood.setTextureOffset(36, 7);
        hood.addBox(-1.5F, -0.5F, -1.5F, 3.0F, 4.0F, 4.0F, 0.0F, false);
        ...
        wingR.setTextureOffset(20, 14);
        wingR.addBox(-0.5F, -1.0F, -4.5F, 1.0F, 12.0F, 5.0F, 0.0F, true);

        feathersR = new AdvancedModelBox(this, "feathersR");
        feathersR.setPos(-0.5F, 0.8F, 1.6F);
        wingR.addChild(feathersR);
        feathersR.setTextureOffset(52, 10);
        feathersR.addBox(0.5F, -1.5F, -3.1F, 0.0F, 16.0F, 2.0F, 0.0F, true);

        tipR = new AdvancedModelBox(this, "tipR");
        tipR.setPos(-0.51F, 11.8F, 0.5F);
        wingR.addChild(tipR);
        setRotationAngle(tipR, 0.0F, 0.0F, 0.0873F);
        tipR.setTextureOffset(36, 10);
        tipR.addBox(0.5F, -6.0F, -6.0F, 0.0F, 13.0F, 8.0F, 0.0F, true);

        wingL = new AdvancedModelBox(this, "wingL");
        wingL.setPos(1.9F, 0.0F, 2.0F);
        body.addChild(wingL);
        setRotationAngle(wingL, 0.576F, -0.1571F, -0.1396F);
        wingL.setTextureOffset(20, 14);
        wingL.addBox(-0.5F, -1.0F, -4.5F, 1.0F, 12.0F, 5.0F, 0.0F, false);

        feathersL = new AdvancedModelBox(this, "feathersL");
        feathersL.setPos(0.5F, 0.8F, 1.6F);
        wingL.addChild(feathersL);
        feathersL.setTextureOffset(52, 10);
        feathersL.addBox(-0.5F, -1.5F, -3.1F, 0.0F, 16.0F, 2.0F, 0.0F, false);

        tipL = new AdvancedModelBox(this, "tipL");
        tipL.setPos(0.51F, 11.8F, 0.5F);
        wingL.addChild(tipL);
        setRotationAngle(tipL, 0.0F, 0.0F, -0.0873F);
        tipL.setTextureOffset(36, 10);
        tipL.addBox(-0.5F, -6.0F, -6.0F, 0.0F, 13.0F, 8.0F, 0.0F, false);
        this.updateDefaultPose();
    }

    @Override
    public void setAngles(EntityBaldEagle entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        this.body.rotateAngleX += birdPitch * flyProgress * 0.2F * MathHelper.RADIANS_PER_DEGREE;

    }

    @Override
    public void render(MatrixStack matrixStackIn, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
        if (this.child) {
            float f = 1.35F;
            head.setScale(f, f, f);
