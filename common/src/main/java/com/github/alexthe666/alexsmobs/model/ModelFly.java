...
public class ModelFly extends AdvancedEntityModel<EntityFly> {
    ...
    public ModelFly() {
        ...
        body.addBox(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 6.0F, 0.0F, false);

        legs = new AdvancedModelBox(this, "legs");
        legs.setPos(0.0F, 2.0F, -2.0F);
        body.addChild(legs);
        legs.setTextureOffset(0, 11);
        legs.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 1.0F, 5.0F, 0.0F, false);

        left_wing = new AdvancedModelBox(this, "left_wing");
        left_wing.setPos(1.0F, -2.0F, -1.0F);
        body.addChild(left_wing);
        left_wing.setTextureOffset(12, 11);
        left_wing.addBox(0.0F, 0.0F, -1.0F, 4.0F, 0.0F, 3.0F, 0.0F, false);

        right_wing = new AdvancedModelBox(this, "right_wing");
        right_wing.setPos(-1.0F, -2.0F, -1.0F);
        body.addChild(right_wing);
        right_wing.setTextureOffset(12, 11);
        right_wing.addBox(-4.0F, 0.0F, -1.0F, 4.0F, 0.0F, 3.0F, 0.0F, true);

        mouth = new AdvancedModelBox(this, "mouth");
        mouth.setPos(0.0F, 0.0F, -3.0F);
        body.addChild(mouth);
        mouth.setTextureOffset(15, 16);
        mouth.addBox(0.0F, 0.0F, -1.0F, 0.0F, 4.0F, 2.0F, 0.0F, false);        this.updateDefaultPose();
    }
    ...
    @Override
    public void setAngles(EntityFly entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        boolean flag = entityIn.isOnGround() && entityIn.getVelocity().lengthSquared() < 1.0E-7D;
        if(flag){
