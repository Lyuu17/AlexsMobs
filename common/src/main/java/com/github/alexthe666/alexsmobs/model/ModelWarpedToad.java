...
public class ModelWarpedToad extends AdvancedEntityModel<EntityWarpedToad> {
    ...
    public ModelWarpedToad() {
        ...
        body.addBox(-7.0F, -2.0F, -12.0F, 14.0F, 7.0F, 11.0F, -0.001F, false);
        body.setTextureOffset(0, 43);
        body.addBox(-7.0F, 0.0F, -12.0F, 14.0F, 0.0F, 11.0F, 0.0F, false);
        body.setTextureOffset(0, 0);
        body.addBox(-7.0F, -6.0F, -1.0F, 14.0F, 11.0F, 12.0F, -0.001F, false);

        tongue = new AdvancedModelBox(this, "tongue");
        tongue.setPos(0.0F, -1.0F, -1.0F);
        body.addChild(tongue);
        tongue.setTextureOffset(0, 55);
        tongue.addBox(-4.0F, 0.0F, -10.0F, 8.0F, 0.0F, 10.0F, 0.0F, false);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setPos(6.4F, 2.0F, -4.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(50, 69);
        left_arm.addBox(-1.0F, -1.01F, -2.0F, 3.0F, 7.0F, 4.0F, 0.0F, false);
        left_arm.setTextureOffset(27, 55);
        left_arm.addBox(-4.0F, 6.0F, -3.0F, 6.0F, 0.0F, 5.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setPos(-6.4F, 2.0F, -4.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(50, 69);
        right_arm.addBox(-2.0F, -1.01F, -2.0F, 3.0F, 7.0F, 4.0F, 0.0F, true);
        right_arm.setTextureOffset(27, 55);
        right_arm.addBox(-2.0F, 6.0F, -3.0F, 6.0F, 0.0F, 5.0F, 0.0F, true);

        sac = new AdvancedModelBox(this, "sac");
        sac.setPos(0.0F, 5.0F, -1.0F);
        body.addChild(sac);
        sac.setTextureOffset(42, 13);
        sac.addBox(-7.0F, -5.0F, -11.0F, 14.0F, 5.0F, 11.0F, -0.1F, false);

        left_gland = new AdvancedModelBox(this, "left_gland");
        left_gland.setPos(5.0F, -5.0F, 3.1F);
        body.addChild(left_gland);
        left_gland.setTextureOffset(0, 66);
        left_gland.addBox(-2.0F, -2.0F, -4.0F, 5.0F, 4.0F, 8.0F, 0.0F, false);

        right_gland = new AdvancedModelBox(this, "right_gland");
        right_gland.setPos(-5.0F, -5.0F, 3.1F);
        body.addChild(right_gland);
        right_gland.setTextureOffset(0, 66);
        right_gland.addBox(-3.0F, -2.0F, -4.0F, 5.0F, 4.0F, 8.0F, 0.0F, true);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setPos(6.0F, 1.5F, 8.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(40, 50);
        left_leg.addBox(-4.0F, -1.0F, -6.0F, 6.0F, 7.0F, 11.0F, 0.0F, false);
        ...
        left_foot.setTextureOffset(64, 50);
        left_foot.addBox(-2.0F, 0.0F, -2.0F, 10.0F, 1.0F, 4.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setPos(-6.0F, 1.5F, 8.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(40, 50);
        right_leg.addBox(-2.0F, -1.0F, -6.0F, 6.0F, 7.0F, 11.0F, 0.0F, true);
        ...
        right_foot.setTextureOffset(64, 50);
        right_foot.addBox(-8.0F, 0.0F, -2.0F, 10.0F, 1.0F, 4.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setPos(0.0F, -2.0F, -3.0F);
        body.addChild(head);
        head.setTextureOffset(40, 32);
        head.addBox(-7.0F, -4.0F, -9.0F, 14.0F, 6.0F, 11.0F, 0.0F, false);
        head.setTextureOffset(41, 0);
        head.addBox(-7.0F, -1.0F, -9.0F, 14.0F, 0.0F, 11.0F, 0.0F, false);

        left_eye = new AdvancedModelBox(this, "left_eye");
        left_eye.setPos(7.0F, -4.0F, -6.0F);
        head.addChild(left_eye);
        left_eye.setTextureOffset(27, 69);
        left_eye.addBox(-5.0F, -2.0F, 0.0F, 5.0F, 2.0F, 6.0F, 0.0F, false);
        left_eye.setTextureOffset(19, 66);
        left_eye.addBox(-2.0F, -4.0F, 0.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);

        right_eye = new AdvancedModelBox(this, "right_eye");
        right_eye.setPos(-7.0F, -4.0F, -6.0F);
        head.addChild(right_eye);
        right_eye.setTextureOffset(27, 69);
        right_eye.addBox(0.0F, -2.0F, 0.0F, 5.0F, 2.0F, 6.0F, 0.0F, true);
        right_eye.setTextureOffset(19, 66);
        right_eye.addBox(0.0F, -4.0F, 0.0F, 2.0F, 2.0F, 4.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityWarpedToad entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (attackProgress > 0) {
            this.tongue.rotateAngleX += headPitch * MathHelper.RADIANS_PER_DEGREE;
        }
