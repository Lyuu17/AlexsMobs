...
public class ModelRockyRoller extends AdvancedEntityModel<EntityRockyRoller> {
    ...
    public ModelRockyRoller() {
        ...
        body.addBox(-9.0F, -8.0F, -10.0F, 18.0F, 16.0F, 20.0F, 0.0F, false);
        body.setTextureOffset(64, 85);
        body.addBox(0.0F, 1.0F, -13.0F, 15.0F, 0.0F, 28.0F, 0.0F, false);
        body.setTextureOffset(64, 85);
        body.addBox(-15.0F, 1.0F, -13.0F, 15.0F, 0.0F, 28.0F, 0.0F, true);
        ...
        HSpikes_r1.setTextureOffset(0, 0);
        HSpikes_r1.addBox(-14.5F, 0.0F, -14.0F, 15.0F, 0.0F, 28.0F, 0.0F, true);
        ...
        HSpikes_r2.setTextureOffset(0, 0);
        HSpikes_r2.addBox(-0.5F, 0.0F, -14.0F, 15.0F, 0.0F, 28.0F, 0.0F, false);
        ...
        VSpikes_r1.setTextureOffset(1, 69);
        VSpikes_r1.addBox(0.0F, -18.0F, -14.0F, 0.0F, 18.0F, 28.0F, 0.0F, false);
        ...
        VSpikes_r2.setTextureOffset(1, 69);
        VSpikes_r2.addBox(0.0F, -18.0F, -14.0F, 0.0F, 18.0F, 28.0F, 0.0F, true);
        ...
        VSpikes_r3.setTextureOffset(49, 38);
        VSpikes_r3.addBox(0.0F, -16.0F, -14.0F, 0.0F, 18.0F, 28.0F, 0.0F, true);
        ...
        VSpikes_r4.setTextureOffset(49, 38);
        VSpikes_r4.addBox(0.0F, -16.0F, -14.0F, 0.0F, 18.0F, 28.0F, 0.0F, false);
        ...
        tail.addBox(-2.0F, -2.0F, 0.0F, 4.0F, 4.0F, 12.0F, 0.0F, false);
        tail.setTextureOffset(19, 8);
        tail.addBox(0.0F, -4.0F, 8.0F, 0.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        head.addBox(-3.0F, -3.0F, -4.0F, 6.0F, 6.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(21, 15);
        head.addBox(0.0F, -5.0F, -4.0F, 0.0F, 2.0F, 3.0F, 0.0F, false);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setRotationPoint(4.0F, 8.0F, -7.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(0, 29);
        left_arm.addBox(-1.0F, 0.0F, -1.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
        left_arm.setTextureOffset(18, 0);
        left_arm.addBox(0.0F, 3.0F, 2.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setRotationPoint(-4.0F, 8.0F, -7.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(0, 29);
        right_arm.addBox(-2.0F, 0.0F, -1.0F, 3.0F, 5.0F, 3.0F, 0.0F, true);
        right_arm.setTextureOffset(18, 0);
        right_arm.addBox(-2.0F, 3.0F, 2.0F, 2.0F, 2.0F, 2.0F, 0.0F, true);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setRotationPoint(6.0F, 9.0F, 6.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(0, 12);
        left_leg.addBox(-3.0F, -1.0F, -3.0F, 5.0F, 8.0F, 5.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setRotationPoint(-6.0F, 9.0F, 6.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(0, 12);
        right_leg.addBox(-2.0F, -1.0F, -3.0F, 5.0F, 8.0F, 5.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityRockyRoller entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        if(entity.isRolling()){
            ...
            float rollDeg = (float)MathHelper.wrapDegrees(Math.toDegrees(entity.clientRoll));
