...
public class ModelBoneSerpentTail extends AdvancedEntityModel<EntityBoneSerpentPart> {
    ...
    public ModelBoneSerpentTail() {
        ...
        tail.addBox(-5.0F, -5.25F, -8.0F, 10.0F, 10.0F, 16.0F, 0.0F, false);
        tail.setTextureOffset(0, 27);
        tail.addBox(-1.0F, -6.25F, -8.0F, 2.0F, 1.0F, 16.0F, 0.0F, false);
    ...
    public void setAngles(EntityBoneSerpentPart entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.tail.rotateAngleX = headPitch * MathHelper.RADIANS_PER_DEGREE;
        this.tail.rotateAngleY = netHeadYaw * MathHelper.RADIANS_PER_DEGREE;
