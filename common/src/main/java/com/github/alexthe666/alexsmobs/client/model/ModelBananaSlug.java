...
public class ModelBananaSlug extends AdvancedEntityModel<EntityBananaSlug> {
    ...
    public ModelBananaSlug() {
        ...
        root.addChild(body);
        body.setTextureOffset(18, 23);
        body.addBox(-2.5F, -2.0F, -4.0F, 5.0F, 4.0F, 7.0F, 0.0F, false);

        goo = new AdvancedModelBox(this, "goo");
        goo.setRotationPoint(0.0F, 2.0F, 0.0F);
        body.addChild(goo);
        goo.setTextureOffset(0, 0);
        goo.addBox(-2.5F, -0.001F, 0.0F, 5.0F, 0.0F, 17.0F, 0.0F, false);
        ...
        leftAntenna.setTextureOffset(0, 0);
        leftAntenna.addBox(0.0F, -1.0F, -5.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);
        ...
        rightAntenna.setTextureOffset(0, 0);
        rightAntenna.addBox(0.0F, -1.0F, -5.0F, 0.0F, 3.0F, 5.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 0.0F, 3.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 18);
        tail.addBox(-2.0F, -1.0F, 0.0F, 4.0F, 3.0F, 8.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityBananaSlug entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        leftAntenna.rotateAngleY += netHeadYaw * 0.6F * MathHelper.RADIANS_PER_DEGREE;
        leftAntenna.rotateAngleX += headPitch * 0.3F * MathHelper.RADIANS_PER_DEGREE;
        rightAntenna.rotateAngleY += netHeadYaw * 0.6F * MathHelper.RADIANS_PER_DEGREE;
        rightAntenna.rotateAngleX += headPitch * 0.3F * MathHelper.RADIANS_PER_DEGREE;
