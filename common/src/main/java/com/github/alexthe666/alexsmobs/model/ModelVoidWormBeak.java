...
public class ModelVoidWormBeak extends AdvancedEntityModel<Entity> {
    ...
    public ModelVoidWormBeak() {
        ...
        root.addChild(left);
        left.setTextureOffset(0, 0);
        left.addBox(-0.1F, -12.9F, -3.5F, 7.0F, 13.0F, 7.0F, -0.1F, false);
        right = new AdvancedModelBox(this, "right");
        right.setPos(0.0F, 0.0F, 0.0F);
        root.addChild(right);
        right.setTextureOffset(0, 21);
        right.addBox(-7.0F, -13.0F, -3.5F, 7.0F, 13.0F, 7.0F, 0.0F, false);
