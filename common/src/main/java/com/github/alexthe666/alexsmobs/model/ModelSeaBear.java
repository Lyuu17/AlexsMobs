...
public class ModelSeaBear extends AdvancedEntityModel<EntitySeaBear> {
	...
	public ModelSeaBear() {
		...
		body.addBox(-8.0F, -13.0F, -20.0F, 16.0F, 28.0F, 41.0F, 0.0F, false);
		body.setTextureOffset(0, 70);
		body.addBox(0.0F, -22.0F, -19.0F, 0.0F, 9.0F, 39.0F, 0.0F, false);
		...
		right_ear.setTextureOffset(11, 19);
		right_ear.addBox(-1.5F, -2.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);

		left_ear = new AdvancedModelBox(this, "left_ear");
		left_ear.setRotationPoint(3.5F, -5.0F, -3.0F);
		head.addChild(left_ear);
		left_ear.setTextureOffset(11, 19);
		left_ear.addBox(-1.5F, -2.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, true);

		tail = new AdvancedModelBox(this, "tail");
		tail.setRotationPoint(0.0F, 1.0F, 21.0F);
		body.addChild(tail);
		tail.setTextureOffset(79, 70);
		tail.addBox(0.0F, -13.0F, 0.0F, 0.0F, 25.0F, 17.0F, 0.0F, false);

		left_arm = new AdvancedModelBox(this, "left_arm");
		left_arm.setRotationPoint(6.6F, 15.0F, -10.0F);
		body.addChild(left_arm);
		left_arm.setTextureOffset(0, 70);
		left_arm.addBox(-1.0F, 0.0F, -5.0F, 2.0F, 13.0F, 9.0F, 0.0F, false);
		left_arm.setTextureOffset(0, 19);
		left_arm.addBox(0.0F, 13.0F, -5.0F, 0.0F, 1.0F, 9.0F, 0.0F, false);

		right_arm = new AdvancedModelBox(this, "right_arm");
		right_arm.setRotationPoint(-6.6F, 15.0F, -10.0F);
		body.addChild(right_arm);
		right_arm.setTextureOffset(0, 70);
		right_arm.addBox(-1.0F, 0.0F, -5.0F, 2.0F, 13.0F, 9.0F, 0.0F, true);
		right_arm.setTextureOffset(0, 19);
		right_arm.addBox(0.0F, 13.0F, -5.0F, 0.0F, 1.0F, 9.0F, 0.0F, true);

		left_leg = new AdvancedModelBox(this, "left_leg");
		left_leg.setRotationPoint(7.7F, 15.0F, 16.0F);
		body.addChild(left_leg);
		left_leg.setTextureOffset(40, 70);
		left_leg.addBox(-1.0F, 0.0F, -3.0F, 1.0F, 8.0F, 6.0F, 0.0F, false);
		left_leg.setTextureOffset(15, 30);
		left_leg.addBox(0.0F, 8.0F, -3.0F, 0.0F, 1.0F, 6.0F, 0.0F, false);

		right_leg = new AdvancedModelBox(this, "right_leg");
		right_leg.setRotationPoint(-7.7F, 15.0F, 16.0F);
		body.addChild(right_leg);
		right_leg.setTextureOffset(40, 70);
		right_leg.addBox(0.0F, 0.0F, -3.0F, 1.0F, 8.0F, 6.0F, 0.0F, true);
		right_leg.setTextureOffset(15, 30);
		right_leg.addBox(0.0F, 8.0F, -3.0F, 0.0F, 1.0F, 6.0F, 0.0F, true);
	...
	@Override
	public void setAngles(EntitySeaBear entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		float landProgress = entity.prevOnLandProgress + (entity.onLandProgress - entity.prevOnLandProgress) * (ageInTicks - entity.age);
