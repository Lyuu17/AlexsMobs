...
public class ModelStraddleboard extends AdvancedEntityModel<EntityStraddleboard> {
	...
	public ModelStraddleboard() {
		...
		body.addBox(-6.0F, -2.0F, -10.0F, 12.0F, 2.0F, 26.0F, 0.0F, false);
		...
		hair_left.setTextureOffset(0, 29);
		hair_left.addBox(0.0F, -10.0F, -2.0F, 0.0F, 10.0F, 24.0F, 0.0F, false);
		...
		hair_right.setTextureOffset(0, 29);
		hair_right.addBox(0.0F, -10.0F, -2.0F, 0.0F, 10.0F, 24.0F, 0.0F, true);

		spikes = new AdvancedModelBox(this, "spikes");
		spikes.setPos(0.0F, -1.5F, 13.5F);
		body.addChild(spikes);
		spikes.setTextureOffset(25, 29);
		spikes.addBox(-4.0F, -5.5F, -3.5F, 8.0F, 11.0F, 7.0F, 0.0F, false);

		front = new AdvancedModelBox(this, "front");
		front.setPos(0.0F, 0.0F, -10.0F);
		body.addChild(front);
		setRotationAngle(front, -0.1309F, 0.0F, 0.0F);
		front.setTextureOffset(48, 40);
		front.addBox(-5.0F, -2.0F, -8.0F, 10.0F, 2.0F, 8.0F, 0.0F, false);

		spikes_front = new AdvancedModelBox(this, "spikes_front");
		spikes_front.setPos(0.0F, -4.0F, -3.5F);
		front.addChild(spikes_front);
		spikes_front.setTextureOffset(0, 0);
		spikes_front.addBox(-2.0F, -2.0F, -2.5F, 4.0F, 4.0F, 5.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityStraddleboard entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
