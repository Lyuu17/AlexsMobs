...
public class ModelGuster extends AdvancedEntityModel<EntityGuster> {
    ...
    public ModelGuster() {
        ...
        tornado.setTextureOffset(65, 72);
        tornado.addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);

        tornado2 = new AdvancedModelBox(this, "tornado2");
        tornado2.setPos(0.0F, -8.0F, 0.0F);
        tornado.addChild(tornado2);
        tornado2.setTextureOffset(0, 72);
        tornado2.addBox(-8.0F, -4.0F, -8.0F, 16.0F, 8.0F, 16.0F, 0.0F, false);

        tornadomid = new AdvancedModelBox(this, "tornadomid");
        tornadomid.setPos(0.0F, 6.0F, 0.0F);
        tornado2.addChild(tornadomid);
        tornadomid.setTextureOffset(16, 96);
        tornadomid.addBox(-14.0F, -4.0F, -14.0F, 28.0F, 4.0F, 28.0F, 0.0F, false);

        tornado3 = new AdvancedModelBox(this, "tornado3");
        tornado3.setPos(0.0F, -8.0F, 0.0F);
        tornado2.addChild(tornado3);
        tornado3.setTextureOffset(0, 39);
        tornado3.addBox(-12.0F, -4.0F, -12.0F, 24.0F, 8.0F, 24.0F, 0.0F, false);

        tornado4 = new AdvancedModelBox(this, "tornado4");
        tornado4.setPos(0.0F, -8.0F, 0.0F);
        tornado3.addChild(tornado4);
        tornado4.setTextureOffset(0, 0);
        tornado4.addBox(-15.0F, -4.0F, -15.0F, 30.0F, 8.0F, 30.0F, 0.0F, false);
        ...
        eye_left.setTextureOffset(8, 13);
        eye_left.addBox(-3.0F, -4.0F, 0.0F, 6.0F, 8.0F, 0.0F, 0.0F, false);

        eye_right = new AdvancedModelBox(this, "eye_right");
        eye_right.setPos(-4.0F, 0.0F, 0.0F);
        eyes.addChild(eye_right);
        eye_right.setTextureOffset(8, 13);
        eye_right.addBox(-3.0F, -4.0F, 0.0F, 6.0F, 8.0F, 0.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityGuster entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        this.eyes.rotateAngleY += netHeadYaw * 0.5F * MathHelper.RADIANS_PER_DEGREE;
        this.eyes.rotateAngleX += headPitch * 0.8F * MathHelper.RADIANS_PER_DEGREE;
