...
public class ModelCaiman extends AdvancedEntityModel<EntityCaiman> {
    ...
    public ModelCaiman() {
        ...
        body.addBox(-4.0F, -3.0F, -8.0F, 8.0F, 6.0F, 16.0F, 0.0F, false);

        leftLeg = new AdvancedModelBox(this);
        leftLeg.setRotationPoint(4.0F, 1.0F, 6.0F);
        body.addChild(leftLeg);
        leftLeg.setTextureOffset(56, 13);
        leftLeg.addBox(-1.0F, -1.0F, -4.0F, 3.0F, 4.0F, 5.0F, 0.0F, false);

        leftFoot = new AdvancedModelBox(this);
        leftFoot.setRotationPoint(1.0F, 3.0F, -3.0F);
        leftLeg.addChild(leftFoot);
        leftFoot.setTextureOffset(26, 55);
        leftFoot.addBox(-2.0F, -0.01F, -4.0F, 5.0F, 0.0F, 5.0F, 0.0F, false);

        rightLeg = new AdvancedModelBox(this);
        rightLeg.setRotationPoint(-4.0F, 1.0F, 6.0F);
        body.addChild(rightLeg);
        rightLeg.setTextureOffset(56, 13);
        rightLeg.addBox(-2.0F, -1.0F, -4.0F, 3.0F, 4.0F, 5.0F, 0.0F, true);

        rightFoot = new AdvancedModelBox(this);
        rightFoot.setRotationPoint(-1.0F, 3.0F, -3.0F);
        rightLeg.addChild(rightFoot);
        rightFoot.setTextureOffset(26, 55);
        rightFoot.addBox(-3.0F, -0.01F, -4.0F, 5.0F, 0.0F, 5.0F, 0.0F, true);

        leftArm = new AdvancedModelBox(this);
        leftArm.setRotationPoint(4.2F, 0.2F, -5.5F);
        body.addChild(leftArm);
        leftArm.setTextureOffset(0, 0);
        leftArm.addBox(-1.2F, -1.2F, -1.5F, 3.0F, 5.0F, 3.0F, 0.0F, false);

        leftHand = new AdvancedModelBox(this);
        leftHand.setRotationPoint(0.3F, 3.8F, -0.5F);
        leftArm.addChild(leftHand);
        leftHand.setTextureOffset(55, 39);
        leftHand.addBox(-2.5F, -0.01F, -4.0F, 5.0F, 0.0F, 5.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this);
        rightArm.setRotationPoint(-4.2F, 0.2F, -5.5F);
        body.addChild(rightArm);
        rightArm.setTextureOffset(0, 0);
        rightArm.addBox(-1.8F, -1.2F, -1.5F, 3.0F, 5.0F, 3.0F, 0.0F, true);

        rightHand = new AdvancedModelBox(this);
        rightHand.setRotationPoint(-0.3F, 3.8F, -0.5F);
        rightArm.addChild(rightHand);
        rightHand.setTextureOffset(55, 39);
        rightHand.addBox(-2.5F, -0.01F, -4.0F, 5.0F, 0.0F, 5.0F, 0.0F, true);

        tail1 = new AdvancedModelBox(this);
        tail1.setRotationPoint(0.0F, 0.0F, 7.0F);
        body.addChild(tail1);
        tail1.setTextureOffset(0, 23);
        tail1.addBox(-3.0F, -2.0F, 1.0F, 6.0F, 5.0F, 11.0F, 0.0F, false);
        tail1.setTextureOffset(24, 23);
        tail1.addBox(-2.0F, -3.0F, 7.0F, 4.0F, 1.0F, 5.0F, 0.0F, false);
        tail1.setTextureOffset(50, 28);
        tail1.addBox(-4.0F, -2.0F, 1.0F, 8.0F, 0.0F, 6.0F, 0.0F, false);

        tail2 = new AdvancedModelBox(this);
        tail2.setRotationPoint(0.0F, 1.0F, 12.0F);
        tail1.addChild(tail2);
        tail2.setTextureOffset(39, 13);
        tail2.addBox(-1.5F, -2.0F, 0.0F, 3.0F, 4.0F, 10.0F, 0.0F, false);
        tail2.setTextureOffset(43, 45);
        tail2.addBox(-1.5F, -4.0F, 0.0F, 3.0F, 2.0F, 10.0F, 0.0F, false);

        tail3 = new AdvancedModelBox(this);
        tail3.setRotationPoint(0.0F, 0.0F, 10.0F);
        tail2.addChild(tail3);
        tail3.setTextureOffset(15, 55);
        tail3.addBox(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 10.0F, 0.0F, false);

        head = new AdvancedModelBox(this);
        head.setRotationPoint(0.0F, 0.0F, -10.0F);
        body.addChild(head);
        head.setTextureOffset(0, 52);
        head.addBox(-3.5F, -5.0F, -3.0F, 7.0F, 7.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(58, 0);
        head.addBox(-2.5F, -6.0F, -3.0F, 5.0F, 1.0F, 3.0F, 0.0F, false);

        bottomJaw = new AdvancedModelBox(this);
        bottomJaw.setRotationPoint(0.0F, -3.0F, -2.0F);
        head.addChild(bottomJaw);
        bottomJaw.setTextureOffset(0, 40);
        bottomJaw.addBox(-3.0F, 0.0F, -10.0F, 6.0F, 2.0F, 9.0F, 0.0F, false);
        bottomJaw.setTextureOffset(22, 44);
        bottomJaw.addBox(-3.0F, -1.0F, -10.0F, 6.0F, 1.0F, 9.0F, 0.0F, false);

        topJaw = new AdvancedModelBox(this);
        topJaw.setRotationPoint(0.0F, -4.0F, -3.0F);
        head.addChild(topJaw);
        topJaw.setTextureOffset(33, 0);
        topJaw.addBox(-3.5F, -1.0F, -10.0F, 7.0F, 2.0F, 10.0F, 0.0F, false);
        topJaw.setTextureOffset(25, 30);
        topJaw.addBox(-3.5F, 1.0F, -10.0F, 7.0F, 3.0F, 10.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityCaiman entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
