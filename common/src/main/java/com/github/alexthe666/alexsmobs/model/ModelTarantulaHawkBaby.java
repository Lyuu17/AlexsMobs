...
public class ModelTarantulaHawkBaby extends AdvancedEntityModel<EntityTarantulaHawk> {
    ...
    public ModelTarantulaHawkBaby() {
        ...
        body.addBox(-4.0F, -3.0F, 0.0F, 8.0F, 6.0F, 15.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setPos(0.0F, 0.9F, 0.0F);
        body.addChild(head);
        head.setTextureOffset(0, 22);
        head.addBox(-3.5F, -3.0F, -3.0F, 7.0F, 5.0F, 3.0F, 0.0F, false);
        this.updateDefaultPose();
    }

    @Override
    public void setAngles(EntityTarantulaHawk entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
