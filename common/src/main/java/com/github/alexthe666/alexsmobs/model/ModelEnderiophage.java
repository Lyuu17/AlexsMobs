...
public class ModelEnderiophage extends AdvancedEntityModel<EntityEnderiophage> {
    ...
    public ModelEnderiophage() {
        ...
        root.addChild(body);
        body.setTextureOffset(0, 30);
        body.addBox(-4.0F, -2.0F, -4.0F, 8.0F, 3.0F, 8.0F, 0.0F, false);

        mouth = new AdvancedModelBox(this, "mouth");
        mouth.setPos(0.0F, 1.0F, 0.0F);
        body.addChild(mouth);
        mouth.setTextureOffset(0, 0);
        mouth.addBox(-1.0F, -5.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

        sheath = new AdvancedModelBox(this, "sheath");
        sheath.setPos(0.0F, -2.0F, 0.0F);
        body.addChild(sheath);
        sheath.setTextureOffset(50, 43);
        sheath.addBox(-2.0F, -14.0F, -2.0F, 4.0F, 14.0F, 4.0F, 0.0F, false);

        collar = new AdvancedModelBox(this, "collar");
        collar.setPos(0.0F, -14.0F, 0.0F);
        sheath.addChild(collar);
        collar.setTextureOffset(0, 55);
        collar.addBox(-3.0F, -1.0F, -3.0F, 6.0F, 1.0F, 6.0F, 0.0F, false);

        capsid = new AdvancedModelBox(this, "capsid");
        capsid.setPos(0.0F, -1.0F, 0.0F);
        collar.addChild(capsid);
        capsid.setTextureOffset(0, 0);
        capsid.addBox(-7.0F, -15.0F, -7.0F, 14.0F, 15.0F, 14.0F, 0.0F, false);

        eye = new AdvancedModelBox(this, "eye");
        eye.setPos(0.0F, -8.0F, 0.0F);
        capsid.addChild(eye);
        eye.setTextureOffset(43, 0);
        eye.addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
        ...
        tailmid_left.setTextureOffset(25, 43);
        tailmid_left.addBox(0.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, false);
        ...
        tailmid_right.setTextureOffset(25, 43);
        tailmid_right.addBox(-12.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, true);
        ...
        tailback_left.setTextureOffset(33, 30);
        tailback_left.addBox(0.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, false);
        ...
        tailback_right.setTextureOffset(33, 30);
        tailback_right.addBox(-12.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, true);
        ...
        tailfront_left.setTextureOffset(0, 42);
        tailfront_left.addBox(0.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, false);
        ...
        tailfront_right.setTextureOffset(0, 42);
        tailfront_right.addBox(-12.0F, 0.0F, 0.0F, 12.0F, 12.0F, 0.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityEnderiophage entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float phagePitch = Maths.rad(MathHelper.lerpAngleDegrees(partialTicks, entity.prevPhagePitch, entity.getPhagePitch()));
        float totalYaw = Maths.rad(MathHelper.lerpAngleDegrees(partialTicks, entity.prevBodyYaw, entity.bodyYaw));
        ...
        if(entity.hasVehicle()){
            this.body.rotateAngleX += MathHelper.HALF_PI;
            this.body.rotateAngleY += MathHelper.HALF_PI * entity.passengerIndex;
        ...
        if (look != null) {
            Vec3d vector3d = look.getCameraPosVec(partialTicks);
            Vec3d vector3d1 = entity.getCameraPosVec(partialTicks);
            Vec3d vector3d2 = vector3d.subtract(vector3d1);
            float f = MathHelper.sqrt((float)(vector3d2.x * vector3d2.x + vector3d2.z * vector3d2.z)) - totalYaw;
