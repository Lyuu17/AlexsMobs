...
public class ModelSpectre extends AdvancedEntityModel<EntitySpectre> {
    ...
    public ModelSpectre() {
        ...
        body.addBox(-12.0F, -5.5F, -12.0F, 24.0F, 6.0F, 24.0F, 0.0F, false);

        spine = new AdvancedModelBox(this, "spine");
        spine.setPos(0.0F, -5.5F, 0.0F);
        body.addChild(spine);
        setRotationAngle(spine, 0.0F, 0.7854F, 0.0F);
        spine.setTextureOffset(0, 0);
        spine.addBox(0.0F, -3.0F, -14.0F, 0.0F, 8.0F, 42.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setPos(0.0F, 1.0F, 28.0F);
        spine.addChild(tail);
        tail.setTextureOffset(76, 31);
        tail.addBox(0.0F, -6.0F, 0.0F, 0.0F, 11.0F, 27.0F, 0.0F, false);
        ...
        wing_left.setTextureOffset(76, 76);
        wing_left.addBox(0.0F, -1.5F, 0.0F, 26.0F, 3.0F, 23.0F, 0.0F, false);
        ...
        wing_right.setTextureOffset(0, 51);
        wing_right.addBox(-26.0F, -1.5F, 0.0F, 26.0F, 3.0F, 23.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntitySpectre entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
       this.resetToDefaultPose();
        ...
        this.root.rotateAngleX += birdPitch * MathHelper.RADIANS_PER_DEGREE;
