...
public class ModelFarseer extends AdvancedEntityModel<EntityFarseer> {
    ...
    public ModelFarseer(float scale) {
        ...
        bodyCube1.setTextureOffset(0, 56);
        bodyCube1.addBox(-5.0F, -2.0F, -3.0F, 10.0F, 4.0F, 5.0F, scale, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -15.0F, 0.0F);
        root.addChild(head);
        head.setTextureOffset(0, 0);
        head.addBox(-10.5F, -5.0F, -6.0F, 21.0F, 9.0F, 13.0F, scale, false);
        ...
        leftUpperMask.setTextureOffset(0, 23);
        leftUpperMask.addBox(0.0F, -0.5F, -7.9F, 11.0F, 7.0F, 8.0F, scale, false);
        ...
        rightUpperMask.setTextureOffset(0, 23);
        rightUpperMask.addBox(-11.0F, -0.5F, -7.9F, 11.0F, 7.0F, 8.0F, scale, true);
        ...
        leftLowerMask.setTextureOffset(31, 31);
        leftLowerMask.addBox(0.0F, -2.5F, -7.9F, 11.0F, 4.0F, 8.0F, scale, false);
        ...
        rightLowerMask.setTextureOffset(31, 31);
        rightLowerMask.addBox(-11.0F, -2.5F, -7.9F, 11.0F, 4.0F, 8.0F, scale, true);

        eye = new AdvancedModelBox(this, "eye");
        eye.setRotationPoint(0.0F, 4.0F, -1.0F);
        head.addChild(eye);
        eye.setTextureOffset(56, 0);
        eye.addBox(-4.5F, -8.0F, -6.0F, 9.0F, 4.0F, 2.0F, scale, false);

        bodyCube2 = new AdvancedModelBox(this, "bodyCube2");
        bodyCube2.setRotationPoint(1.0F, -2.0F, 1.0F);
        root.addChild(bodyCube2);
        bodyCube2.setTextureOffset(33, 44);
        bodyCube2.addBox(-6.0F, -3.0F, -3.0F, 10.0F, 5.0F, 6.0F, scale, false);
        ...
        leftArm.setTextureOffset(31, 23);
        leftArm.addBox(-1.0F, -1.5F, -2.0F, 16.0F, 3.0F, 4.0F, scale, false);

        leftElbow = new AdvancedModelBox(this, "leftElbow");
        leftElbow.setRotationPoint(15.0F, 0.0F, 0.0F);
        leftArm.addChild(leftElbow);
        leftElbow.setTextureOffset(0, 39);
        leftElbow.addBox(-1.0F, -1.0F, -13.0F, 2.0F, 2.0F, 14.0F, scale, false);
        ...
        leftUpperRFinger.setTextureOffset(0, 0);
        leftUpperRFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftLowerRFinger.setTextureOffset(0, 0);
        leftLowerRFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftLowerLFinger.setTextureOffset(0, 0);
        leftLowerLFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftUpperLFinger.setTextureOffset(0, 0);
        leftUpperLFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftArm2.setTextureOffset(31, 23);
        leftArm2.addBox(-1.0F, -1.5F, -2.0F, 16.0F, 3.0F, 4.0F, scale, false);

        leftElbow2 = new AdvancedModelBox(this, "leftElbow2");
        leftElbow2.setRotationPoint(15.0F, 0.0F, 0.0F);
        leftArm2.addChild(leftElbow2);
        leftElbow2.setTextureOffset(0, 39);
        leftElbow2.addBox(-1.0F, -1.0F, -13.0F, 2.0F, 2.0F, 14.0F, scale, false);
        ...
        leftUpperRFinger2.setTextureOffset(0, 0);
        leftUpperRFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftLowerRFinger2.setTextureOffset(0, 0);
        leftLowerRFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftLowerLFinger2.setTextureOffset(0, 0);
        leftLowerLFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        leftUpperLFinger2.setTextureOffset(0, 0);
        leftUpperLFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, false);
        ...
        rightArm.setTextureOffset(31, 23);
        rightArm.addBox(-15.0F, -1.5F, -2.0F, 16.0F, 3.0F, 4.0F, scale, true);

        rightElbow = new AdvancedModelBox(this, "rightElbow");
        rightElbow.setRotationPoint(-15.0F, 0.0F, 0.0F);
        rightArm.addChild(rightElbow);
        rightElbow.setTextureOffset(0, 39);
        rightElbow.addBox(-1.0F, -1.0F, -13.0F, 2.0F, 2.0F, 14.0F, scale, true);
        ...
        rightUpperRFinger.setTextureOffset(0, 0);
        rightUpperRFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightLowerRFinger2.setTextureOffset(0, 0);
        rightLowerRFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightLowerLFinger.setTextureOffset(0, 0);
        rightLowerLFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightUpperLFinger.setTextureOffset(0, 0);
        rightUpperLFinger.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightArm2.setTextureOffset(31, 23);
        rightArm2.addBox(-15.0F, -1.5F, -2.0F, 16.0F, 3.0F, 4.0F, scale, true);
        ...
        rightElbow2.setTextureOffset(0, 39);
        rightElbow2.addBox(-1.0F, -1.0F, -13.0F, 2.0F, 2.0F, 14.0F, scale, true);
        ...
        rightUpperRFinger2.setTextureOffset(0, 0);
        rightUpperRFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightLowerRFinger3.setTextureOffset(0, 0);
        rightLowerRFinger3.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightLowerLFinger2.setTextureOffset(0, 0);
        rightLowerLFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
        ...
        rightUpperLFinger2.setTextureOffset(0, 0);
        rightUpperLFinger2.addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 4.0F, scale, true);
    ...
    @Override
    public void setAngles(EntityFarseer entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        var topArmOffset = entity.getLatencyOffsetVec(4, partialTick).multiply(-4.0F);
        var bottomArmOffset = entity.getLatencyOffsetVec(8, partialTick).multiply(-5.0F);
        var body1Offset = entity.getLatencyOffsetVec(8, partialTick).multiply(-3.0F);
        var body2Offset = entity.getLatencyOffsetVec(12, partialTick).multiply(-5.0F);
        var angryShake = entity.angryShakeVec.multiply(angryProgress * 0.1F);
        ...
        float headY = netHeadYaw * invPortalDegree * MathHelper.RADIANS_PER_DEGREE;
        float headZ = headPitch * invPortalDegree * MathHelper.RADIANS_PER_DEGREE;
