...
public class ModelMurmurBody extends AdvancedEntityModel<EntityMurmur> {
    ...
    public ModelMurmurBody() {
        ...
        body.addBox(-7.0F, -13.0F, -5.0F, 14.0F, 14.0F, 10.0F, 0.0F, false);
        body.setTextureOffset(72, 20);
        body.addBox(-7.0F, 1.0F, -5.0F, 14.0F, 13.0F, 10.0F, 0.0F, false);

        arms = new AdvancedModelBox(this, "arms");
        arms.setRotationPoint(0.0F, -8.5F, -1.0F);
        body.addChild(arms);
        arms.rotateAngleX = 0.4363F;
        arms.setTextureOffset(0, 25);
        arms.addBox(-9.0F, -2.5F, -8.0F, 18.0F, 5.0F, 10.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityMurmur entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
