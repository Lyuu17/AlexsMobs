...
public class ModelGazelle extends AdvancedEntityModel<EntityGazelle> {
    ...
    public ModelGazelle() {
        ...
        body.addBox(-4.0F, -16.8F, -9.0F, 8.0F, 8.0F, 18.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityGazelle entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
