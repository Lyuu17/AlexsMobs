...
public class ModelMudskipper extends AdvancedEntityModel<EntityMudskipper> {
    ...
    public ModelMudskipper() {
        ...
        head.addBox(-3.5F, -3.0F, -4.0F, 7.0F, 5.0F, 6.0F, 0.0F, false);

        eyes = new AdvancedModelBox(this, "eyes");
        eyes.setRotationPoint(0.0F, -3.0F, -1.5F);
        head.addChild(eyes);
        eyes.setTextureOffset(19, 0);
        eyes.addBox(-2.5F, -2.0F, -1.5F, 5.0F, 2.0F, 3.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 0.0F, 3.0F);
        head.addChild(tail);
        tail.setTextureOffset(0, 0);
        tail.addBox(-2.0F, -2.0F, -1.0F, 4.0F, 4.0F, 10.0F, 0.0F, false);
        tail.setTextureOffset(23, 9);
        tail.addBox(0.0F, -4.0F, 4.0F, 0.0F, 2.0F, 6.0F, 0.0F, false);

        dorsalFin = new AdvancedModelBox(this, "dorsalFin");
        dorsalFin.setRotationPoint(0.0F, -2.0F, -2.0F);
        tail.addChild(dorsalFin);
        dorsalFin.setTextureOffset(0, 27);
        dorsalFin.addBox(0.0F, -5.0F, -1.0F, 0.0F, 5.0F, 7.0F, 0.0F, false);

        tailFin = new AdvancedModelBox(this, "tailFin");
        tailFin.setRotationPoint(0.0F, 0.0F, 9.0F);
        tail.addChild(tailFin);
        tailFin.setTextureOffset(20, 20);
        tailFin.addBox(0.0F, -3.0F, -1.0F, 0.0F, 6.0F, 7.0F, 0.0F, false);

        leftFin = new AdvancedModelBox(this, "leftFin");
        leftFin.setRotationPoint(2.0F, 2.0F, -1.0F);
        tail.addChild(leftFin);
        leftFin.setTextureOffset(28, 18);
        leftFin.addBox(0.0F, 0.0F, 0.0F, 3.0F, 0.0F, 3.0F, 0.0F, false);

        rightFin = new AdvancedModelBox(this, "rightFin");
        rightFin.setRotationPoint(-2.0F, 2.0F, -1.0F);
        tail.addChild(rightFin);
        rightFin.setTextureOffset(28, 18);
        rightFin.addBox(-3.0F, 0.0F, 0.0F, 3.0F, 0.0F, 3.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityMudskipper entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
