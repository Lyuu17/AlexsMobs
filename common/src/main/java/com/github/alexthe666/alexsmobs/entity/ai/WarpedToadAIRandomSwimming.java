...
public class WarpedToadAIRandomSwimming extends WanderAroundGoal {
    ...
    public boolean canStart() {
        if (this.mob.hasPassengers() || ((EntityWarpedToad)mob).isOrderedToSit() || mob.getTarget() != null || !this.mob.isTouchingWater() && !this.mob.isInLava() && this.mob instanceof ISemiAquatic && !((ISemiAquatic) this.mob).shouldEnterWater()) {
            return false;
        } else {
