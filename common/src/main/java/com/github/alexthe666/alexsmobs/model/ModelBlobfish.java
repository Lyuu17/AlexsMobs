...
public class ModelBlobfish extends AdvancedEntityModel<EntityBlobfish> {
    ...
    public ModelBlobfish() {
        ...
        body.addBox(-3.0F, -2.5F, -8.0F, 6.0F, 5.0F, 8.0F, 0.0F, false);

        nose = new AdvancedModelBox(this, "nose");
        nose.setPos(0.0F, -0.5F, -8.0F);
        body.addChild(nose);
        nose.setTextureOffset(0, 19);
        nose.addBox(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 1.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setPos(0.0F, 0.25F, 0.0F);
        body.addChild(tail);
        tail.setTextureOffset(11, 14);
        tail.addBox(-2.0F, -2.25F, 0.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setPos(0.0F, -1.45F, 0.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(0, 14);
        tail_fin.addBox(0.0F, -2.0F, -1.0F, 0.0F, 6.0F, 10.0F, 0.0F, false);
        ...
        fin_right.setTextureOffset(0, 0);
