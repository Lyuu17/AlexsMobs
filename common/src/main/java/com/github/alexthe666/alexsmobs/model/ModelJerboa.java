...
public class ModelJerboa extends AdvancedEntityModel<EntityJerboa> {
    ...
    public ModelJerboa() {
        ...
        body.addBox(-2.5F, -2.0F, -4.0F, 5.0F, 4.0F, 8.0F, 0.0F, false);
        ...
        leftEar.addBox(-2.0F, -5.0F, 0.0F, 4.0F, 5.0F, 0.0F, 0.0F, false);
        ...
        rightEar.addBox(-2.0F, -5.0F, 0.0F, 4.0F, 5.0F, 0.0F, 0.0F, true);
        ...
        leftArm.setTextureOffset(0, 6);
        leftArm.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, 0.0F, false);
        ...
        rightArm.setTextureOffset(0, 6);
        rightArm.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityJerboa entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        float headY = netHeadYaw * 0.35F * MathHelper.RADIANS_PER_DEGREE;
        float headZ = headPitch * 0.65F * MathHelper.RADIANS_PER_DEGREE;
