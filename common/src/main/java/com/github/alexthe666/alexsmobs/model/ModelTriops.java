...
public class ModelTriops extends AdvancedEntityModel<EntityTriops> {
    ...
    public ModelTriops() {
        ...
        body.addBox(-3.5F, -1.1F, -3.5F, 7.0F, 3.0F, 7.0F, 0.0F, false);

        leftAntenna = new AdvancedModelBox(this);
        leftAntenna.setRotationPoint(3.5F, 2.0F, -2.0F);
        body.addChild(leftAntenna);
        leftAntenna.setTextureOffset(15, 21);
        leftAntenna.addBox(-1.0F, -1.0F, 0.0F, 4.0F, 1.0F, 3.0F, 0.0F, false);

        rightAntenna = new AdvancedModelBox(this);
        rightAntenna.setRotationPoint(-3.5F, 2.0F, -2.0F);
        body.addChild(rightAntenna);
        rightAntenna.setTextureOffset(15, 21);
        rightAntenna.addBox(-3.0F, -1.0F, 0.0F, 4.0F, 1.0F, 3.0F, 0.0F, true);
        ...
        leftLegs.setTextureOffset(22, 0);
        leftLegs.addBox(0.0F, 0.0F, -2.0F, 3.0F, 0.0F, 4.0F, 0.0F, false);
        ...
        rightLegs.setTextureOffset(22, 0);
        rightLegs.addBox(-3.0F, 0.0F, -2.0F, 3.0F, 0.0F, 4.0F, 0.0F, true);

        tail1 = new AdvancedModelBox(this);
        tail1.setRotationPoint(0.0F, 1.0F, 2.3F);
        body.addChild(tail1);
        tail1.setTextureOffset(0, 18);
        tail1.addBox(-1.5F, -1.0F, -0.8F, 3.0F, 2.0F, 4.0F, 0.0F, false);
        tail1.setTextureOffset(22, 11);
        tail1.addBox(1.5F, 1.0F, -0.8F, 2.0F, 0.0F, 4.0F, 0.0F, false);
        tail1.setTextureOffset(22, 11);
        tail1.addBox(-3.5F, 1.0F, -0.8F, 2.0F, 0.0F, 4.0F, 0.0F, true);

        tail2 = new AdvancedModelBox(this);
        tail2.setRotationPoint(0.0F, 0.2F, 3.2F);
        tail1.addChild(tail2);
        tail2.setTextureOffset(11, 14);
        tail2.addBox(-1.5F, -1.2F, 0.0F, 3.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        leftTailFlipper.setTextureOffset(0, 11);
        leftTailFlipper.addBox(0.0F, 0.0F, -1.0F, 1.0F, 0.0F, 6.0F, 0.0F, false);
        ...
        rightTailFlipper.setTextureOffset(0, 11);
        rightTailFlipper.addBox(-1.0F, 0.0F, -1.0F, 1.0F, 0.0F, 6.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityTriops entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        float yaw = entity.prevBodyYaw + (entity.bodyYaw - entity.prevBodyYaw) * partialTick;
        ...
        this.body.rotateAngleX += headPitch * MathHelper.RADIANS_PER_DEGREE * swimAmount;
