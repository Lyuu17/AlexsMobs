...
public class ModelBisonBaby extends AdvancedEntityModel<EntityBison> {
    ...
    public ModelBisonBaby() {
        ...
        head.addBox(-2.5F, -3.0F, -8.0F, 5.0F, 6.0F, 9.0F, 0.0F, false);
        ...
        left_ear.setTextureOffset(24, 0);
        left_ear.addBox(0.0F, -1.0F, -0.5F, 4.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        right_ear.setTextureOffset(24, 0);
        right_ear.addBox(-4.0F, -1.0F, -0.5F, 4.0F, 2.0F, 1.0F, 0.0F, true);
        ...
        tail.addBox(-1.0F, -1.0F, 0.0F, 2.0F, 6.0F, 1.0F, 0.0F, false);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setRotationPoint(1.8F, 3.5F, 7.5F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(33, 26);
        left_leg.addBox(-1.0F, 1.0F, -1.5F, 2.0F, 9.0F, 3.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setRotationPoint(-1.8F, 3.5F, 7.5F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(33, 26);
        right_leg.addBox(-1.0F, 1.0F, -1.5F, 2.0F, 9.0F, 3.0F, 0.0F, true);
    ...
    public void setAngles(EntityBison entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.head.rotateAngleY += netHeadYaw * 0.75F * MathHelper.RADIANS_PER_DEGREE;
