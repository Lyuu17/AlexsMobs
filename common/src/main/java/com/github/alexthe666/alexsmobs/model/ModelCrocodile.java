...
public class ModelCrocodile extends AdvancedEntityModel<EntityCrocodile> {
    ...
    public ModelCrocodile() {
        ...
        body.addBox(-8.0F, -7.0F, -13.0F, 16.0F, 12.0F, 27.0F, 0.0F, false);

        left_leg = new AdvancedModelBox(this, "left_leg");
        left_leg.setRotationPoint(8.0F, 3.0F, 10.0F);
        body.addChild(left_leg);
        left_leg.setTextureOffset(0, 0);
        left_leg.addBox(-2.0F, -2.0F, -5.0F, 5.0F, 8.0F, 8.0F, 0.0F, false);

        left_foot = new AdvancedModelBox(this, "left_foot");
        left_foot.setRotationPoint(2.0F, 6.0F, -3.0F);
        left_leg.addChild(left_foot);
        left_foot.setTextureOffset(45, 42);
        left_foot.addBox(-2.0F, -0.01F, -5.0F, 5.0F, 0.0F, 6.0F, 0.0F, false);

        right_leg = new AdvancedModelBox(this, "right_leg");
        right_leg.setRotationPoint(-8.0F, 3.0F, 10.0F);
        body.addChild(right_leg);
        right_leg.setTextureOffset(0, 0);
        right_leg.addBox(-3.0F, -2.0F, -5.0F, 5.0F, 8.0F, 8.0F, 0.0F, true);

        right_foot = new AdvancedModelBox(this, "right_foot");
        right_foot.setRotationPoint(-2.0F, 6.0F, -3.0F);
        right_leg.addChild(right_foot);
        right_foot.setTextureOffset(45, 42);
        right_foot.addBox(-3.0F, -0.01F, -5.0F, 5.0F, 0.0F, 6.0F, 0.0F, true);

        left_arm = new AdvancedModelBox(this, "left_arm");
        left_arm.setRotationPoint(9.0F, 1.0F, -9.0F);
        body.addChild(left_arm);
        left_arm.setTextureOffset(0, 40);
        left_arm.addBox(-2.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.0F, false);

        left_hand = new AdvancedModelBox(this, "left_hand");
        left_hand.setRotationPoint(0.0F, 8.0F, 1.0F);
        left_arm.addChild(left_hand);
        left_hand.setTextureOffset(0, 17);
        left_hand.addBox(-2.0F, -0.01F, -7.0F, 6.0F, 0.0F, 7.0F, 0.0F, false);

        right_arm = new AdvancedModelBox(this, "right_arm");
        right_arm.setRotationPoint(-9.0F, 1.0F, -9.0F);
        body.addChild(right_arm);
        right_arm.setTextureOffset(0, 40);
        right_arm.addBox(-2.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, 0.0F, true);

        right_hand = new AdvancedModelBox(this, "right_hand");
        right_hand.setRotationPoint(0.0F, 8.0F, 1.0F);
        right_arm.addChild(right_hand);
        right_hand.setTextureOffset(0, 17);
        right_hand.addBox(-4.0F, -0.01F, -7.0F, 6.0F, 0.0F, 7.0F, 0.0F, true);

        tail1 = new AdvancedModelBox(this, "tail1");
        tail1.setRotationPoint(0.0F, 0.0F, 16.0F);
        body.addChild(tail1);
        tail1.setTextureOffset(0, 40);
        tail1.addBox(-5.0F, -5.0F, -2.0F, 10.0F, 10.0F, 24.0F, 0.0F, false);
        tail1.setTextureOffset(45, 51);
        tail1.addBox(-5.0F, -7.0F, -2.0F, 10.0F, 2.0F, 24.0F, 0.0F, false);

        tail2 = new AdvancedModelBox(this, "tail2");
        tail2.setRotationPoint(0.0F, 1.0F, 24.0F);
        tail1.addChild(tail2);
        tail2.setTextureOffset(62, 15);
        tail2.addBox(-3.0F, -3.0F, -2.0F, 6.0F, 7.0F, 25.0F, 0.0F, false);
        tail2.setTextureOffset(43, 78);
        tail2.addBox(-2.0F, -5.0F, -2.0F, 4.0F, 2.0F, 20.0F, 0.0F, false);

        tail3 = new AdvancedModelBox(this, "tail3");
        tail3.setRotationPoint(0.0F, 0.0F, 18.0F);
        tail2.addChild(tail3);
        tail3.setTextureOffset(0, 75);
        tail3.addBox(0.0F, -6.0F, 0.0F, 0.0F, 10.0F, 21.0F, 0.0F, false);

        neck = new AdvancedModelBox(this, "neck");
        neck.setRotationPoint(0.0F, 0.0F, -15.0F);
        body.addChild(neck);
        neck.setTextureOffset(80, 89);
        neck.addBox(-6.0F, -5.0F, -10.0F, 12.0F, 10.0F, 12.0F, 0.0F, false);
        neck.setTextureOffset(60, 0);
        neck.addBox(-4.0F, -6.0F, -10.0F, 8.0F, 1.0F, 12.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, 1.0F, -11.0F);
        neck.addChild(head);
        head.setTextureOffset(72, 78);
        head.addBox(-5.0F, -4.0F, -5.0F, 10.0F, 4.0F, 6.0F, 0.0F, false);
        head.setTextureOffset(60, 14);
        head.addBox(-4.0F, -5.0F, -5.0F, 8.0F, 1.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(22, 78);
        head.addBox(-3.0F, -4.0F, -17.0F, 6.0F, 4.0F, 12.0F, 0.0F, false);

        crown = new AdvancedModelBox(this, "crown");
        crown.setRotationPoint(0.0F, -5.0F, -2.0F);
        head.addChild(crown);
        crown.setTextureOffset(49, 54);
        crown.addBox(-1.5F, -5.0F, -2.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
        ...
        left_upperteeth.setTextureOffset(104, 23);
        left_upperteeth.addBox(0.0F, 0.0F, -0.025F, 3.0F, 2.0F, 11.0F, 0.0F, false);
        ...
        right_upperteeth.setTextureOffset(104, 23);
        right_upperteeth.addBox(-3.0F, 0.0F, -0.025F, 3.0F, 2.0F, 11.0F, 0.0F, true);

        jaw = new AdvancedModelBox(this, "jaw");
        jaw.setRotationPoint(0.0F, 0.0F, 0.0F);
        head.addChild(jaw);
        jaw.setTextureOffset(100, 7);
        jaw.addBox(-5.5F, -2.0F, -6.0F, 11.0F, 5.0F, 7.0F, 0.001F, false);
        jaw.setTextureOffset(90, 48);
        jaw.addBox(-3.0F, 0.0F, -17.0F, 6.0F, 3.0F, 11.0F, 0.0F, false);
        ...
        left_lowerteeth.setTextureOffset(105, 67);
        left_lowerteeth.addBox(0.0F, -2.0F, -0.025F, 3.0F, 2.0F, 11.0F, 0.0F, false);
        ...
        right_lowerteeth.setTextureOffset(105, 67);
        right_lowerteeth.addBox(-3.0F, -2.0F, -0.025F, 3.0F, 2.0F, 11.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityCrocodile entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetToDefaultPose();
