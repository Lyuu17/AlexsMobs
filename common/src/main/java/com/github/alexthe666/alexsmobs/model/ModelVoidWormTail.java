...
public class ModelVoidWormTail extends AdvancedEntityModel<EntityVoidWormPart> {
	...
	public ModelVoidWormTail(float f) {
		...
		body.addBox(-8.0F, -19.0F, 0.0F, 16.0F, 38.0F, 35.0F, f, false);
		...
		frillstop_left.setTextureOffset(65, 36);
		frillstop_left.addBox(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, f, false);
		...
		frillstop_right.setTextureOffset(65, 36);
		frillstop_right.addBox(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, f, true);
		...
		frillsbottom_left.setTextureOffset(65, 36);
		frillsbottom_left.addBox(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, f, false);
		...
		frillsbottom_right.setTextureOffset(65, 36);
		frillsbottom_right.addBox(0.0F, -14.0F, -16.0F, 0.0F, 14.0F, 38.0F, f, true);
