...
public class AMEntityRegistry {
    ...
    public static final RegistrySupplier<EntityType<EntitySunbird>> SUNBIRD = registerEntity("sunbird",
            EntityType.Builder.create(EntitySunbird::new, SpawnGroup.CREATURE)
                    ...
                    .setUpdateInterval(1)*/);
//    public static final RegistrySupplier<EntityType<EntityGorilla>> GORILLA = DEF_REG.register("gorilla", () -> registerEntity(EntityType.Builder.create(EntityGorilla::new, SpawnGroup.CREATURE).setDimensions(1.15F, 1.35F).maxTrackingRange(10), "gorilla"));
...
//                    .setCustomClientFactory(EntityMosquitoSpit::new)
    ...
    public static final RegistrySupplier<EntityType<EntityHammerheadShark>> HAMMERHEAD_SHARK = registerEntity("hammerhead_shark",
            EntityType.Builder.create(EntityHammerheadShark::new, SpawnGroup.WATER_CREATURE)
                    ...
                    .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntitySharkToothArrow>> SHARK_TOOTH_ARROW = DEF_REG.register("shark_tooth_arrow", () -> registerEntity(EntityType.Builder.create(EntitySharkToothArrow::new, SpawnGroup.MISC).setDimensions(0.5F, 0.5F).setCustomClientFactory(EntitySharkToothArrow::new), "shark_tooth_arrow"));
...
//                    .setUpdateInterval(1)
    ...
    public static final RegistrySupplier<EntityType<EntityMoose>> MOOSE = registerEntity("moose",
            EntityType.Builder.create(EntityMoose::new, SpawnGroup.CREATURE)
                    ...
                    .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntityMimicube>> MIMICUBE = DEF_REG.register("mimicube", () -> registerEntity(EntityType.Builder.create(EntityMimicube::new, SpawnGroup.MONSTER).setDimensions(0.9F, 0.9F).maxTrackingRange(8), "mimicube"));
    ...
    public static final RegistrySupplier<EntityType<EntityBlobfish>> BLOBFISH = registerEntity("blobfish",
        EntityType.Builder.create(EntityBlobfish::new, SpawnGroup.WATER_AMBIENT)
                ...
                .maxTrackingRange(5));
//    public static final RegistrySupplier<EntityType<EntitySeal>> SEAL = DEF_REG.register("seal", () -> registerEntity(EntityType.Builder.create(EntitySeal::new, SpawnGroup.CREATURE).setDimensions(1.45F, 0.9F).maxTrackingRange(10), "seal"));
...
//                    .setCustomClientFactory(EntityCockroachEgg::new)
                    .makeFireImmune());
//    public static final RegistrySupplier<EntityType<EntityShoebill>> SHOEBILL = DEF_REG.register("shoebill", () -> registerEntity(EntityType.Builder.create(EntityShoebill::new, SpawnGroup.CREATURE).setDimensions(0.8F, 1.5F).setUpdateInterval(1).maxTrackingRange(10), "shoebill"));
...
//                    .setUpdateInterval(1)
    ...
    public static final RegistrySupplier<EntityType<EntitySnowLeopard>> SNOW_LEOPARD = registerEntity("snow_leopard",
            EntityType.Builder.create(EntitySnowLeopard::new, SpawnGroup.CREATURE)
                    ...
                    .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntitySpectre>> SPECTRE = DEF_REG.register("spectre", () -> registerEntity(EntityType.Builder.create(EntitySpectre::new, SpawnGroup.CREATURE).setDimensions(3.15F, 0.8F).makeFireImmune().maxTrackingRange(10).setShouldReceiveVelocityUpdates(true).setUpdateInterval(1), "spectre"));
...
//    public static final RegistrySupplier<EntityType<EntityMantisShrimp>> MANTIS_SHRIMP = DEF_REG.register("mantis_shrimp", () -> registerEntity(EntityType.Builder.create(EntityMantisShrimp::new, SpawnGroup.WATER_CREATURE).setDimensions(1.25F, 1.2F).maxTrackingRange(10), "mantis_shrimp"));
...
//                    .setCustomClientFactory(EntityEmuEgg::new)
    ...
    //    public static final RegistrySupplier<EntityType<EntityLeafcutterAnt>> LEAFCUTTER_ANT = DEF_REG.register("leafcutter_ant", () -> registerEntity(EntityType.Builder.create(EntityLeafcutterAnt::new, SpawnGroup.CREATURE).setDimensions(0.8F, 0.5F).maxTrackingRange(5), "leafcutter_ant"));
...
//                    .setUpdateInterval(1)
                    .maxTrackingRange(14));
//    public static final RegistrySupplier<EntityType<EntityTiger>> TIGER = DEF_REG.register("tiger", () -> registerEntity(EntityType.Builder.create(EntityTiger::new, SpawnGroup.CREATURE).setDimensions(1.45F, 1.2F).maxTrackingRange(10), "tiger"));
...
//                    .setCustomClientFactory(EntityVoidPortal::new)
    ...
    public static final RegistrySupplier<EntityType<EntityMimicOctopus>> MIMIC_OCTOPUS = registerEntity("mimic_octopus",
        EntityType.Builder.create(EntityMimicOctopus::new, SpawnGroup.WATER_CREATURE)
                ...
                .maxTrackingRange(8));
//    public static final RegistrySupplier<EntityType<EntitySeagull>> SEAGULL = DEF_REG.register("seagull", () -> registerEntity(EntityType.Builder.create(EntitySeagull::new, SpawnGroup.CREATURE).setDimensions(0.45F, 0.45F).maxTrackingRange(10), "seagull"));
...
//                    .setUpdateInterval(1)
                    .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntityCosmaw>> COSMAW = DEF_REG.register("cosmaw", () -> registerEntity(EntityType.Builder.create(EntityCosmaw::new, SpawnGroup.CREATURE).setDimensions(1.95F, 1.8F).maxTrackingRange(10), "cosmaw"));
    public static final RegistrySupplier<EntityType<EntityToucan>> TOUCAN = registerEntity("toucan",
        EntityType.Builder.create(EntityToucan::new, SpawnGroup.CREATURE)
                .setDimensions(0.45F, 0.45F)
                .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntityManedWolf>> MANED_WOLF = DEF_REG.register("maned_wolf", () -> registerEntity(EntityType.Builder.create(EntityManedWolf::new, SpawnGroup.CREATURE).setDimensions(0.9F, 1.26F).maxTrackingRange(10), "maned_wolf"));
    ...
    //    public static final RegistrySupplier<EntityType<EntityVineLasso>> VINE_LASSO = DEF_REG.register("vine_lasso", () -> registerEntity(EntityType.Builder.create(EntityVineLasso::new, SpawnGroup.MISC).setDimensions(0.85F, 0.2F).setCustomClientFactory(EntityVineLasso::new).makeFireImmune(), "vine_lasso"));
//    public static final RegistrySupplier<EntityType<EntityAnteater>> ANTEATER = DEF_REG.register("anteater", () -> registerEntity(EntityType.Builder.create(EntityAnteater::new, SpawnGroup.CREATURE).setDimensions(1.3F, 1.1F).maxTrackingRange(10), "anteater"));
//    public static final RegistrySupplier<EntityType<EntityRockyRoller>> ROCKY_ROLLER = DEF_REG.register("rocky_roller", () -> registerEntity(EntityType.Builder.create(EntityRockyRoller::new, SpawnGroup.MONSTER).setDimensions(1.2F, 1.45F).maxTrackingRange(8), "rocky_roller"));
//    public static final RegistrySupplier<EntityType<EntityFlutter>> FLUTTER = DEF_REG.register("flutter", () -> registerEntity(EntityType.Builder.create(EntityFlutter::new, SpawnGroup.AMBIENT).setDimensions(0.5F, 0.7F).maxTrackingRange(6), "flutter"));
//    public static final RegistrySupplier<EntityType<EntityPollenBall>> POLLEN_BALL = DEF_REG.register("pollen_ball", () -> registerEntity(EntityType.Builder.create(EntityPollenBall::new, SpawnGroup.MISC).setDimensions(0.35F, 0.35F).setCustomClientFactory(EntityPollenBall::new).makeFireImmune(), "pollen_ball"));
//    public static final RegistrySupplier<EntityType<EntityGeladaMonkey>> GELADA_MONKEY = DEF_REG.register("gelada_monkey", () -> registerEntity(EntityType.Builder.create(EntityGeladaMonkey::new, SpawnGroup.CREATURE).setDimensions(1.2F, 1.2F).maxTrackingRange(10), "gelada_monkey"));
    ...
    //    public static final RegistrySupplier<EntityType<EntitySquidGrapple>> SQUID_GRAPPLE = DEF_REG.register("squid_grapple", () -> registerEntity(EntityType.Builder.create(EntitySquidGrapple::new, SpawnGroup.MISC).setDimensions(0.5F, 0.5F).setCustomClientFactory(EntitySquidGrapple::new).makeFireImmune(), "squid_grapple"));
    public static final RegistrySupplier<EntityType<EntitySeaBear>> SEA_BEAR = registerEntity("sea_bear",
            EntityType.Builder.create(EntitySeaBear::new, SpawnGroup.WATER_CREATURE)
                    ...
                    .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntityDevilsHolePupfish>> DEVILS_HOLE_PUPFISH = DEF_REG.register("devils_hole_pupfish", () -> registerEntity(EntityType.Builder.create(EntityDevilsHolePupfish::new, SpawnGroup.WATER_AMBIENT).setDimensions(0.6F, 0.4F).maxTrackingRange(4), "devils_hole_pupfish"));
//    public static final RegistrySupplier<EntityType<EntityCatfish>> CATFISH = DEF_REG.register("catfish", () -> registerEntity(EntityType.Builder.create(EntityCatfish::new, SpawnGroup.WATER_AMBIENT).setDimensions(0.9F, 0.6F).maxTrackingRange(5), "catfish"));
    public static final RegistrySupplier<EntityType<EntityFlyingFish>> FLYING_FISH = registerEntity("flying_fish",
        EntityType.Builder.create(EntityFlyingFish::new, SpawnGroup.WATER_AMBIENT)
                ...
                .maxTrackingRange(5));
//    public static final RegistrySupplier<EntityType<EntitySkelewag>> SKELEWAG = DEF_REG.register("skelewag", () -> registerEntity(EntityType.Builder.create(EntitySkelewag::new, SpawnGroup.MONSTER).setDimensions(2F, 1.2F).setShouldReceiveVelocityUpdates(true).setUpdateInterval(1).maxTrackingRange(8), "skelewag"));
//    public static final RegistrySupplier<EntityType<EntityRainFrog>> RAIN_FROG = DEF_REG.register("rain_frog", () -> registerEntity(EntityType.Builder.create(EntityRainFrog::new, SpawnGroup.AMBIENT).setDimensions(0.55F, 0.5F).maxTrackingRange(5), "rain_frog"));
//    public static final RegistrySupplier<EntityType<EntityPotoo>> POTOO = DEF_REG.register("potoo", () -> registerEntity(EntityType.Builder.create(EntityPotoo::new, SpawnGroup.CREATURE).setDimensions(0.6F, 0.8F).maxTrackingRange(10), "potoo"));
//    public static final RegistrySupplier<EntityType<EntityMudskipper>> MUDSKIPPER = DEF_REG.register("mudskipper", () -> registerEntity(EntityType.Builder.create(EntityMudskipper::new, SpawnGroup.CREATURE).setDimensions(0.7F, 0.44F).maxTrackingRange(10), "mudskipper"));
//    public static final RegistrySupplier<EntityType<EntityMudBall>> MUD_BALL = DEF_REG.register("mud_ball", () -> registerEntity(EntityType.Builder.create(EntityMudBall::new, SpawnGroup.MISC).setDimensions(0.35F, 0.35F).setCustomClientFactory(EntityMudBall::new).makeFireImmune(), "mud_ball"));
//    public static final RegistrySupplier<EntityType<EntityRhinoceros>> RHINOCEROS = DEF_REG.register("rhinoceros", () -> registerEntity(EntityType.Builder.create(EntityRhinoceros::new, SpawnGroup.CREATURE).setDimensions(2.3F, 2.4F).maxTrackingRange(10), "rhinoceros"));
//    public static final RegistrySupplier<EntityType<EntitySugarGlider>> SUGAR_GLIDER = DEF_REG.register("sugar_glider", () -> registerEntity(EntityType.Builder.create(EntitySugarGlider::new, SpawnGroup.CREATURE).setDimensions(0.8F, 0.45F).maxTrackingRange(10), "sugar_glider"));
...
//                .setUpdateInterval(1)
                .makeFireImmune()
                .maxTrackingRange(8));
//    public static final RegistrySupplier<EntityType<EntitySkreecher>> SKREECHER = DEF_REG.register("skreecher", () -> registerEntity(EntityType.Builder.create(EntitySkreecher::new, SpawnGroup.CREATURE).setDimensions(0.99F, 0.95F).setShouldReceiveVelocityUpdates(true).setUpdateInterval(1).maxTrackingRange(8), "skreecher"));
    ...
    public static final RegistrySupplier<EntityType<EntityMurmurHead>> MURMUR_HEAD = registerEntity("murmur_head",
            EntityType.Builder.create(EntityMurmurHead::new, SpawnGroup.MONSTER)
                    ...
                    .maxTrackingRange(8));
//    public static final RegistrySupplier<EntityType<EntityTendonSegment>> TENDON_SEGMENT = DEF_REG.register("tendon_segment", () -> registerEntity(EntityType.Builder.create(EntityTendonSegment::new, SpawnGroup.MISC).setDimensions(0.1F, 0.1F).setCustomClientFactory(EntityTendonSegment::new).makeFireImmune(), "tendon_segment"));
    public static final RegistrySupplier<EntityType<EntitySkunk>> SKUNK = registerEntity("skunk",
        EntityType.Builder.create(EntitySkunk::new, SpawnGroup.CREATURE)
                ...
                .maxTrackingRange(10));
//    public static final RegistrySupplier<EntityType<EntityFart>> FART = DEF_REG.register("fart", () -> registerEntity(EntityType.Builder.create(EntityFart::new, SpawnGroup.MISC).setDimensions(0.7F, 0.3F).setCustomClientFactory(EntityFart::new).makeFireImmune(), "fart"));
//    public static final RegistrySupplier<EntityType<EntityBananaSlug>> BANANA_SLUG = DEF_REG.register("banana_slug", () -> registerEntity(EntityType.Builder.create(EntityBananaSlug::new, SpawnGroup.CREATURE).setDimensions(0.8F, 0.4F).maxTrackingRange(10), "banana_slug"));
