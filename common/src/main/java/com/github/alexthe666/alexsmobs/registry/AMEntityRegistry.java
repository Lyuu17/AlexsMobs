...
import com.github.alexthe666.alexsmobs.misc.PlatformEntityConstructors;
...
public class AMEntityRegistry {
    ...
    public static final DeferredRegister<EntityType<? extends Entity>> DEF_REG = DeferredRegister.create(AlexsMobs.MOD_ID, Registries.ENTITY_TYPE);
    public static final RegistrySupplier<EntityType<EntityGrizzlyBear>> GRIZZLY_BEAR = DEF_REG.register("grizzly_bear", () -> registerEntity(EntityType.Builder.of(EntityGrizzlyBear::new, MobCategory.CREATURE).sized(1.6F, 1.8F).setTrackingRange(10), "grizzly_bear"));
    ...
    public static final RegistrySupplier<EntityType<EntityCrimsonMosquito>> CRIMSON_MOSQUITO = DEF_REG.register("crimson_mosquito", () -> registerEntity(EntityType.Builder.of(EntityCrimsonMosquito::new, MobCategory.MONSTER).sized(1.25F, 1.15F).fireImmune().setTrackingRange(8), "crimson_mosquito"));
    public static final RegistrySupplier<EntityType<EntityMosquitoSpit>> MOSQUITO_SPIT = DEF_REG.register("mosquito_spit", () -> registerEntity(EntityType.Builder.of(EntityMosquitoSpit::new, MobCategory.MISC).sized(0.5F, 0.5F).setCustomClientFactory(EntityMosquitoSpit::new).fireImmune(), "mosquito_spit"));
    ...
    public static final RegistrySupplier<EntityType<EntityLobster>> LOBSTER = DEF_REG.register("lobster", () -> registerEntity(EntityType.Builder.of(EntityLobster::new, MobCategory.WATER_AMBIENT).sized(0.7F, 0.4F).setTrackingRange(5), "lobster"));
    ...
    public static final RegistrySupplier<EntityType<EntityWarpedToad>> WARPED_TOAD = DEF_REG.register("warped_toad", () -> registerEntity(EntityType.Builder.of(EntityWarpedToad::new, MobCategory.CREATURE).sized(0.9F, 1.4F).fireImmune().setShouldReceiveVelocityUpdates(true).setUpdateInterval(1).setTrackingRange(10), "warped_toad"));
    ...
    public static final RegistrySupplier<EntityType<? extends Entity>> COCKROACH = DEF_REG.register("cockroach", () -> registerEntity(PlatformEntityConstructors.createCochroachEntityBuilder(MobCategory.CREATURE).sized(0.7F, 0.3F), "cockroach"));
    ...
    public static final RegistrySupplier<EntityType<? extends Entity>> ALLIGATOR_SNAPPING_TURTLE = DEF_REG.register("alligator_snapping_turtle", () -> registerEntity(PlatformEntityConstructors.createAlligatorSnappingTurtleEntityBuilder(MobCategory.CREATURE).sized(1.25F, 0.65F), "alligator_snapping_turtle"));
    public static final RegistrySupplier<EntityType<? extends Entity>> MUNGUS = DEF_REG.register("mungus", () -> registerEntity(PlatformEntityConstructors.createMungusEntityBuilder(MobCategory.CREATURE).sized(0.75F, 1.45F), "mungus"));
    ...
    public static final RegistrySupplier<EntityType<EntityWarpedMosco>> WARPED_MOSCO = DEF_REG.register("warped_mosco", () -> registerEntity(EntityType.Builder.of(EntityWarpedMosco::new, MobCategory.MONSTER).sized(1.99F, 3.25F).fireImmune().setTrackingRange(10), "warped_mosco"));
    public static final RegistrySupplier<EntityType<EntityHemolymph>> HEMOLYMPH = DEF_REG.register("hemolymph", () -> registerEntity(EntityType.Builder.of(EntityHemolymph::new, MobCategory.MISC).sized(0.5F, 0.5F).setCustomClientFactory(EntityHemolymph::new).fireImmune(), "hemolymph"));
    ...
    public static final RegistrySupplier<EntityType<EntityCachalotWhale>> CACHALOT_WHALE = DEF_REG.register("cachalot_whale", () -> registerEntity(EntityType.Builder.of(EntityCachalotWhale::new, MobCategory.WATER_CREATURE).sized(9F, 4.0F).setTrackingRange(10), "cachalot_whale"));
    public static final RegistrySupplier<EntityType<EntityCachalotEcho>> CACHALOT_ECHO = DEF_REG.register("cachalot_echo", () -> registerEntity(EntityType.Builder.of(EntityCachalotEcho::new, MobCategory.MISC).sized(2F, 2F).setCustomClientFactory(EntityCachalotEcho::new).fireImmune(), "cachalot_echo"));
    ...
    public static final RegistrySupplier<EntityType<EntityMimicOctopus>> MIMIC_OCTOPUS = DEF_REG.register("mimic_octopus", () -> registerEntity(EntityType.Builder.of(EntityMimicOctopus::new, MobCategory.WATER_CREATURE).sized(0.9F, 0.6F).setTrackingRange(8), "mimic_octopus"));
    ...
    public static final RegistrySupplier<EntityType<EntityLaviathan>> LAVIATHAN = DEF_REG.register("laviathan", () -> registerEntity(EntityType.Builder.of(EntityLaviathan::new, MobCategory.CREATURE).sized(3.3F, 2.4F).fireImmune().setShouldReceiveVelocityUpdates(true).setUpdateInterval(1).setTrackingRange(10), "laviathan"));
    ...
    public static final RegistrySupplier<EntityType<EntityAnaconda>> ANACONDA = DEF_REG.register("anaconda", () -> registerEntity(EntityType.Builder.of(EntityAnaconda::new, MobCategory.CREATURE).sized(0.8F, 0.8F).setTrackingRange(10), "anaconda"));
    public static final RegistrySupplier<EntityType<EntityAnacondaPart>> ANACONDA_PART = DEF_REG.register("anaconda_part", () -> registerEntity(EntityType.Builder.of(EntityAnacondaPart::new, MobCategory.MISC).sized(0.8F, 0.8F).setShouldReceiveVelocityUpdates(true).setUpdateInterval(1).setTrackingRange(10), "anaconda_part"));
    ...
    public static final RegistrySupplier<EntityType<EntityTerrapin>> TERRAPIN = DEF_REG.register("terrapin", () -> registerEntity(EntityType.Builder.of(EntityTerrapin::new, MobCategory.WATER_AMBIENT).sized(0.75F, 0.45F).setTrackingRange(5), "terrapin"));
    public static final RegistrySupplier<EntityType<EntityCombJelly>> COMB_JELLY = DEF_REG.register("comb_jelly", () -> registerEntity(EntityType.Builder.of(EntityCombJelly::new, MobCategory.WATER_AMBIENT).sized(0.65F, 0.8F).setTrackingRange(5), "comb_jelly"));
    ...
    public static final RegistrySupplier<EntityType<EntityBunfungus>> BUNFUNGUS = DEF_REG.register("bunfungus", () -> registerEntity(EntityType.Builder.of(EntityBunfungus::new, MobCategory.CREATURE).sized(1.85F, 2.1F).setTrackingRange(10), "bunfungus"));
    public static final RegistrySupplier<EntityType<? extends Entity>> BISON = DEF_REG.register("bison", () -> registerEntity(PlatformEntityConstructors.createBisonEntityBuilder(MobCategory.CREATURE).sized(2.4F, 2.1F), "bison"));
    public static final RegistrySupplier<EntityType<EntityGiantSquid>> GIANT_SQUID = DEF_REG.register("giant_squid", () -> registerEntity(EntityType.Builder.of(EntityGiantSquid::new, MobCategory.WATER_CREATURE).sized(0.9F, 1.2F).setTrackingRange(10), "giant_squid"));
    ...
    public static final RegistrySupplier<EntityType<EntityTriops>> TRIOPS = DEF_REG.register("triops", () -> registerEntity(EntityType.Builder.of(EntityTriops::new, MobCategory.WATER_AMBIENT).sized(0.7F, 0.25F).setTrackingRange(5), "triops"));
