...
public class ModelFlutterPotted extends AdvancedEntityModel<EntityFlutter> {
    ...
    public ModelFlutterPotted() {
        ...
        root.addChild(pot);
        pot.setTextureOffset(24, 43);
        pot.addBox(-3.0F, -6.0F, -3.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);
        pot.setTextureOffset(3, 42);
        pot.addBox(-3.0F, -5.8F, -3.0F, 6.0F, 0.0F, 6.0F, 0.0F, false);

        left_foot = new AdvancedModelBox(this, "left_foot");
        left_foot.setRotationPoint(1.6F, 0.0F, 0.8F);
        pot.addChild(left_foot);
        left_foot.setTextureOffset(1, 50);
        left_foot.addBox(-1.0F, 0.0F, -2.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);

        right_foot = new AdvancedModelBox(this, "right_foot");
        right_foot.setRotationPoint(-1.6F, 0.0F, 0.8F);
        pot.addChild(right_foot);
        right_foot.setTextureOffset(1, 50);
        right_foot.addBox(-1.0F, 0.0F, -2.0F, 2.0F, 1.0F, 2.0F, 0.0F, true);
