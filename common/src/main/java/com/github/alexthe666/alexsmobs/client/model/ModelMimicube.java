...
public class ModelMimicube extends AdvancedEntityModel<EntityMimicube> {
	...
	public ModelMimicube() {
		...
		body.addBox(-8.0F, -14.0F, -8.0F, 16.0F, 14.0F, 16.0F, 0.0F, false);

		innerbody = new AdvancedModelBox(this, "innerbody");
		innerbody.setPos(0.0F, -7.0F, 0.0F);
		root.addChild(innerbody);
		innerbody.setTextureOffset(0, 31);
		innerbody.addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);

		mouth = new AdvancedModelBox(this, "mouth");
		mouth.setPos(2.0F, 4.0F, -5.0F);
		innerbody.addChild(mouth);
		mouth.setTextureOffset(0, 12);
		mouth.addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		...
		eye_left.setTextureOffset(0, 6);
		eye_left.addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
		...
		eye_right.setTextureOffset(0, 0);
		eye_right.addBox(-1.5F, -1.5F, -1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityMimicube entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
