...
//        try {
//            for (var f : BiomeConfig.class.getDeclaredFields()) {
//                Object obj = f.get(null);
//               if(obj instanceof Pair){
//				   String id = (String)((Pair) obj).getFirst();
//				   SpawnBiomeData data = (SpawnBiomeData)((Pair) obj).getSecond();
...
//    }
    ...
    public static boolean test(Pair<String, SpawnBiomeData> entry, RegistryEntry<Biome> biome, Identifier name){
		...
		return biomeConfigValues.get(entry.getFirst()).matches(biome, name);
	}

//	// FIXME forge registries
//	public static boolean test(Pair<String, SpawnBiomeData> spawns, RegistryEntry<Biome> biome) {
