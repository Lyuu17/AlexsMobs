...
public class ModelVoidWormShot extends AdvancedEntityModel<Entity> {
    ...
    public ModelVoidWormShot() {
        ...
        root.addChild(glass);
        glass.setTextureOffset(0, 21);
        glass.addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);

        cube = new AdvancedModelBox(this, "cube");
        cube.setPos(0.0F, -5.0F, 0.0F);
        root.addChild(cube);
        cube.setTextureOffset(0, 0);
        cube.addBox(-5.0F, -5.0F, -5.0F, 10.0F, 10.0F, 10.0F, 0.0F, false);
