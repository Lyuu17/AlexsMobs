...
public class ModelStradpole extends AdvancedEntityModel<EntityStradpole> {
	...
	public ModelStradpole() {
		...
		body.addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		...
		hair_left.setTextureOffset(0, 17);
		hair_left.addBox(0.0F, 0.0F, -3.0F, 9.0F, 0.0F, 8.0F, 0.0F, false);
		...
		hair_right.setTextureOffset(0, 17);
		hair_right.addBox(-9.0F, 0.0F, -3.0F, 9.0F, 0.0F, 8.0F, 0.0F, true);

		tail = new AdvancedModelBox(this, "tail");
		tail.setPos(0.0F, 0.0F, 4.0F);
		body.addChild(tail);
		tail.setTextureOffset(24, 24);
		tail.addBox(0.0F, -4.0F, 0.0F, 0.0F, 8.0F, 14.0F, 0.0F, false);
		this.updateDefaultPose();
	}

	@Override
	public void setAngles(EntityStradpole entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
