    ...
    private static List<ItemStack> getDimensionalCarverShards() {
        if (DIMENSIONAL_CARVER_SHARDS == null || DIMENSIONAL_CARVER_SHARDS.isEmpty()) {
            DIMENSIONAL_CARVER_SHARDS = Util.make(Lists.newArrayList(), (list) -> {
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_0"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_1"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_2"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_3"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_4"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_5"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_6"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_7"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_8"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_9"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(new ResourceLocation("alexsmobs:dimensional_carver_shard_10"))));
            });
        }
        ...
        if (itemStackIn.getItem() == AMItemRegistry.TAB_ICON.get()) {
            ...
            if (level != null) {
                if (ItemTabIcon.hasCustomEntityDisplay(itemStackIn)) {
                    ...
                    var local = ItemTabIcon.getEntityType(itemStackIn.getTag());
