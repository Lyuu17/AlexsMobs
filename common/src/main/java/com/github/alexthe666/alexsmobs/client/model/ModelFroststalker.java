...
public class ModelFroststalker extends AdvancedEntityModel<EntityFroststalker> {
    ...
    public ModelFroststalker() {
        ...
        body.addBox(-3.0F, -4.0F, -10.0F, 6.0F, 7.0F, 16.0F, 0.0F, false);

        tail1 = new AdvancedModelBox(this, "tail1");
        tail1.setRotationPoint(0.0F, -1.0F, 5.0F);
        body.addChild(tail1);
        tail1.setTextureOffset(34, 24);
        tail1.addBox(-2.0F, -3.0F, 1.0F, 4.0F, 5.0F, 9.0F, 0.0F, false);
        tail1.setTextureOffset(0, 41);
        tail1.addBox(-1.0F, -5.0F, 1.0F, 2.0F, 2.0F, 9.0F, 0.0F, false);

        tail2 = new AdvancedModelBox(this, "tail2");
        tail2.setRotationPoint(0.0F, -2.0F, 9.0F);
        tail1.addChild(tail2);
        tail2.setTextureOffset(29, 0);
        tail2.addBox(-1.0F, -1.0F, 1.0F, 2.0F, 3.0F, 11.0F, 0.0F, false);
        tail2.setTextureOffset(21, 29);
        tail2.addBox(0.0F, -7.0F, 1.0F, 0.0F, 8.0F, 12.0F, 0.0F, false);
        ...
        icespikesleft.setTextureOffset(35, 39);
        icespikesleft.addBox(0.0F, -6.0F, -5.5F, 0.0F, 6.0F, 11.0F, 0.0F, false);
        ...
        icespikesright.setTextureOffset(35, 39);
        icespikesright.addBox(0.0F, -6.0F, -5.5F, 0.0F, 6.0F, 11.0F, 0.0F, true);

        neck = new AdvancedModelBox(this, "neck");
        neck.setRotationPoint(0.0F, -2.0F, -8.0F);
        body.addChild(neck);
        neck.setTextureOffset(52, 18);
        neck.addBox(-1.5F, -4.0F, -3.0F, 3.0F, 6.0F, 5.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -4.0F, -1.0F);
        neck.addChild(head);
        head.setTextureOffset(44, 62);
        head.addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 5.0F, 0.0F, false);
        head.setTextureOffset(5, 29);
        head.addBox(-2.0F, -4.0F, -9.0F, 4.0F, 3.0F, 7.0F, 0.0F, false);
        head.setTextureOffset(17, 50);
        head.addBox(-1.0F, -6.0F, 0.0F, 2.0F, 6.0F, 6.0F, 0.0F, false);
        head.setTextureOffset(47, 39);
        head.addBox(-2.0F, -1.0F, -9.0F, 4.0F, 2.0F, 7.0F, 0.0F, false);

        horn = new AdvancedModelBox(this, "horn");
        horn.setRotationPoint(0.0F, -3.0F, -3.0F);
        head.addChild(horn);
        setRotationAngle(horn, -0.3927F, 0.0F, 0.0F);
        horn.setTextureOffset(47, 6);
        horn.addBox(-1.0F, -2.0F, -8.0F, 2.0F, 2.0F, 9.0F, 0.0F, false);

        jaw = new AdvancedModelBox(this, "jaw");
        jaw.setRotationPoint(0.0F, -1.0F, -2.0F);
        head.addChild(jaw);
        jaw.setTextureOffset(40, 79);
        jaw.addBox(-1.5F, 0.0F, -7.0F, 3.0F, 1.0F, 7.0F, 0.0F, false);

        armleft = new AdvancedModelBox(this, "armleft");
        armleft.setRotationPoint(3.0F, 2.0F, -7.5F);
        body.addChild(armleft);
        armleft.setTextureOffset(0, 53);
        armleft.addBox(-1.0F, -1.0F, -1.5F, 2.0F, 10.0F, 3.0F, 0.0F, false);
        armleft.setTextureOffset(0, 24);
        armleft.addBox(-3.0F, 7.0F, -1.5F, 2.0F, 2.0F, 2.0F, 0.0F, false);

        armright = new AdvancedModelBox(this, "armright");
        armright.setRotationPoint(-3.0F, 2.0F, -7.5F);
        body.addChild(armright);
        armright.setTextureOffset(0, 53);
        armright.addBox(-1.0F, -1.0F, -1.5F, 2.0F, 10.0F, 3.0F, 0.0F, true);
        armright.setTextureOffset(0, 24);
        armright.addBox(1.0F, 7.0F, -1.5F, 2.0F, 2.0F, 2.0F, 0.0F, true);

        legleft = new AdvancedModelBox(this, "legleft");
        legleft.setRotationPoint(1.5F, 2.0F, 3.9F);
        body.addChild(legleft);
        legleft.setTextureOffset(0, 0);
        legleft.addBox(-1.0F, -2.0F, -2.0F, 3.0F, 11.0F, 4.0F, 0.0F, false);

        legright = new AdvancedModelBox(this, "legright");
        legright.setRotationPoint(-1.5F, 2.0F, 3.9F);
        body.addChild(legright);
        legright.setTextureOffset(0, 0);
        legright.addBox(-2.0F, -2.0F, -2.0F, 3.0F, 11.0F, 4.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityFroststalker entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
