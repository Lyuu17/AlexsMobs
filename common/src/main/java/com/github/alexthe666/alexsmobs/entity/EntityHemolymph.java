...
public class EntityHemolymph extends Entity {
    ...
    public EntityHemolymph(EntityType<? extends EntityHemolymph> entityType, World world) {
...
//    }
    ...
    public void tick() {
        ...
        if(this.getWorld().isClient){
            ...
            this.getWorld().addParticle(AMParticleRegistry.HEMOLYMPH.get(), this.getX() + r1, this.getY() + r2, this.getZ() + r3, r1 * 0.1F, r2 * 0.1F, r3 * 0.1F);
        }
        super.tick();
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity) {
            p_213868_1_.getEntity().damage(getDamageSources().mobProjectile(this, (LivingEntity) entity), 7.0F);
        }
    }
    ...
    public void shoot(double x, double y, double z, float velocity, float inaccuracy) {
        var vector3d = (new Vec3d(x, y, z)).normalize().add(this.random.nextGaussian() * (double) 0.0075F * (double) inaccuracy, this.random.nextGaussian() * (double) 0.0075F * (double) inaccuracy, this.random.nextGaussian() * (double) 0.0075F * (double) inaccuracy).multiply(velocity);
