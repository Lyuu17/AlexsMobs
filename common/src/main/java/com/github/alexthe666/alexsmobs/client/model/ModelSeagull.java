...
public class ModelSeagull extends AdvancedEntityModel<EntitySeagull> {
	...
	public ModelSeagull() {
		...
		body.addBox(-2.0F, -2.5F, -4.5F, 4.0F, 5.0F, 9.0F, 0.0F, false);

		tail = new AdvancedModelBox(this, "tail");
		tail.setPos(0.0F, -1.5F, 4.5F);
		body.addChild(tail);
		setRotationAngle(tail, -0.3927F, 0.0F, 0.0F);
		tail.setTextureOffset(18, 0);
		tail.addBox(-1.5F, 0.0F, 0.0F, 3.0F, 2.0F, 5.0F, 0.0F, false);

		head = new AdvancedModelBox(this, "head");
		head.setPos(0.0F, -0.5F, -4.0F);
		body.addChild(head);
		head.setTextureOffset(16, 26);
		head.addBox(-1.5F, -6.0F, -1.5F, 3.0F, 8.0F, 3.0F, 0.0F, false);

		beak = new AdvancedModelBox(this, "beak");
		beak.setPos(0.0F, -4.0F, -1.5F);
		head.addChild(beak);
		beak.setTextureOffset(11, 15);
		beak.addBox(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);

		left_wing = new AdvancedModelBox(this, "left_wing");
		left_wing.setPos(2.0F, -1.5F, -2.5F);
		body.addChild(left_wing);
		left_wing.setTextureOffset(0, 15);
		left_wing.addBox(0.0F, -1.0F, -1.0F, 1.0F, 4.0F, 8.0F, 0.0F, false);
		...
		left_wingtip_r1.setTextureOffset(19, 15);
		left_wingtip_r1.addBox(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 7.0F, 0.0F, false);

		right_wing = new AdvancedModelBox(this, "right_wing");
		right_wing.setPos(-2.0F, -1.5F, -2.5F);
		body.addChild(right_wing);
		right_wing.setTextureOffset(0, 15);
		right_wing.addBox(-1.0F, -1.0F, -1.0F, 1.0F, 4.0F, 8.0F, 0.0F, true);
		...
		right_wingtip_r1.setTextureOffset(19, 15);
		right_wingtip_r1.addBox(0.0F, -1.5F, 0.0F, 0.0F, 3.0F, 7.0F, 0.0F, true);

		left_leg = new AdvancedModelBox(this, "left_leg");
		left_leg.setPos(1.0F, 2.5F, 2.0F);
		body.addChild(left_leg);
		left_leg.setTextureOffset(27, 8);
		left_leg.addBox(-1.0F, 0.0F, -3.0F, 3.0F, 4.0F, 3.0F, 0.0F, false);

		right_leg = new AdvancedModelBox(this, "right_leg");
		right_leg.setPos(-1.0F, 2.5F, 2.0F);
		body.addChild(right_leg);
		right_leg.setTextureOffset(27, 8);
		right_leg.addBox(-2.0F, 0.0F, -3.0F, 3.0F, 4.0F, 3.0F, 0.0F, true);
	...
	@Override
	public void setAngles(EntitySeagull entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
