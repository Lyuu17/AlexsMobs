...
public class ModelMimicOctopus extends AdvancedEntityModel<EntityMimicOctopus> {
    ...
    public ModelMimicOctopus() {
        ...
        root.addChild(body);
        body.setTextureOffset(30, 24);
        body.addBox(-3.0F, -2.0F, -4.0F, 6.0F, 4.0F, 7.0F, 0.0F, false);

        leftEye = new AdvancedModelBox(this, "leftEye");
        leftEye.setRotationPoint(2.0F, -2.0F, -2.5F);
        body.addChild(leftEye);
        leftEye.setTextureOffset(35, 18);
        leftEye.addBox(-1.0F, -1.0F, -1.5F, 2.0F, 1.0F, 3.0F, 0.0F, false);
        ...
        leftEyeSpike.setTextureOffset(0, 0);
        leftEyeSpike.addBox(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 2.0F, 0.0F, false);

        rightEye = new AdvancedModelBox(this, "rightEye");
        rightEye.setRotationPoint(-2.0F, -2.0F, -2.5F);
        body.addChild(rightEye);
        rightEye.setTextureOffset(35, 18);
        rightEye.addBox(-1.0F, -1.0F, -1.5F, 2.0F, 1.0F, 3.0F, 0.0F, true);
        ...
        rightEyeSpike.setTextureOffset(0, 0);
        rightEyeSpike.addBox(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 2.0F, 0.0F, true);
        ...
        leftFrontArm1.setTextureOffset(26, 0);
        leftFrontArm1.addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, false);
        leftFrontArm1.setTextureOffset(35, 11);
        leftFrontArm1.addBox(11.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        rightFrontArm1.setTextureOffset(26, 0);
        rightFrontArm1.addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, true);
        rightFrontArm1.setTextureOffset(35, 11);
        rightFrontArm1.addBox(-15.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, true);
        ...
        leftFrontArm2.setTextureOffset(0, 26);
        leftFrontArm2.addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, false);
        leftFrontArm2.setTextureOffset(35, 5);
        leftFrontArm2.addBox(11.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        rightFrontArm2.setTextureOffset(0, 26);
        rightFrontArm2.addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, true);
        rightFrontArm2.setTextureOffset(35, 5);
        rightFrontArm2.addBox(-15.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, true);
        ...
        leftBackArm1.setTextureOffset(0, 21);
        leftBackArm1.addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, false);
        leftBackArm1.setTextureOffset(13, 31);
        leftBackArm1.addBox(11.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        rightBackArm1.setTextureOffset(0, 21);
        rightBackArm1.addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, true);
        rightBackArm1.setTextureOffset(13, 31);
        rightBackArm1.addBox(-15.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, true);
        ...
        leftBackArm2.setTextureOffset(0, 16);
        leftBackArm2.addBox(-1.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, false);
        leftBackArm2.setTextureOffset(0, 31);
        leftBackArm2.addBox(11.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, false);
        ...
        rightBackArm2.setTextureOffset(0, 16);
        rightBackArm2.addBox(-15.0F, -1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 0.0F, true);
        rightBackArm2.setTextureOffset(0, 31);
        rightBackArm2.addBox(-15.0F, -4.0F, -1.0F, 4.0F, 3.0F, 2.0F, 0.0F, true);
        ...
        mantle.addBox(-4.0F, -4.0F, -2.0F, 8.0F, 6.0F, 9.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityMimicOctopus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if(swimProgress > 0.0F){
            float rot = headPitch * MathHelper.RADIANS_PER_DEGREE;
        ...
        if (state == EntityMimicOctopus.MimicState.GUARDIAN) {
            ...
            if(swimProgress > 0) {
                if (state == EntityMimicOctopus.MimicState.PUFFERFISH) {
                    float f2 = 1.4F + 0.15F * MathHelper.sin(speed * limbSwing - 2) * swimProgress * 0.2F;
                    progressPositionPrev(mantle, swimProgress, 0, 1, 0, 5F);
                    this.mantle.setScale(f2, f2, f2);
                } else {
                    float scale = 1.1F + 0.3F * f * MathHelper.sin(speed * limbSwing - 2);
