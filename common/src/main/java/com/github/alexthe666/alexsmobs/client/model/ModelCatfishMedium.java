...
public class ModelCatfishMedium extends AdvancedEntityModel<EntityCatfish> {
    ...
    public ModelCatfishMedium() {
        ...
        body.addBox(-7.0F, -6.0F, -10.0F, 14.0F, 11.0F, 18.0F, 0.0F, false);
        ...
        dorsal_fin.addBox(0.0F, -4.0F, -1.0F, 0.0F, 4.0F, 7.0F, 0.0F, false);
        ...
        left_fin.setTextureOffset(0, 30);
        left_fin.addBox(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, false);
        ...
        right_fin.setTextureOffset(0, 30);
        right_fin.addBox(0.0F, 0.0F, -1.0F, 0.0F, 3.0F, 5.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -2.0F, 9.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 30);
        tail.addBox(-5.0F, -4.0F, -1.0F, 10.0F, 8.0F, 19.0F, 0.0F, false);
        tail.setTextureOffset(53, 18);
        tail.addBox(0.0F, 4.0F, 1.0F, 0.0F, 4.0F, 12.0F, 0.0F, false);
        tail.setTextureOffset(8, 0);
        tail.addBox(0.0F, -6.0F, 4.0F, 0.0F, 2.0F, 4.0F, 0.0F, false);

        tail_fin = new AdvancedModelBox(this, "tail_fin");
        tail_fin.setRotationPoint(0.0F, -4.0F, 17.0F);
        tail.addChild(tail_fin);
        tail_fin.setTextureOffset(38, 37);
        tail_fin.addBox(0.0F, -3.0F, -6.0F, 0.0F, 13.0F, 21.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -1.0F, -11.0F);
        body.addChild(head);
        head.setTextureOffset(47, 0);
        head.addBox(-6.0F, -5.0F, -5.0F, 12.0F, 9.0F, 6.0F, 0.0F, false);
        ...
        left_BigWhisker.setTextureOffset(0, 12);
        left_BigWhisker.addBox(0.0F, 0.0F, 0.0F, 8.0F, 5.0F, 0.0F, 0.0F, false);
        ...
        right_BigWhisker.setTextureOffset(0, 12);
        right_BigWhisker.addBox(-8.0F, 0.0F, 0.0F, 8.0F, 5.0F, 0.0F, 0.0F, true);
        ...
        left_SmallWhisker.setTextureOffset(6, 30);
        left_SmallWhisker.addBox(0.0F, 0.0F, 0.0F, 5.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        right_SmallWhisker.setTextureOffset(6, 30);
        right_SmallWhisker.addBox(-5.0F, 0.0F, 0.0F, 5.0F, 3.0F, 0.0F, 0.0F, true);
