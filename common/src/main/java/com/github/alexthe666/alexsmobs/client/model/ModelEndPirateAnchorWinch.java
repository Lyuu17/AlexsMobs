...
public class ModelEndPirateAnchorWinch extends AdvancedEntityModel<Entity> {
    ...
    public ModelEndPirateAnchorWinch() {
        ...
        chains.setTextureOffset(0, 33);
        chains.addBox(-8.0F, -5.0F, -5.0F, 16.0F, 10.0F, 10.0F, 0.0F, false);
    ...
    public void renderAnchor(EndPirateAnchorWinchBlockEntity anchor, float partialTick, boolean east) {
        ...
        if(anchor.isWinching()){
            ...
            float rollDeg = (float) MathHelper.wrapDegrees(Math.toDegrees(anchor.clientRoll));
