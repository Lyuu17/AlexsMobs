...
public class ModelLobster extends AdvancedEntityModel<EntityLobster> {
	...
	public ModelLobster() {
		...
		body.addBox(-2.0F, -1.4F, -7.0F, 4.0F, 2.0F, 7.0F, 0.0F, false);
		...
		antenna_left.setTextureOffset(18, 18);
		antenna_left.addBox(0.0F, -0.9F, -5.0F, 0.0F, 1.0F, 5.0F, 0.0F, false);
		...
		antenna_right.setTextureOffset(18, 20);
		antenna_right.addBox(0.0F, -0.9F, -5.0F, 0.0F, 1.0F, 5.0F, 0.0F, true);
		...
		arm_left.setTextureOffset(15, 5);
		arm_left.addBox(0.0F, 0.0F, -0.5F, 4.0F, 0.0F, 1.0F, 0.0F, false);
		...
		hand_left.setTextureOffset(0, 21);
		hand_left.addBox(0.0F, -1.0F, -1.9F, 3.0F, 1.0F, 2.0F, 0.0F, false);
		...
		arm_right.setTextureOffset(15, 6);
		arm_right.addBox(-4.0F, 0.0F, -0.5F, 4.0F, 0.0F, 1.0F, 0.0F, true);
		...
		hand_right.setTextureOffset(0, 25);
		hand_right.addBox(-3.0F, -1.0F, -1.9F, 3.0F, 1.0F, 2.0F, 0.0F, true);

		tail = new AdvancedModelBox(this, "tail");
		tail.setPos(0.0F, -0.4F, 0.0F);
		body.addChild(tail);
		tail.setTextureOffset(0, 0);
		tail.addBox(-1.5F, -1.0F, 0.0F, 3.0F, 2.0F, 8.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this, "tail2");
		tail2.setPos(0.0F, 0.0F, 6.0F);
		tail.addChild(tail2);
		tail2.setTextureOffset(15, 0);
		tail2.addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 4.0F, 0.0F, false);
		...
		legs_left.setTextureOffset(16, 11);
		legs_left.addBox(0.0F, 0.0F, -3.55F, 3.0F, 0.0F, 5.0F, 0.0F, false);
		...
		legs_right.setTextureOffset(25, 11);
		legs_right.addBox(-3.0F, 0.0F, -3.55F, 3.0F, 0.0F, 5.0F, 0.0F, true);

		this.updateDefaultPose();
	}

	@Override
	public void setAngles(EntityLobster entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
