...
public class AMBlockEntityRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<LeafcutterAnthillBlockEntity>> LEAFCUTTER_ANTHILL = registerBlockEntity("leafcutter_anthill_te",
            BlockEntityType.Builder.create(LeafcutterAnthillBlockEntity::new, AMBlockRegistry.LEAFCUTTER_ANTHILL.get()));
    ...
    public static final RegistrySupplier<BlockEntityType<EndPirateDoorBlockEntity>> END_PIRATE_DOOR = null;//DEF_REG.register("end_pirate_door_te", () -> BlockEntityType.Builder.create(TileEntityEndPirateDoor::new, AMBlockRegistry.END_PIRATE_DOOR.get()).build(null));
    public static final RegistrySupplier<BlockEntityType<EndPirateAnchorBlockEntity>> END_PIRATE_ANCHOR = null;// DEF_REG.register("end_pirate_anchor_te", () -> BlockEntityType.Builder.create(TileEntityEndPirateAnchor::new, AMBlockRegistry.END_PIRATE_ANCHOR.get()).build(null));
    public static final RegistrySupplier<BlockEntityType<EndPirateAnchorWinchBlockEntity>> END_PIRATE_ANCHOR_WINCH =  null;//DEF_REG.register("end_pirate_anchor_winch_te", () -> BlockEntityType.Builder.create(TileEntityEndPirateAnchorWinch::new, AMBlockRegistry.END_PIRATE_ANCHOR_WINCH.get()).build(null));
    public static final RegistrySupplier<BlockEntityType<EndPirateShipWheelBlockEntity>> END_PIRATE_SHIP_WHEEL = null;// DEF_REG.register("end_pirate_ship_wheel_te", () -> BlockEntityType.Builder.create(TileEntityEndPirateShipWheel::new, AMBlockRegistry.END_PIRATE_SHIP_WHEEL.get()).build(null));
    public static final RegistrySupplier<BlockEntityType<EndPirateFlagBlockEntity>> END_PIRATE_FLAG = null;// DEF_REG.register("end_pirate_flag_te", () -> BlockEntityType.Builder.create(TileEntityEndPirateFlag::new, AMBlockRegistry.END_PIRATE_FLAG.get()).build(null));
