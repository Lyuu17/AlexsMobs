...
public class ModelStraddler extends AdvancedEntityModel<EntityStraddler> {
    ...
    public ModelStraddler() {
        ...
        body.addBox(-14.0F, -12.0F, -7.0F, 28.0F, 11.0F, 14.0F, 0.0F, false);

        hair = new AdvancedModelBox(this, "hair");
        hair.setPos(0.0F, -13.0F, 0.0F);
        body.addChild(hair);
        hair.setTextureOffset(23, 26);
        hair.addBox(-6.0F, -4.0F, 0.0F, 12.0F, 5.0F, 0.0F, 0.0F, false);

        horn_left = new AdvancedModelBox(this, "horn_left");
        horn_left.setPos(9.5F, -12.0F, -4.0F);
        body.addChild(horn_left);
        horn_left.setTextureOffset(0, 26);
        horn_left.addBox(-2.5F, -18.0F, 0.0F, 6.0F, 18.0F, 10.0F, 0.0F, false);
        ...
        hair_left.setTextureOffset(33, 33);
        hair_left.addBox(0.0F, 0.0F, 0.0F, 0.0F, 6.0F, 16.0F, 0.0F, false);

        horn_right = new AdvancedModelBox(this, "horn_right");
        horn_right.setPos(-9.5F, -12.0F, -4.0F);
        body.addChild(horn_right);
        horn_right.setTextureOffset(0, 26);
        horn_right.addBox(-3.5F, -18.0F, 0.0F, 6.0F, 18.0F, 10.0F, 0.0F, true);
        ...
        hair_right.setTextureOffset(33, 33);
        hair_right.addBox(0.0F, 0.0F, 0.0F, 0.0F, 6.0F, 16.0F, 0.0F, true);

        leg_left = new AdvancedModelBox(this, "leg_left");
        leg_left.setPos(7.0F, -0.5F, 0.0F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(50, 26);
        leg_left.addBox(-3.0F, -0.5F, -3.0F, 6.0F, 15.0F, 6.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this, "leg_right");
        leg_right.setPos(-7.0F, -0.5F, 0.0F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(50, 26);
        leg_right.addBox(-3.0F, -0.5F, -3.0F, 6.0F, 15.0F, 6.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityStraddler entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (entity.getPassengerList().size() <= 0) {
            this.body.rotateAngleX += headPitch * 0.5F * MathHelper.RADIANS_PER_DEGREE;
            this.leg_right.rotateAngleX -= headPitch * 0.5F * MathHelper.RADIANS_PER_DEGREE;
            this.leg_left.rotateAngleX -= headPitch * 0.5F * MathHelper.RADIANS_PER_DEGREE;
        }
    }
