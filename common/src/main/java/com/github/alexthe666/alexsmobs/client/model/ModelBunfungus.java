...
public class ModelBunfungus extends AdvancedEntityModel<EntityBunfungus> {
    ...
    public ModelBunfungus() {
        ...
        body.addBox(-10.0F, -10.0F, -10.0F, 20.0F, 20.0F, 19.0F, 0.0F, false);

        belly = new AdvancedModelBox(this, "belly");
        belly.setRotationPoint(0.0F, 4.0F, -4.3F);
        body.addChild(belly);
        belly.setTextureOffset(64, 25);
        belly.addBox(-11.0F, -7.0F, -7.5F, 22.0F, 14.0F, 15.0F, -2.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 10.0F, 9.0F);
        body.addChild(tail);
        tail.setTextureOffset(60, 0);
        tail.addBox(-3.0F, -5.0F, -1.0F, 6.0F, 6.0F, 6.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -10.0F, -6.0F);
        body.addChild(head);
        head.setTextureOffset(0, 66);
        head.addBox(-6.0F, -5.0F, -9.0F, 12.0F, 8.0F, 13.0F, 0.0F, false);

        left_brow = new AdvancedModelBox(this, "left_brow");
        left_brow.setRotationPoint(3.5F, -3.5F, -9.1F);
        head.addChild(left_brow);
        left_brow.setTextureOffset(90, 2);
        left_brow.addBox(-2.5F, -0.5F, 0.0F, 5.0F, 1.0F, 0.0F, 0.0F, false);

        right_brow = new AdvancedModelBox(this, "right_brow");
        right_brow.setRotationPoint(-3.5F, -3.5F, -9.1F);
        head.addChild(right_brow);
        right_brow.setTextureOffset(90, 2);
        right_brow.addBox(-2.5F, -0.5F, 0.0F, 5.0F, 1.0F, 0.0F, 0.0F, true);

        shroom_cap = new AdvancedModelBox(this, "shroom_cap");
        shroom_cap.setRotationPoint(0.0F, -5.0F, -4.0F);
        head.addChild(shroom_cap);
        shroom_cap.setTextureOffset(0, 40);
        shroom_cap.addBox(-10.0F, -5.0F, -8.0F, 20.0F, 5.0F, 20.0F, 0.0F, false);
        ...
        left_ear.setTextureOffset(0, 0);
        left_ear.addBox(-2.0F, -12.0F, -1.0F, 4.0F, 12.0F, 2.0F, 0.0F, false);
        ...
        right_ear.setTextureOffset(0, 0);
        right_ear.addBox(-2.0F, -12.0F, -1.0F, 4.0F, 12.0F, 2.0F, 0.0F, true);

        snout = new AdvancedModelBox(this, "snout");
        snout.setRotationPoint(0.0F, 0.0F, -10.0F);
        head.addChild(snout);
        snout.setTextureOffset(0, 40);
        snout.addBox(-3.0F, -1.0F, -1.0F, 6.0F, 4.0F, 2.0F, 0.0F, false);
        ...
        snout_r1.setTextureOffset(0, 48);
        snout_r1.addBox(-4.0F, 0.0F, 0.0F, 8.0F, 2.0F, 0.0F, 0.0F, false);
        ...
        left_arm.setTextureOffset(51, 77);
        left_arm.addBox(-2.5F, -1.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0.0F, false);
        ...
        right_arm.setTextureOffset(51, 77);
        right_arm.addBox(-2.5F, -1.0F, -2.5F, 5.0F, 8.0F, 5.0F, 0.0F, true);
        ...
        left_foot.setTextureOffset(64, 55);
        left_foot.addBox(-3.0F, -1.0F, -15.0F, 6.0F, 4.0F, 17.0F, 0.0F, false);
        ...
        right_foot.setTextureOffset(64, 55);
        right_foot.addBox(-3.0F, -1.0F, -15.0F, 6.0F, 4.0F, 17.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityBunfungus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
