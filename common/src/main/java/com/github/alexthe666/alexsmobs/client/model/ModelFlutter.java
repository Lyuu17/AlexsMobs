...
public class ModelFlutter extends AdvancedEntityModel<EntityFlutter> {
    ...
    public ModelFlutter() {
        ...
        body.addBox(-3.5F, -3.0F, -3.5F, 7.0F, 5.0F, 7.0F, 0.0F, false);
        body.setTextureOffset(0, 0);
        body.addBox(-3.5F, -3.0F, -3.5F, 7.0F, 5.0F, 7.0F, -0.2F, false);

        eyes = new AdvancedModelBox(this, "eyes");
        eyes.setRotationPoint(0.0F, -1.0F, -3.0F);
        body.addChild(eyes);
        eyes.setTextureOffset(23, 30);
        eyes.addBox(-1.5F, -0.5F, 0.0F, 3.0F, 1.0F, 0.0F, 0.0F, false);
        ...
        front_petal.setTextureOffset(0, 26);
        front_petal.addBox(-3.5F, -7.0F, 0.0F, 7.0F, 7.0F, 0.0F, 0.0F, false);
        ...
        left_petal.setTextureOffset(0, 26);
        left_petal.addBox(-3.5F, -7.0F, 0.0F, 7.0F, 7.0F, 0.0F, 0.0F, false);
        ...
        right_petal.setTextureOffset(0, 26);
        right_petal.addBox(-3.5F, -7.0F, 0.0F, 7.0F, 7.0F, 0.0F, 0.0F, true);
        ...
        back_petal.setTextureOffset(0, 26);
        back_petal.addBox(-3.5F, -7.0F, 0.0F, 7.0F, 7.0F, 0.0F, 0.0F, false);
        ...
        left_arm.addBox(-0.5F, 0.0F, -2.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        left_leg.addBox(-0.5F, 0.0F, -2.0F, 1.0F, 2.0F, 2.0F, 0.0F, false);
        ...
        right_leg.addBox(-0.5F, 0.0F, -2.0F, 1.0F, 2.0F, 2.0F, 0.0F, true);
        ...
        right_arm.addBox(-0.5F, 0.0F, -2.0F, 1.0F, 2.0F, 2.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntityFlutter entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float flutterPitch = Maths.rad(MathHelper.lerpAngleDegrees(partialTicks, entity.prevFlutterPitch, entity.getFlutterPitch()));
        ...
        if(entity.isShakingHead()){
            ...
            Vec3d vector3d = look.getCameraPosVec(0.0F);
            Vec3d vector3d1 = entity.getCameraPosVec(0.0F);
            double d0 = vector3d.y - vector3d1.y;
            float f1 = (float)MathHelper.clamp(-d0 - 0.5F, -2.0F, 0F);
            this.eyes.rotationPointY = f1;
            Vec3d vector3d2 = entity.getRotationVec(0.0F);
            vector3d2 = new Vec3d(vector3d2.x, 0.0D, vector3d2.z);
            Vec3d vector3d3 = (new Vec3d(vector3d1.x - vector3d.x, 0.0D, vector3d1.z - vector3d.z)).normalize().rotateY((MathHelper.PI / 2F));
            double d1 = vector3d2.dotProduct(vector3d3);
            this.eyes.rotationPointX += MathHelper.sqrt((float) Math.abs(d1)) * 1.5F * (float) Math.signum(d1);
        }else{
        ...
        this.body.rotateAngleY += Math.toRadians(MathHelper.wrapDegrees(shootProgress * 360 * 0.2F));
