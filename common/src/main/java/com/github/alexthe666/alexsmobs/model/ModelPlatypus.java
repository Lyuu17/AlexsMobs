...
public class ModelPlatypus extends AdvancedEntityModel<EntityPlatypus> {
    ...
    public ModelPlatypus() {
        ...
        body.addBox(-3.5F, -3.4F, -5.9F, 7.0F, 6.0F, 11.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setPos(0.0F, -0.4F, -5.9F);
        body.addChild(head);
        head.setTextureOffset(5, 51);
        head.addBox(-3.0F, -2.5F, -4.0F, 6.0F, 5.0F, 4.0F, 0.0F, false);

        beak = new AdvancedModelBox(this, "beak");
        beak.setPos(0.0F, 2.0F, -5.0F);
        head.addChild(beak);
        beak.setTextureOffset(28, 0);
        beak.addBox(-2.0F, -2.0F, -3.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);

        fedora = new AdvancedModelBox(this, "fedora");
        fedora.setPos(0.0F, -2.6F, -1.9F);
        head.addChild(fedora);
        fedora.setTextureOffset(23, 20);
        fedora.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, 0.0F, false);
        fedora.setTextureOffset(29, 30);
        fedora.addBox(-2.0F, -2.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);

        arm_left = new AdvancedModelBox(this, "arm_left");
        arm_left.setPos(3.5F, 2.1F, -4.9F);
        body.addChild(arm_left);
        arm_left.setTextureOffset(7, 39);
        arm_left.addBox(0.0F, -0.5F, 0.0F, 3.0F, 1.0F, 3.0F, 0.0F, false);

        arm_right = new AdvancedModelBox(this, "arm_right");
        arm_right.setPos(-3.5F, 2.1F, -4.9F);
        body.addChild(arm_right);
        arm_right.setTextureOffset(7, 39);
        arm_right.addBox(-3.0F, -0.5F, 0.0F, 3.0F, 1.0F, 3.0F, 0.0F, true);

        leg_left = new AdvancedModelBox(this, "leg_left");
        leg_left.setPos(3.5F, 2.1F, 2.6F);
        body.addChild(leg_left);
        leg_left.setTextureOffset(27, 43);
        leg_left.addBox(0.0F, -0.5F, -0.5F, 3.0F, 1.0F, 3.0F, 0.0F, false);

        leg_right = new AdvancedModelBox(this, "leg_right");
        leg_right.setPos(-3.5F, 2.1F, 2.6F);
        body.addChild(leg_right);
        leg_right.setTextureOffset(27, 43);
        leg_right.addBox(-3.0F, -0.5F, -0.5F, 3.0F, 1.0F, 3.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setPos(0.0F, -0.4F, 5.1F);
        body.addChild(tail);
        tail.setTextureOffset(0, 24);
        tail.addBox(-3.0F, -1.0F, 0.0F, 6.0F, 3.0F, 8.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntityPlatypus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
