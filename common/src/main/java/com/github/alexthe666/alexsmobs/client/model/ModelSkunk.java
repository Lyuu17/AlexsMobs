...
public class ModelSkunk extends AdvancedEntityModel<EntitySkunk> {
    ...
    public ModelSkunk() {
        ...
        body.addBox(-3.5F, -4.0F, -4.5F, 7.0F, 6.0F, 9.0F, 0.0F, false);
        ...
        leftLeg.setTextureOffset(0, 33);
        leftLeg.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(0, 33);
        rightLeg.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F, 0.0F, true);
        ...
        leftArm.setTextureOffset(32, 31);
        leftArm.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);
        ...
        rightArm.setTextureOffset(32, 31);
        rightArm.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, -1.0F, 4.5F);
        body.addChild(tail);
        tail.setTextureOffset(0, 16);
        tail.addBox(-3.0F, -10.0F, 0.0F, 6.0F, 12.0F, 4.0F, 0.0F, false);
        tail.setTextureOffset(21, 16);
        tail.addBox(-3.0F, -10.0F, 4.0F, 6.0F, 7.0F, 5.0F, 0.0F, false);
        ...
        head.setTextureOffset(21, 29);
        head.addBox(-2.0F, 0.0F, -6.0F, 4.0F, 2.0F, 3.0F, 0.0F, false);
    ...
    @Override
    public void setAngles(EntitySkunk entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
