...
public class ModelSeal extends AdvancedEntityModel<EntitySeal> {
    ...
    public ModelSeal() {
        ...
        body.addBox(-6.5F, -6.0F, -9.0F, 13.0F, 9.0F, 18.0F, 0.0F, false);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 1.0F, 9.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 28);
        tail.addBox(-4.0F, -4.0F, 0.0F, 8.0F, 6.0F, 14.0F, 0.0F, false);
        ...
        leftLeg.setTextureOffset(45, 0);
        leftLeg.addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 8.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(45, 0);
        rightLeg.addBox(-1.0F, -2.0F, 0.0F, 2.0F, 4.0F, 8.0F, 0.0F, true);

        leftArm = new AdvancedModelBox(this, "leftArm");
        leftArm.setRotationPoint(7.5F, 2.5F, -4.0F);
        body.addChild(leftArm);
        leftArm.setTextureOffset(31, 28);
        leftArm.addBox(-1.0F, -0.5F, -2.0F, 8.0F, 1.0F, 5.0F, 0.0F, false);
        leftArm.setTextureOffset(0, 7);
        leftArm.addBox(7.0F, 0.5F, -2.0F, 0.0F, 2.0F, 5.0F, 0.0F, false);

        rightArm = new AdvancedModelBox(this, "rightArm");
        rightArm.setRotationPoint(-7.5F, 2.5F, -4.0F);
        body.addChild(rightArm);
        rightArm.setTextureOffset(31, 28);
        rightArm.addBox(-7.0F, -0.5F, -2.0F, 8.0F, 1.0F, 5.0F, 0.0F, true);
        rightArm.setTextureOffset(0, 7);
        rightArm.addBox(-7.0F, 0.5F, -2.0F, 0.0F, 2.0F, 5.0F, 0.0F, true);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, -1.0F, -5.0F);
        body.addChild(head);
        head.setTextureOffset(35, 39);
        head.addBox(-3.5F, -3.0F, -9.0F, 7.0F, 6.0F, 10.0F, 0.0F, false);
        head.setTextureOffset(0, 0);
        head.addBox(-2.5F, 0.0F, -12.0F, 5.0F, 3.0F, 3.0F, 0.0F, false);
        ...
        leftWhisker.setTextureOffset(0, 7);
        leftWhisker.addBox(0.0F, -2.0F, 0.0F, 2.0F, 3.0F, 0.0F, 0.0F, false);
        ...
        rightWhisker.setTextureOffset(0, 7);
        rightWhisker.addBox(-2.0F, -2.0F, 0.0F, 2.0F, 3.0F, 0.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntitySeal entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        this.resetToDefaultPose();
        float walkSpeed = this.child ? 0.25F : 0.5F;
        float walkDegree = 1F;
        ...
        if(entity.isTearsEasterEgg() && !entity.isTouchingWater()){
