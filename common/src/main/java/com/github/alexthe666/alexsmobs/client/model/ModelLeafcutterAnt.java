...
public class ModelLeafcutterAnt extends AdvancedEntityModel<EntityLeafcutterAnt> {
	...
	public ModelLeafcutterAnt() {
		...
		root.addChild(body);
		body.setTextureOffset(14, 5);
		body.addBox(-1.0F, -0.4F, -2.125F, 2.0F, 2.0F, 5.0F, 0.0F, false);
		...
		legfront_left.setTextureOffset(0, 19);
		legfront_left.addBox(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		...
		legfront_right.setTextureOffset(0, 19);
		legfront_right.addBox(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, true);

		legmid_left = new AdvancedModelBox(this, "legmid_left");
		legmid_left.setPos(1.0F, 1.0F, 0.875F);
		body.addChild(legmid_left);
		legmid_left.setTextureOffset(0, 19);
		legmid_left.addBox(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);

		legmid_right = new AdvancedModelBox(this, "legmid_right");
		legmid_right.setPos(-1.0F, 1.0F, 0.875F);
		body.addChild(legmid_right);
		legmid_right.setTextureOffset(0, 19);
		legmid_right.addBox(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, true);
		...
		legback_left.setTextureOffset(0, 19);
		legback_left.addBox(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, false);
		...
		legback_right.setTextureOffset(0, 19);
		legback_right.addBox(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 0.0F, 0.0F, true);

		abdomen = new AdvancedModelBox(this, "abdomen");
		abdomen.setPos(0.0F, 0.0F, 2.875F);
		body.addChild(abdomen);
		abdomen.setTextureOffset(0, 0);
		abdomen.addBox(-2.0F, -3.0F, 0.0F, 4.0F, 4.0F, 5.0F, 0.0F, false);

		head = new AdvancedModelBox(this, "head");
		head.setPos(0.0F, -0.5F, -2.125F);
		body.addChild(head);
		head.setTextureOffset(0, 10);
		head.addBox(-2.0F, -2.0F, -4.0F, 4.0F, 3.0F, 5.0F, 0.0F, false);
		...
		leaf_r1.setTextureOffset(6, 5);
		leaf_r1.addBox(0.0F, -14.0F, -6.0F, 0.0F, 14.0F, 13.0F, 0.0F, false);
		...
		antenna_left.setTextureOffset(12, 13);
		antenna_left.addBox(0.0F, 0.0F, -6.0F, 5.0F, 0.0F, 6.0F, 0.0F, false);
		...
		antenna_right.setTextureOffset(12, 13);
		antenna_right.addBox(-5.0F, 0.0F, -6.0F, 5.0F, 0.0F, 6.0F, 0.0F, true);

		fangs = new AdvancedModelBox(this, "fangs");
		fangs.setPos(0.0F, 1.0F, -5.0F);
		head.addChild(fangs);
		fangs.setTextureOffset(14, 0);
		fangs.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityLeafcutterAnt entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
	...
	public void animateAnteater(EntityAnteater anteater, float partialTicks) {
		this.resetToDefaultPose();
		float ageInTicks = anteater.age + partialTicks;
