...
public class ModelSugarGlider extends AdvancedEntityModel<EntitySugarGlider> {
    ...
    public ModelSugarGlider() {
        ...
        body.addBox(-2.0F, -1.0F, -3.0F, 4.0F, 3.0F, 7.0F, 0.0F, false);
        ...
        leftArm.setTextureOffset(12, 11);
        leftArm.addBox(-1.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, 0.0F, false);
        ...
        rightArm.setTextureOffset(12, 11);
        rightArm.addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, 0.0F, true);
        ...
        leftLeg.setTextureOffset(15, 0);
        leftLeg.addBox(-1.0F, 0.0F, -2.0F, 6.0F, 0.0F, 5.0F, 0.0F, false);
        ...
        rightLeg.setTextureOffset(15, 0);
        rightLeg.addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 5.0F, 0.0F, true);

        tail = new AdvancedModelBox(this, "tail");
        tail.setRotationPoint(0.0F, 0.0F, 4.0F);
        body.addChild(tail);
        tail.setTextureOffset(0, 11);
        tail.addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 8.0F, 0.0F, false);

        head = new AdvancedModelBox(this, "head");
        head.setRotationPoint(0.0F, 0.0F, -3.0F);
        body.addChild(head);
        head.setTextureOffset(17, 18);
        head.addBox(-2.5F, -2.0F, -4.0F, 5.0F, 4.0F, 4.0F, 0.0F, false);
        head.setTextureOffset(0, 22);
        head.addBox(-1.5F, 0.0F, -5.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        leftEar.setTextureOffset(0, 0);
        leftEar.addBox(0.0F, -2.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        ...
        rightEar.setTextureOffset(0, 0);
        rightEar.addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 1.0F, 0.0F, true);
    ...
    @Override
    public void setAngles(EntitySugarGlider entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
