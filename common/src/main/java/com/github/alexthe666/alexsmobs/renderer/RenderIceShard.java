...
public class RenderIceShard extends EntityRenderer<EntityIceShard> {
    private static final Identifier TEXTURE = new Identifier("alexsmobs:textures/entity/ice_shard.png");

    public RenderIceShard(EntityRendererFactory.Context renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void render(EntityIceShard p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, VertexConsumerProvider p_225623_5_, int p_225623_6_) {
        p_225623_4_.push();
        ...
        MatrixStack.Entry lvt_19_1_ = p_225623_4_.peek();
    ...
    @Override
    public Identifier getTexture(EntityIceShard entity) {
        return TEXTURE;
    }
}
