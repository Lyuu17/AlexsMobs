...
public class ModelAncientDart extends AdvancedEntityModel<Entity> {
	...
	public ModelAncientDart() {
		...
		root.addChild(main);
		main.setTextureOffset(11, 0);
		main.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		main.setTextureOffset(0, 0);
		main.addBox(-0.5F, -0.5F, -5.0F, 1.0F, 1.0F, 4.0F, 0.0F, false);
		...
		cube_r1.setTextureOffset(0, 6);
		cube_r1.addBox(0.0F, -1.5F, -0.5F, 0.0F, 3.0F, 3.0F, 0.0F, false);

		cube_r2 = new AdvancedModelBox(this, "cube_r2");
		cube_r2.setPos(0.0F, -1.0F, 0.5F);
		feathers.addChild(cube_r2);
		setRotationAngle(cube_r2, 0.0F, 0.0F, -0.7854F);
		cube_r2.setTextureOffset(7, 6);
		cube_r2.addBox(0.0F, -1.5F, -0.5F, 0.0F, 3.0F, 3.0F, 0.0F, false);
	}
