...
public class ModelVoidWormBody extends AdvancedEntityModel<EntityVoidWormPart> {
	...
	public ModelVoidWormBody(float f) {
		...
		body.addBox(-7.0F, -12.0F, 0.0F, 14.0F, 26.0F, 21.0F, f, false);
		...
		frillstop_left_r1.setTextureOffset(0, 48);
		frillstop_left_r1.addBox(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, f, false);
		...
		frillstop_right_r1.setTextureOffset(0, 48);
		frillstop_right_r1.addBox(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, f, true);
		...
		frillsbottom_left_r1.setTextureOffset(0, 48);
		frillsbottom_left_r1.addBox(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, f, false);
		...
		frillsbottom_right_r1.setTextureOffset(0, 48);
		frillsbottom_right_r1.addBox(0.0F, -8.0F, -10.0F, 0.0F, 8.0F, 21.0F, f, true);
		this.updateDefaultPose();
	}

	@Override
	public void setAngles(EntityVoidWormPart entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
