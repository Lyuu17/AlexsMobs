package com.github.alexthe666.alexsmobs.model;// Made with Blockbench 3.8.3
...
public class ModelCachalotWhale extends AdvancedEntityModel<EntityCachalotWhale> {
	...
	public ModelCachalotWhale() {
		...
		body.addBox(-21.0F, -30.0F, -60.0F, 42.0F, 60.0F, 112.0F, 0.0F, false);

		top_fin = new AdvancedModelBox(this, "top_fin");
		top_fin.setPos(0.0F, -34.0F, 42.0F);
		body.addChild(top_fin);
		top_fin.setTextureOffset(0, 0);
		top_fin.addBox(-3.0F, -4.0F, -10.0F, 6.0F, 8.0F, 20.0F, 0.0F, false);

		arm_left = new AdvancedModelBox(this, "arm_left");
		arm_left.setPos(21.0F, 26.0F, -38.0F);
		body.addChild(arm_left);
		arm_left.setTextureOffset(304, 220);
		arm_left.addBox(0.0F, -2.0F, -3.0F, 36.0F, 4.0F, 21.0F, 0.0F, false);

		arm_right = new AdvancedModelBox(this, "arm_right");
		arm_right.setPos(-21.0F, 26.0F, -38.0F);
		body.addChild(arm_right);
		arm_right.setTextureOffset(304, 220);
		arm_right.addBox(-36.0F, -2.0F, -3.0F, 36.0F, 4.0F, 21.0F, 0.0F, true);

		tail1 = new AdvancedModelBox(this, "tail1");
		tail1.setPos(0.0F, -1.0F, 52.0F);
		body.addChild(tail1);
		tail1.setTextureOffset(163, 227);
		tail1.addBox(-15.0F, -22.0F, 0.0F, 30.0F, 45.0F, 80.0F, 0.0F, false);

		tail2 = new AdvancedModelBox(this, "tail2");
		tail2.setPos(0.0F, -1.0F, 80.0F);
		tail1.addChild(tail2);
		tail2.setTextureOffset(197, 0);
		tail2.addBox(-9.0F, -14.0F, 0.0F, 18.0F, 28.0F, 65.0F, 0.0F, false);

		tail3 = new AdvancedModelBox(this, "tail3");
		tail3.setPos(0.0F, 2.0F, 56.0F);
		tail2.addChild(tail3);
		tail3.setTextureOffset(158, 173);
		tail3.addBox(-33.0F, -5.0F, -5.0F, 66.0F, 9.0F, 37.0F, 0.0F, false);

		head = new AdvancedModelBox(this, "head");
		head.setPos(0.0F, -2.0F, -60.0F);
		body.addChild(head);
		head.setTextureOffset(0, 173);
		head.addBox(-18.0F, -28.0F, -85.0F, 36.0F, 48.0F, 85.0F, 0.0F, false);

		jaw = new AdvancedModelBox(this, "jaw");
		jaw.setPos(0.0F, 20.0F, 0.0F);
		head.addChild(jaw);
		jaw.setTextureOffset(293, 23);
		jaw.addBox(-7.0F, 0.0F, -71.0F, 14.0F, 9.0F, 71.0F, 0.0F, false);

		teeth = new AdvancedModelBox(this, "teeth");
		teeth.setPos(0.0F, 0.0F, -7.0F);
		jaw.addChild(teeth);
		teeth.setTextureOffset(32, 370);
		teeth.addBox(-4.0F, -4.0F, -59.0F, 8.0F, 4.0F, 60.0F, 0.0F, false);
	...
	@Override
	public void setAngles(EntityCachalotWhale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		this.resetToDefaultPose();
		float partialTicks = ageInTicks - entity.age;
		float renderYaw = (float)entity.getMovementOffsets(0, partialTicks)[0] ;
		float properPitch = entity.prevPitch + (entity.getPitch() - entity.prevPitch) * partialTicks;
		...
		this.tail1.rotateAngleY += MathHelper.clamp((float)entity.getMovementOffsets(15, partialTicks)[0] - renderYaw, -50, 50) * 0.017453292F;
		this.tail2.rotateAngleY += MathHelper.clamp((float)entity.getMovementOffsets(17, partialTicks)[0] - renderYaw, -50, 50) * 0.017453292F;
		this.body.rotateAngleX += Math.min(properPitch, sleepProgress * -9) * MathHelper.RADIANS_PER_DEGREE;
		this.body.rotateAngleZ += f * 0.017453292F;
		this.head.rotateAngleY += (float) (Math.sin((entity.grabTime + partialTicks) * 0.3F) * 0.1F * grabProgress);
