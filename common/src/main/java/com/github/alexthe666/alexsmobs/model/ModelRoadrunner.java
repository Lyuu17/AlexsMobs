...
public class ModelRoadrunner extends AdvancedEntityModel<EntityRoadrunner> {
    ...
    public ModelRoadrunner() {
        ...
        root.addChild(body);
        body.setTextureOffset(23, 14);
        body.addBox(-2.0F, -2.0F, -3.0F, 4.0F, 4.0F, 7.0F, 0.0F, false);
        ...
        left_wing.setTextureOffset(0, 14);
        left_wing.addBox(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 11.0F, 0.0F, false);
        ...
        right_wing.setTextureOffset(0, 14);
        right_wing.addBox(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 11.0F, 0.0F, true);
        ...
        tail.addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 13.0F, 0.0F, false);
        ...
        neck.addBox(-1.5F, -6.0F, -1.3F, 3.0F, 8.0F, 3.0F, 0.0F, false);
        neck.setTextureOffset(0, 14);
        neck.addBox(0.0F, -8.0F, -1.3F, 0.0F, 4.0F, 5.0F, 0.0F, false);

        beak = new AdvancedModelBox(this, "beak");
        beak.setRotationPoint(0.0F, -4.5F, -0.8F);
        neck.addChild(beak);
        setRotationAngle(beak, -0.3491F, 0.0F, 0.0F);
        beak.setTextureOffset(12, 14);
        beak.addBox(-0.5F, -0.5F, -4.2F, 1.0F, 1.0F, 4.0F, 0.0F, false);
        beak.setTextureOffset(47, 22);
        beak.addBox(-1.0F, -0.1F, -2.1F, 2.0F, 1.0F, 2.0F, 0.0F, false);
        ...
        right_spin.setTextureOffset(42, 9);
        right_spin.addBox(-1.0F, -2.5F, -2.5F, 2.0F, 5.0F, 5.0F, 0.0F, true);
        ...
        left_spin.setTextureOffset(42, 9);
        left_spin.addBox(-1.0F, -2.5F, -2.5F, 2.0F, 5.0F, 5.0F, 0.0F, false);
        ...
        left_leg.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, 0.0F, false);
        ...
        left_knee.setTextureOffset(0, 14);
        left_knee.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 0.0F, 0.0F, false);
        ...
        left_foot.setTextureOffset(23, 14);
        left_foot.addBox(-1.5F, -2.5F, 0.0F, 3.0F, 5.0F, 0.0F, 0.0F, false);
        ...
        right_leg.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 2.0F, 0.0F, 0.0F, true);
        ...
        right_knee.setTextureOffset(0, 14);
        right_knee.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 0.0F, 0.0F, true);
        ...
        right_foot.setTextureOffset(23, 14);
        right_foot.addBox(-1.5F, -2.5F, 0.0F, 3.0F, 5.0F, 0.0F, 0.0F, true);

        this.updateDefaultPose();
    }

    @Override
    public void setAngles(EntityRoadrunner entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netneckYaw, float neckPitch) {
